...
public class TurboPasscodeView extends FrameLayout {
    private Drawable backgroundDrawable;
    private FrameLayout backgroundFrameLayout;
    private CancellationSignal cancellationSignal;
    private ImageView checkImage;
    private int checkType;
    private TurboPasscodeViewDelegate delegate;
    ...
    public interface TurboPasscodeViewDelegate {
        void didAcceptedPassword();
    }

    /* renamed from: turbogram.Components.TurboPasscodeView$1 */
    class C22841 implements OnEditorActionListener {
        C22841() {
        }
        ...
        public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
            ...
            TurboPasscodeView.this.processDone(false);
            return true;
        }
    }

    /* renamed from: turbogram.Components.TurboPasscodeView$2 */
    class C22852 implements TextWatcher {
        C22852() {
        }
        ...
        public void afterTextChanged(Editable s) {
            if (TurboPasscodeView.this.passwordEditText.length() == 4 && TurboPasscodeView.this.passcodeType == 0) {
                TurboPasscodeView.this.processDone(false);
            }
        }
    }

    /* renamed from: turbogram.Components.TurboPasscodeView$3 */
    class C22863 implements Callback {
        C22863() {
        }
    ...
    /* renamed from: turbogram.Components.TurboPasscodeView$4 */
    class C22874 implements OnClickListener {
        C22874() {
        }
    ...
    /* renamed from: turbogram.Components.TurboPasscodeView$5 */
    class C22885 implements OnLongClickListener {
        C22885() {
        }

        public boolean onLongClick(View v) {
            TurboPasscodeView.this.passwordEditText.setText("");
            TurboPasscodeView.this.passwordEditText2.eraseAllCharacters(true);
            return true;
        }
    }

    /* renamed from: turbogram.Components.TurboPasscodeView$6 */
    class C22896 implements OnClickListener {
        C22896() {
        }
        ...
        public void onClick(View v) {
            switch (((Integer) v.getTag()).intValue()) {
                case 0:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("0");
                    break;
                case 1:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("1");
                    break;
                case 2:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter(ExifInterface.GPS_MEASUREMENT_2D);
                    break;
                case 3:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter(ExifInterface.GPS_MEASUREMENT_3D);
                    break;
                case 4:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("4");
                    break;
                case 5:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("5");
                    break;
                case 6:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("6");
                    break;
                case 7:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("7");
                    break;
                case 8:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("8");
                    break;
                case 9:
                    TurboPasscodeView.this.passwordEditText2.appendCharacter("9");
                    break;
                case 10:
                    TurboPasscodeView.this.passwordEditText2.eraseLastCharacter();
                    break;
            }
            if (TurboPasscodeView.this.passwordEditText2.lenght() == 4) {
                TurboPasscodeView.this.processDone(false);
            }
        }
    }

    /* renamed from: turbogram.Components.TurboPasscodeView$7 */
    class C22907 extends AnimatorListenerAdapter {
        C22907() {
        }

        public void onAnimationEnd(Animator animation) {
            TurboPasscodeView.this.setVisibility(8);
        }
    }
    ...
    private class AnimatingTextView extends FrameLayout {
        ...
        /* renamed from: turbogram.Components.TurboPasscodeView$AnimatingTextView$2 */
        class C22942 extends AnimatorListenerAdapter {
            C22942() {
            }
        ...
        /* renamed from: turbogram.Components.TurboPasscodeView$AnimatingTextView$3 */
        class C22953 extends AnimatorListenerAdapter {
            C22953() {
            }
        ...
        /* renamed from: turbogram.Components.TurboPasscodeView$AnimatingTextView$4 */
        class C22964 extends AnimatorListenerAdapter {
            C22964() {
            }
        ...
        public void appendCharacter(String c) {
            if (this.stringBuilder.length() != 4) {
                ...
                this.dotRunnable = new Runnable() {
                    ...
                    /* renamed from: turbogram.Components.TurboPasscodeView$AnimatingTextView$1$1 */
                    class C22921 extends AnimatorListenerAdapter {
                        C22921() {
                        }
                    ...
                    public void run() {
                        if (AnimatingTextView.this.dotRunnable == this) {
                            ...
                            AnimatingTextView.this.currentAnimation.addListener(new C22921());
                ...
                this.currentAnimation.addListener(new C22942());
        ...
        public void eraseLastCharacter() {
            if (this.stringBuilder.length() != 0) {
                ...
                this.currentAnimation.setDuration(150);
                this.currentAnimation.playTogether(animators);
                this.currentAnimation.addListener(new C22953());
                this.currentAnimation.start();
            }
        }
        ...
        private void eraseAllCharacters(boolean animated) {
            if (this.stringBuilder.length() != 0) {
                ...
                if (animated) {
                    ...
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.playTogether(animators);
                    this.currentAnimation.addListener(new C22964());
                    this.currentAnimation.start();
                    return;
                }
                for (a = 0; a < 4; a++) {
    ...
    public TurboPasscodeView(Context context, int checkType) {
        int a;
        super(context);
        ...
        this.passwordEditText.setOnEditorActionListener(new C22841());
        this.passwordEditText.addTextChangedListener(new C22852());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C22863());
        ...
        this.checkImage.setOnClickListener(new C22874());
        ...
        for (a = 0; a < 11; a++) {
            ...
            if (a == 10) {
                frameLayout.setOnLongClickListener(new C22885());
            }
            frameLayout.setOnClickListener(new C22896());
    ...
    public void setDelegate(TurboPasscodeViewDelegate delegate) {
    ...
    private void processDone(boolean fingerprint) {
        if (!fingerprint) {
            ...
            if (!password.equals(this.checkType == 0 ? TurboConfig.chatHidePasscode : TurboConfig.chatLockPasscode)) {
        ...
        AnimatorSet.addListener(new C22907());
        AnimatorSet.start();
    ...
    private void shakeTextView(final float x, final int num) {
        if (num != 6) {
            ...
            AnimatorSet.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    TurboPasscodeView.this.shakeTextView(num == 5 ? 0.0f : -x, num + 1);
                }
            });
            AnimatorSet.start();
        }
    ...
    private void checkFingerprint() {
        ...
        if (VERSION.SDK_INT >= 23 && parentActivity != null && this.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            try {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    this.fingerprintImageView.setId(PointerIconCompat.TYPE_CONTEXT_MENU);
                    ...
                    layoutParams.addRule(8, PointerIconCompat.TYPE_CONTEXT_MENU);
                    layoutParams.addRule(6, PointerIconCompat.TYPE_CONTEXT_MENU);
                    layoutParams.addRule(17, PointerIconCompat.TYPE_CONTEXT_MENU);
                    ...
                    builder.setOnDismissListener(new OnDismissListener() {
                        public void onDismiss(DialogInterface dialog) {
                            if (TurboPasscodeView.this.cancellationSignal != null) {
                                TurboPasscodeView.this.selfCancelled = true;
                                TurboPasscodeView.this.cancellationSignal.cancel();
                                TurboPasscodeView.this.cancellationSignal = null;
                            }
                        }
                    });
                    ...
                    fingerprintManager.authenticate(null, 0, this.cancellationSignal, new AuthenticationCallback() {
                        public void onAuthenticationError(int errMsgId, CharSequence errString) {
                            if (!TurboPasscodeView.this.selfCancelled) {
                                TurboPasscodeView.this.showFingerprintError(errString);
                            }
                        }

                        public void onAuthenticationHelp(int helpMsgId, CharSequence helpString) {
                            TurboPasscodeView.this.showFingerprintError(helpString);
                        }

                        public void onAuthenticationFailed() {
                            TurboPasscodeView.this.showFingerprintError(LocaleController.getString("FingerprintNotRecognized", R.string.FingerprintNotRecognized));
                        }

                        public void onAuthenticationSucceeded(AuthenticationResult result) {
                            try {
                                if (TurboPasscodeView.this.fingerprintDialog.isShowing()) {
                                    TurboPasscodeView.this.fingerprintDialog.dismiss();
                                }
                            } catch (Exception e) {
                                FileLog.e(e);
                            }
                            TurboPasscodeView.this.fingerprintDialog = null;
                            TurboPasscodeView.this.processDone(true);
                        }
                    }, null);
                }
            } catch (Exception e2) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.passcodeType == 1 && (AndroidUtilities.isTablet() || getContext().getResources().getConfiguration().orientation != 2)) {
            int t = 0;
