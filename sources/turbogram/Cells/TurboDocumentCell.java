...
public class TurboDocumentCell extends FrameLayout {
    ...
    public TurboDocumentCell(Context context, int padding) {
        int i;
        int i2;
        int i3 = 3;
        super(context);
        ...
        addView(view, LayoutHelper.createFrame(-1, 20.0f, i2 | 48, LocaleController.isRTL ? 28.0f : (float) (padding + 68), 10.0f, LocaleController.isRTL ? (float) (padding + 68) : 28.0f, 0.0f));
        this.valueTextView = new SimpleTextView(context);
        this.valueTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText));
        this.valueTextView.setTextSize(14);
        simpleTextView = this.valueTextView;
        if (LocaleController.isRTL) {
            i = 5;
        } else {
            i = 3;
        ...
        addView(view, LayoutHelper.createFrame(-1, 20.0f, i2 | 48, LocaleController.isRTL ? 28.0f : (float) (padding + 68), 36.0f, LocaleController.isRTL ? (float) (padding + 68) : 28.0f, 0.0f));
    ...
    public void setData(String title, String text, int resId, boolean showOptionButton) {
        ...
        this.optionsButton.setVisibility(showOptionButton ? 0 : 4);
