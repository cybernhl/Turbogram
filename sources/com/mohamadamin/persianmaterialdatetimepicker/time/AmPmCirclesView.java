...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        this.mUnselectedColor = res.getColor(C0429R.color.mdtp_white);
        this.mSelectedColor = res.getColor(C0429R.color.mdtp_accent_color);
        this.mTouchedColor = res.getColor(C0429R.color.mdtp_accent_color_dark);
        this.mAmPmTextColor = res.getColor(C0429R.color.mdtp_ampm_text_color);
        this.mAmPmSelectedTextColor = res.getColor(C0429R.color.mdtp_white);
        this.mSelectedAlpha = 255;
        this.mPaint.setTypeface(Typeface.create(res.getString(C0429R.string.mdtp_sans_serif), 0));
    ...
    void setTheme(Context context, boolean themeDark) {
        Resources res = context.getResources();
        if (themeDark) {
            this.mUnselectedColor = res.getColor(C0429R.color.mdtp_circle_background_dark_theme);
            this.mSelectedColor = res.getColor(C0429R.color.mdtp_red);
            this.mAmPmTextColor = res.getColor(C0429R.color.mdtp_white);
            this.mSelectedAlpha = 255;
            return;
        }
        this.mUnselectedColor = res.getColor(C0429R.color.mdtp_white);
