...
import com.mohamadamin.persianmaterialdatetimepicker.C0429R;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    class C04414 implements OnClickListener {
        C04414() {
        }
    ...
    class C04425 implements OnClickListener {
        C04425() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(C0429R.layout.mdtp_time_picker_dialog, null);
        TimePickerDialog timePickerDialog = this;
        KeyboardListener keyboardListener = new KeyboardListener();
        view.findViewById(C0429R.id.time_picker_dialog).setOnKeyListener(keyboardListener);
        Resources res = getResources();
        this.mHourPickerDescription = res.getString(C0429R.string.mdtp_hour_picker_description);
        this.mSelectHours = res.getString(C0429R.string.mdtp_select_hours);
        this.mMinutePickerDescription = res.getString(C0429R.string.mdtp_minute_picker_description);
        this.mSelectMinutes = res.getString(C0429R.string.mdtp_select_minutes);
        this.mSelectedColor = res.getColor(C0429R.color.mdtp_white);
        this.mUnselectedColor = res.getColor(C0429R.color.mdtp_accent_color_focused);
        this.mHourView = (TextView) view.findViewById(C0429R.id.hours);
        this.mHourView.setOnKeyListener(keyboardListener);
        this.mHourSpaceView = (TextView) view.findViewById(C0429R.id.hour_space);
        this.mMinuteSpaceView = (TextView) view.findViewById(C0429R.id.minutes_space);
        this.mMinuteView = (TextView) view.findViewById(C0429R.id.minutes);
        this.mMinuteView.setOnKeyListener(keyboardListener);
        this.mAmPmTextView = (TextView) view.findViewById(C0429R.id.ampm_label);
        ...
        this.mTimePicker = (RadialPickerLayout) view.findViewById(C0429R.id.time_picker);
        ...
        this.mHourView.setOnClickListener(new C04381());
        this.mMinuteView.setOnClickListener(new C04392());
        this.mOkButton = (Button) view.findViewById(C0429R.id.ok);
        this.mOkButton.setOnClickListener(new C04403());
        ...
        Button mCancelButton = (Button) view.findViewById(C0429R.id.cancel);
        mCancelButton.setOnClickListener(new C04414());
        ...
        this.mAmPmHitspace = view.findViewById(C0429R.id.ampm_hitspace);
        if (this.mIs24HourMode) {
            this.mAmPmTextView.setVisibility(8);
            LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            layoutParams.addRule(13);
            ((TextView) view.findViewById(C0429R.id.separator)).setLayoutParams(layoutParams);
        } else {
            this.mAmPmTextView.setVisibility(0);
            updateAmPmDisplay(this.mInitialHourOfDay < 12 ? 0 : 1);
            this.mAmPmHitspace.setOnClickListener(new C04425());
        }
        this.mAllowAutoAdvance = true;
        setHour(this.mInitialHourOfDay, true);
        setMinute(this.mInitialMinute);
        this.mDoublePlaceholderText = res.getString(C0429R.string.mdtp_time_placeholder);
        this.mDeletedKeyFormat = res.getString(C0429R.string.mdtp_deleted_key);
        ...
        TextView timePickerHeader = (TextView) view.findViewById(C0429R.id.time_picker_header);
        ...
        int white = res.getColor(C0429R.color.mdtp_white);
        int accent = res.getColor(C0429R.color.mdtp_accent_color);
        int circleBackground = res.getColor(C0429R.color.mdtp_circle_background);
        int line = res.getColor(C0429R.color.mdtp_line_background);
        int timeDisplay = res.getColor(C0429R.color.mdtp_numbers_text_color);
        ColorStateList doneTextColor = res.getColorStateList(C0429R.color.mdtp_done_text_color);
        int doneBackground = C0429R.drawable.mdtp_done_background_color;
        int backgroundColor = res.getColor(C0429R.color.mdtp_background_color);
        int darkBackgroundColor = res.getColor(C0429R.color.mdtp_light_gray);
        int darkGray = res.getColor(C0429R.color.mdtp_dark_gray);
        int lightGray = res.getColor(C0429R.color.mdtp_light_gray);
        int darkLine = res.getColor(C0429R.color.mdtp_line_dark);
        ColorStateList darkDoneTextColor = res.getColorStateList(C0429R.color.mdtp_done_text_color_dark);
        int darkDoneBackground = C0429R.drawable.mdtp_done_background_color_dark;
        ...
        View findViewById = view.findViewById(C0429R.id.time_picker_dialog);
        if (!this.mThemeDark) {
