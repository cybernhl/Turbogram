...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle, boolean disappearsOut, int selectionDegrees, boolean isInnerCircle) {
        ...
        this.mPaint.setColor(res.getColor(C0429R.color.mdtp_accent_color));
        ...
        if (hasInnerCircle) {
            ...
            this.mOuterNumbersRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_numbers_radius_multiplier_outer));
        } else {
            this.mNumbersRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_numbers_radius_multiplier_normal));
        }
        this.mSelectionRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_selection_radius_multiplier));
    ...
    void setTheme(Context context, boolean themeDark) {
        ...
        Resources res = context.getResources();
        if (themeDark) {
            color = res.getColor(C0429R.color.mdtp_red);
            this.mSelectionAlpha = 255;
        } else {
            color = res.getColor(C0429R.color.mdtp_accent_color);
            this.mSelectionAlpha = 255;
        }
