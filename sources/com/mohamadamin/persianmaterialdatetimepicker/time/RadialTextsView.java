...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts, boolean is24HourMode, boolean disappearsOut) {
        ...
        this.mPaint.setColor(res.getColor(C0429R.color.mdtp_numbers_text_color));
        this.mTypefaceLight = Typeface.create(res.getString(C0429R.string.mdtp_radial_numbers_typeface), 0);
        this.mTypefaceRegular = Typeface.create(res.getString(C0429R.string.mdtp_sans_serif), 0);
        this.mPaint.setAntiAlias(true);
        this.mPaint.setTextAlign(Align.CENTER);
        this.mSelectedPaint.setColor(res.getColor(C0429R.color.mdtp_white));
        ...
        if (is24HourMode) {
            this.mCircleRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_circle_radius_multiplier_24HourMode));
        } else {
            this.mCircleRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_circle_radius_multiplier));
            this.mAmPmCircleRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_ampm_circle_radius_multiplier));
        }
        this.mTextGridHeights = new float[7];
        this.mTextGridWidths = new float[7];
        if (this.mHasInnerCircle) {
            this.mNumbersRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_numbers_radius_multiplier_outer));
            this.mTextSizeMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_text_size_multiplier_outer));
            this.mInnerNumbersRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_numbers_radius_multiplier_inner));
            this.mInnerTextSizeMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_text_size_multiplier_inner));
            this.mInnerTextGridHeights = new float[7];
            this.mInnerTextGridWidths = new float[7];
        } else {
            this.mNumbersRadiusMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_numbers_radius_multiplier_normal));
            this.mTextSizeMultiplier = Float.parseFloat(res.getString(C0429R.string.mdtp_text_size_multiplier_normal));
        }
    ...
    void setTheme(Context context, boolean themeDark) {
        ...
        if (themeDark) {
            textColor = res.getColor(C0429R.color.mdtp_white);
        } else {
            textColor = res.getColor(C0429R.color.mdtp_numbers_text_color);
        }
