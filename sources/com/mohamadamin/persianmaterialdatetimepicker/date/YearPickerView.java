...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    public YearPickerView(Context context, DatePickerController controller) {
        ...
        this.mViewSize = res.getDimensionPixelOffset(C0429R.dimen.mdtp_date_picker_view_animator_height);
        this.mChildSize = res.getDimensionPixelOffset(C0429R.dimen.mdtp_year_label_height);
    ...
    private void init(Context context) {
        ...
        this.mAdapter = new YearAdapter(context, C0429R.layout.mdtp_year_label_text_view, LanguageUtils.getPersianNumbers(years));
