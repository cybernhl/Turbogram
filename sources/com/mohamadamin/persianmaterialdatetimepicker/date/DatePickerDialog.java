...
public class DatePickerDialog extends DialogFragment implements OnClickListener, DatePickerController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(C0429R.layout.mdtp_date_picker_dialog, null);
        this.mDayOfWeekView = (TextView) view.findViewById(C0429R.id.date_picker_header);
        this.mMonthAndDayView = (LinearLayout) view.findViewById(C0429R.id.date_picker_month_and_day);
        this.mMonthAndDayView.setOnClickListener(this);
        this.mSelectedMonthTextView = (TextView) view.findViewById(C0429R.id.date_picker_month);
        this.mSelectedDayTextView = (TextView) view.findViewById(C0429R.id.date_picker_day);
        this.mYearView = (TextView) view.findViewById(C0429R.id.date_picker_year);
        ...
        this.mDayPickerDescription = res.getString(C0429R.string.mdtp_day_picker_description);
        this.mSelectDay = res.getString(C0429R.string.mdtp_select_day);
        this.mYearPickerDescription = res.getString(C0429R.string.mdtp_year_picker_description);
        this.mSelectYear = res.getString(C0429R.string.mdtp_select_year);
        view.setBackgroundColor(activity.getResources().getColor(this.mThemeDark ? C0429R.color.mdtp_date_picker_view_animator_dark_theme : C0429R.color.mdtp_date_picker_view_animator));
        this.mAnimator = (AccessibleDateAnimator) view.findViewById(C0429R.id.animator);
        ...
        Button okButton = (Button) view.findViewById(C0429R.id.ok);
        okButton.setOnClickListener(new C04301());
        okButton.setTypeface(TypefaceHelper.get(activity, "Roboto-Medium"));
        Button cancelButton = (Button) view.findViewById(C0429R.id.cancel);
        cancelButton.setOnClickListener(new C04312());
    ...
    public void onClick(View v) {
        tryVibrate();
        if (v.getId() == C0429R.id.date_picker_year) {
            setCurrentView(1);
        } else if (v.getId() == C0429R.id.date_picker_month_and_day) {
            setCurrentView(0);
        }
    }
