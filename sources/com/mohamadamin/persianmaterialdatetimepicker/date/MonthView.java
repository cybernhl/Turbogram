...
public abstract class MonthView extends View {
    ...
    protected class MonthViewTouchHelper extends ExploreByTouchHelper {
        ...
        protected CharSequence getItemDescription(int day) {
            ...
            return MonthView.this.getContext().getString(C0429R.string.mdtp_item_is_selected, new Object[]{date});
        }
    }
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        ...
        this.mDayOfWeekTypeface = res.getString(C0429R.string.mdtp_day_of_week_label_typeface);
        this.mMonthTitleTypeface = res.getString(C0429R.string.mdtp_sans_serif);
        if (this.mController != null && this.mController.isThemeDark()) {
            darkTheme = true;
        }
        if (darkTheme) {
            this.mDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_normal_dark_theme);
            this.mMonthDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_month_day_dark_theme);
            this.mDisabledDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_disabled_dark_theme);
            this.mHighlightedDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_highlighted_dark_theme);
        } else {
            this.mDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_normal);
            this.mMonthDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_month_day);
            this.mDisabledDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_disabled);
            this.mHighlightedDayTextColor = res.getColor(C0429R.color.mdtp_date_picker_text_highlighted);
        }
        this.mSelectedDayTextColor = res.getColor(C0429R.color.mdtp_white);
        this.mTodayNumberColor = res.getColor(C0429R.color.mdtp_accent_color);
        this.mMonthTitleColor = res.getColor(C0429R.color.mdtp_white);
        this.mStringBuilder = new StringBuilder(50);
        MINI_DAY_NUMBER_TEXT_SIZE = res.getDimensionPixelSize(C0429R.dimen.mdtp_day_number_size);
        MONTH_LABEL_TEXT_SIZE = res.getDimensionPixelSize(C0429R.dimen.mdtp_month_label_size);
        MONTH_DAY_LABEL_TEXT_SIZE = res.getDimensionPixelSize(C0429R.dimen.mdtp_month_day_label_text_size);
        MONTH_HEADER_SIZE = res.getDimensionPixelOffset(C0429R.dimen.mdtp_month_list_item_header_height);
        DAY_SELECTED_CIRCLE_SIZE = res.getDimensionPixelSize(C0429R.dimen.mdtp_day_number_select_circle_radius);
        this.mRowHeight = (res.getDimensionPixelOffset(C0429R.dimen.mdtp_date_picker_view_animator_height) - getMonthHeaderSize()) / 6;
