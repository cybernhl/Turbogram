...
public class TextViewWithCircularIndicator extends TextView {
    ...
    public TextViewWithCircularIndicator(Context context, AttributeSet attrs) {
        ...
        this.mCircleColor = res.getColor(C0429R.color.mdtp_accent_color);
        this.mRadius = res.getDimensionPixelOffset(C0429R.dimen.mdtp_month_select_circle_radius);
        this.mItemIsSelectedText = context.getResources().getString(C0429R.string.mdtp_item_is_selected);
        init();
    }
