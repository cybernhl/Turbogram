...
public class TrackProductionApertureDimensionsAtom extends AbstractFullBox {
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_3 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setHeight", "com.googlecode.mp4parser.boxes.apple.TrackProductionApertureDimensionsAtom", "double", MonthView.VIEW_PARAMS_HEIGHT, "", "void"), 56);
    }
