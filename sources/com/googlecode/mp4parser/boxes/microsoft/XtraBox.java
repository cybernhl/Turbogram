...
public class XtraBox extends AbstractBox {
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_4 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "getFirstLongValue", "com.googlecode.mp4parser.boxes.microsoft.XtraBox", "java.lang.String", "name", "", "java.lang.Long"), (int) Callback.DEFAULT_DRAG_ANIMATION_DURATION);
    ...
    private static void writeAsciiString(ByteBuffer dest, String s) {
        try {
            dest.put(s.getBytes(C0246C.ASCII_NAME));
    ...
    private static String readAsciiString(ByteBuffer content, int length) {
        ...
        content.get(s);
        try {
            return new String(s, C0246C.ASCII_NAME);
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException("Shouldn't happen", e);
        }
    }
