...
public abstract class AbstractFullBox extends AbstractBox implements FullBox {
    ...
    private static void ajc$preClinit() {
        ...
        ajc$tjp_0 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setVersion", "com.googlecode.mp4parser.AbstractFullBox", "int", ProviderConstants.API_COLNAME_FEATURE_VERSION, "", "void"), 51);
