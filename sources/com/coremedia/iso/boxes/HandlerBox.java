...
public class HandlerBox extends AbstractFullBox {
    ...
    public void _parseDetails(ByteBuffer content) {
        ...
        this.f374a = IsoTypeReader.readUInt32(content);
        this.f375b = IsoTypeReader.readUInt32(content);
        this.f376c = IsoTypeReader.readUInt32(content);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter.writeUInt32(byteBuffer, this.f374a);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f375b);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f376c);
        if (this.name != null) {
