...
final class zzx {
    ...
    final zzy zzc(Context context, String str) {
        zzy zzy = new zzy(zza.zzb(), System.currentTimeMillis());
    ...
    private final void zza(Context context, String str, zzy zzy) {
        ...
        edit.putString(zzav.zzd(str, "|P|"), zzy.zzu());
        edit.putString(zzav.zzd(str, "|K|"), zzy.zzv());
        edit.putString(zzav.zzd(str, "cre"), String.valueOf(zzy.zzbp));
        edit.commit();
    }
