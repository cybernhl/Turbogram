...
public class FirebaseInstanceId {
    ...
    private class zza {
        ...
        final synchronized void setEnabled(boolean z) {
            ...
            Editor edit = this.zzba.zzaj.getApplicationContext().getSharedPreferences("com.google.firebase.messaging", 0).edit();
    ...
    private FirebaseInstanceId(FirebaseApp firebaseApp, zzam zzam, Executor executor, Executor executor2, Subscriber subscriber) {
        this.zzam = new zzap();
        this.zzao = false;
        ...
        if (this.zzal == null) {
            ...
            if (messagingChannel == null || !messagingChannel.isAvailable()) {
                this.zzal = new zzq(firebaseApp, zzam, executor);
            } else {
    ...
    public void deleteToken(String str, String str2) throws IOException {
        ...
        String zzd = zzd(str2);
        zza(this.zzal.deleteToken(zzh(), zzaw.zza(zzb(str, zzd)), str, zzd));
        zzag.zzc("", str, zzd);
    }
