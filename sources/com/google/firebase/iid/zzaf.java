...
final /* synthetic */ class zzaf implements Runnable {
    ...
    L_0x0009:
        return;
    L_0x000a:
        r0 = r1.zzbw;	 Catch:{ all -> 0x0017 }
        r0 = r0.isEmpty();	 Catch:{ all -> 0x0017 }
        if (r0 == 0) goto L_0x001a;
    L_0x0012:
        r1.zzy();	 Catch:{ all -> 0x0017 }
        monitor-exit(r1);	 Catch:{ all -> 0x0017 }
        goto L_0x0009;
    L_0x0017:
        r0 = move-exception;
    ...
    L_0x001a:
        ...
        r0 = (com.google.firebase.iid.zzaj) r0;	 Catch:{ all -> 0x0017 }
        r2 = r1.zzbx;	 Catch:{ all -> 0x0017 }
        r3 = r0.zzcc;	 Catch:{ all -> 0x0017 }
        r2.put(r3, r0);	 Catch:{ all -> 0x0017 }
        r2 = r1.zzby;	 Catch:{ all -> 0x0017 }
        r2 = r2.zzbr;	 Catch:{ all -> 0x0017 }
        r3 = new com.google.firebase.iid.zzag;	 Catch:{ all -> 0x0017 }
    ...
    L_0x006e:
        ...
        r3.putBundle(r2, r0);
        r4.setData(r3);
        r0 = r1.zzbv;	 Catch:{ RemoteException -> 0x00af }
