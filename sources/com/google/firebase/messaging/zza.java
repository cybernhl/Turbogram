                                ...
                                if (PlatformVersion.isAtLeastO() || this.zzv.getApplicationInfo().targetSdkVersion <= 25) {
                                    ...
                                    if (PlatformVersion.isAtLeastO()) {
                                        ...
                                        if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                                            notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.zzv.getString(C0406R.string.fcm_fallback_notification_channel_label), 3));
                                        }
