...
public class FirebaseApp {
    ...
    class C03951 implements com.google.android.gms.common.api.internal.BackgroundDetector.BackgroundStateChangeListener {
        C03951() {
        }
        ...
        synchronized (zzg) {
            ...
            if (firebaseApp != null) {
                ...
                if (zzd.isEmpty()) {
                    ...
                    str = "Available app names: " + TextUtils.join(", ", zzd);
                }
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions options, String name) {
        ...
        if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
            ...
            BackgroundDetector.getInstance().addListener(new C03951());
        }
