...
final class zzer<T> {
    ...
    public final void zza(zzhg zzhg, ResultHolder<Status> resultHolder, T t) throws RemoteException {
        synchronized (this.zzeb) {
    ...
    public final void zza(zzhg zzhg, ResultHolder<Status> resultHolder, T t, zzhk<T> zzhk) throws RemoteException {
        synchronized (this.zzeb) {
