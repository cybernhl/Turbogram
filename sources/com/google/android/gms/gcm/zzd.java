            ...
            if (TextUtils.isEmpty(zzd3)) {
                ...
                if (intent != null) {
                    ...
                    if (PlatformVersion.isAtLeastO() || this.zzk.getApplicationInfo().targetSdkVersion < 26) {
                        smallIcon = new Builder(this.zzk).setAutoCancel(true).setSmallIcon(i);
                        ...
                        if (PlatformVersion.isAtLeastO()) {
                            ...
                            if (this.zzl != null) {
                                ...
                                if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                                    notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.zzk.getString(C0379R.string.gcm_fallback_notification_channel_label), 3));
                                }
                    ...
                    notificationManager.notify(zzd4, 0, build);
                    return true;
                }
                intent2 = intent;
            }
