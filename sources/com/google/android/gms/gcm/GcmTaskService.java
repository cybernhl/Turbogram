...
public abstract class GcmTaskService extends Service {
    ...
    class zze implements Runnable {
        ...
        zze(GcmTaskService gcmTaskService, String str, @NonNull IBinder iBinder, Bundle bundle, List<Uri> list) {
            zzg zzg;
            this.zzy = gcmTaskService;
            this.tag = str;
            if (iBinder == null) {
        ...
        zze(GcmTaskService gcmTaskService, String str, @NonNull Messenger messenger, Bundle bundle, List<Uri> list) {
            this.zzy = gcmTaskService;
            this.tag = str;
            this.zzab = messenger;
            this.extras = bundle;
