...
public final class zzbx extends ViewSwitcher {
    ...
    public final void zzfs() {
        zzakb.m589v("Disable position monitoring on adFrame.");
        if (this.zzaee != null) {
            this.zzaee.zzsd();
        }
    }
    ...
    public final void zzft() {
        zzakb.m589v("Enable debug gesture detector on adFrame.");
        this.zzaef = true;
    }

    public final void zzfu() {
        zzakb.m589v("Disable debug gesture detector on adFrame.");
        this.zzaef = false;
    }
}
