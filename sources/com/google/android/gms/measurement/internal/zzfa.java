...
public class zzfa implements zzcq {
    ...
    @WorkerThread
    private final void zza(zzff zzff) {
        this.zzadj.zzgn().zzaf();
        zzez zzq = new zzq(this);
        zzq.zzq();
        this.zzatf = zzq;
    ...
    @WorkerThread
    final void zzc(zzad zzad, String str) {
        ...
        zzad zzad2 = zzad;
        zzc(zzad2, new zzh(str, zzbl.getGmpAppId(), zzbl.zzak(), zzbl.zzha(), zzbl.zzhb(), zzbl.zzhc(), zzbl.zzhd(), null, zzbl.isMeasurementEnabled(), false, zzbl.getFirebaseInstanceId(), zzbl.zzhq(), 0, 0, zzbl.zzhr(), zzbl.zzhs(), false, zzbl.zzgw()));
    }

    @WorkerThread
    final void zzc(zzad zzad, zzh zzh) {
        ...
        if (zzh.zzagg) {
            ...
            try {
                ...
                while (i < size) {
                    ...
                    i++;
                    zzd(new zzad((zzad) obj, j), zzh);
                }
                zzjq = zzjq();
                String str2 = zzad.name;
                Preconditions.checkNotEmpty(str);
                ...
                for (zzl zzl3 : r2) {
                    if (zzl3 != null) {
                        ...
                        zzfj zzfj = new zzfj(zzl3.packageName, zzl3.origin, zzfh.name, j, zzfh.getValue());
                        if (zzjq().zza(zzfj)) {
    ...
    @WorkerThread
    private final void zzd(zzad zzad, zzh zzh) {
        Preconditions.checkNotNull(zzh);
        Preconditions.checkNotEmpty(zzh.packageName);
        ...
        if (!zzh.zzagg) {
            zzg(zzh);
        } else if (zzln().zzo(str, zzad.name)) {
            Object obj;
            this.zzadj.zzgo().zzjg().zze("Dropping blacklisted event. appId", zzap.zzbv(str), this.zzadj.zzgl().zzbs(zzad.name));
            if (zzln().zzck(str) || zzln().zzcl(str)) {
                obj = 1;
            } else {
                obj = null;
            }
            if (obj == null && !"_err".equals(zzad.name)) {
                this.zzadj.zzgm().zza(str, 11, "_ev", zzad.name, 0);
            }
            if (obj != null) {
                zzg zzbl = zzjq().zzbl(str);
                if (zzbl != null) {
            ...
            if (this.zzadj.zzgo().isLoggable(2)) {
                this.zzadj.zzgo().zzjl().zzg("Logging event", this.zzadj.zzgl().zzb(zzad));
            }
            zzjq().beginTransaction();
            zzg(zzh);
            if (("_iap".equals(zzad.name) || Event.ECOMMERCE_PURCHASE.equals(zzad.name)) && !zza(str, zzad)) {
                zzjq().setTransactionSuccessful();
                zzjq().endTransaction();
                return;
            }
            zzgi zzgi;
            try {
                boolean zzcq = zzfk.zzcq(zzad.name);
                boolean equals = "_err".equals(zzad.name);
                ...
                if (zzcq) {
                    ...
                    if (intValue > 0) {
                        ...
                        this.zzadj.zzgm().zza(str, 16, "_ev", zzad.name, 0);
                        zzjq().setTransactionSuccessful();
                        zzjq().endTransaction();
                        return;
                    }
                ...
                if (equals) {
                    intValue = zza.zzaht - ((long) Math.max(0, Math.min(1000000, this.zzadj.zzgq().zzb(zzh.packageName, zzaf.zzajo))));
                    if (intValue > 0) {
                        if (intValue == 1) {
                ...
                Bundle zziv = zzad.zzaid.zziv();
                this.zzadj.zzgm().zza(zziv, "_o", zzad.origin);
                ...
                zzy zzy2 = new zzy(this.zzadj, zzad.origin, str, zzad.name, zzad.zzaip, 0, zziv);
                zzz zzg = zzjq().zzg(str, zzy2.name);
                if (zzg != null) {
                    zzy2 = zzy2.zza(this.zzadj, zzg.zzaig);
                    zzai = zzg.zzai(zzy2.timestamp);
                    zzy = zzy2;
                } else if (zzjq().zzbp(str) < 500 || !zzcq) {
                    zzai = new zzz(str, zzy2.name, 0, 0, zzy2.timestamp, 0, null, null, null, null);
                    zzy = zzy2;
                } else {
                    this.zzadj.zzgo().zzjd().zzd("Too many event names used, ignoring event. appId, name, supported count", zzap.zzbv(str), this.zzadj.zzgl().zzbs(zzy2.name), Integer.valueOf(500));
                ...
                Preconditions.checkArgument(zzy.zztt.equals(zzh.packageName));
                zzgi = new zzgi();
                zzgi.zzaxa = Integer.valueOf(1);
                zzgi.zzaxi = "android";
                zzgi.zztt = zzh.packageName;
                zzgi.zzage = zzh.zzage;
                zzgi.zzts = zzh.zzts;
                zzgi.zzaxu = zzh.zzagd == -2147483648L ? null : Integer.valueOf((int) zzh.zzagd);
                zzgi.zzaxm = Long.valueOf(zzh.zzadt);
                zzgi.zzafx = zzh.zzafx;
                zzgi.zzawj = zzh.zzagk;
                zzgi.zzaxq = zzh.zzagf == 0 ? null : Long.valueOf(zzh.zzagf);
                Pair zzby = this.zzadj.zzgp().zzby(zzh.packageName);
                if (zzby == null || TextUtils.isEmpty((CharSequence) zzby.first)) {
                    if (!this.zzadj.zzgk().zzl(this.zzadj.getContext()) && zzh.zzagj) {
                ...
                this.zzadj.zzgk().zzcl();
                zzgi.zzaxj = VERSION.RELEASE;
                zzgi.zzaxl = Integer.valueOf((int) this.zzadj.zzgk().zzis());
                zzgi.zzaia = this.zzadj.zzgk().zzit();
                zzgi.zzaxn = null;
                zzgi.zzaxd = null;
                zzgi.zzaxe = null;
                zzgi.zzaxf = null;
                zzgi.zzaxz = Long.valueOf(zzh.zzagh);
                if (this.zzadj.isEnabled() && zzn.zzhz()) {
                    zzgi.zzaya = null;
                }
                zzg zzbl2 = zzjq().zzbl(zzh.packageName);
                if (zzbl2 == null) {
                    zzbl2 = new zzg(this.zzadj, zzh.packageName);
                    zzbl2.zzam(this.zzadj.zzgm().zzmf());
                    zzbl2.zzaq(zzh.zzafz);
                    zzbl2.zzan(zzh.zzafx);
                    zzbl2.zzap(this.zzadj.zzgp().zzbz(zzh.packageName));
                    zzbl2.zzx(0);
                    zzbl2.zzs(0);
                    zzbl2.zzt(0);
                    zzbl2.setAppVersion(zzh.zzts);
                    zzbl2.zzu(zzh.zzagd);
                    zzbl2.zzar(zzh.zzage);
                    zzbl2.zzv(zzh.zzadt);
                    zzbl2.zzw(zzh.zzagf);
                    zzbl2.setMeasurementEnabled(zzh.zzagg);
                    zzbl2.zzag(zzh.zzagh);
                    zzjq().zza(zzbl2);
                }
                zzgi.zzafw = zzbl2.getAppInstanceId();
                zzgi.zzafz = zzbl2.getFirebaseInstanceId();
                List zzbk = zzjq().zzbk(zzh.packageName);
                zzgi.zzaxc = new zzgl[zzbk.size()];
                for (int i = 0; i < zzbk.size(); i++) {
                    zzgl zzgl = new zzgl();
                    zzgi.zzaxc[i] = zzgl;
                    zzgl.name = ((zzfj) zzbk.get(i)).name;
                    zzgl.zzayl = Long.valueOf(((zzfj) zzbk.get(i)).zzaue);
                    zzjo().zza(zzgl, ((zzfj) zzbk.get(i)).value);
                }
                long zza2 = zzjq().zza(zzgi);
                zzq zzjq = zzjq();
                if (zzy.zzaid != null) {
                    ...
                    z = zzln().zzp(zzy.zztt, zzy.name);
                    zzr zza3 = zzjq().zza(zzls(), zzy.zztt, false, false, false, false, false);
                    if (z && zza3.zzahu < ((long) this.zzadj.zzgq().zzat(zzy.zztt))) {
                        z = true;
                        if (zzjq.zza(zzy, zza2, z)) {
                            this.zzatl = 0;
                        }
                        zzjq().setTransactionSuccessful();
                        if (this.zzadj.zzgo().isLoggable(2)) {
                            this.zzadj.zzgo().zzjl().zzg("Event recorded", this.zzadj.zzgl().zza(zzy));
                        }
                        zzjq().endTransaction();
                        zzlv();
                ...
                this.zzadj.zzgo().zzjd().zze("Data loss. Failed to insert raw event metadata. appId", zzap.zzbv(zzgi.zztt), e);
            } catch (Throwable th) {
                zzjq().endTransaction();
            }
        }
    ...
    private final boolean zza(String str, zzad zzad) {
        long round;
        Object string = zzad.zzaid.getString(Param.CURRENCY);
        if (Event.ECOMMERCE_PURCHASE.equals(zzad.name)) {
            double doubleValue = zzad.zzaid.zzbq(Param.VALUE).doubleValue() * 1000000.0d;
            if (doubleValue == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                doubleValue = ((double) zzad.zzaid.getLong(Param.VALUE).longValue()) * 1000000.0d;
            }
            ...
            round = zzad.zzaid.getLong(Param.VALUE).longValue();
        }
        if (!TextUtils.isEmpty(string)) {
            ...
            if (toUpperCase.matches("[A-Z]{3}")) {
                ...
                if (zzi == null || !(zzi.value instanceof Long)) {
                    ...
                    zzi = new zzfj(str, zzad.origin, concat, this.zzadj.zzbx().currentTimeMillis(), Long.valueOf(round));
                } else {
                    valueOf = str;
                    zzi = new zzfj(valueOf, zzad.origin, concat, this.zzadj.zzbx().currentTimeMillis(), Long.valueOf(round + ((Long) zzi.value).longValue()));
                }
                if (!zzjq().zza(zzi)) {
                        ...
                        if (!zzb.isEmpty()) {
                            ...
                            if (obj != null) {
                                for (i = 0; i < zzb.size(); i++) {
                                    zzgi = (zzgi) ((Pair) zzb.get(i)).first;
                                    if (!TextUtils.isEmpty(zzgi.zzaxo) && !zzgi.zzaxo.equals(obj)) {
                            ...
                            subList = zzb;
                            zzgh zzgh = new zzgh();
                            zzgh.zzawy = new zzgi[subList.size()];
                            ...
                            for (i = 0; i < zzgh.zzawy.length; i++) {
                                zzgh.zzawy[i] = (zzgi) ((Pair) subList.get(i)).first;
                                arrayList.add((Long) ((Pair) subList.get(i)).second);
                                zzgh.zzawy[i].zzaxn = Long.valueOf(this.zzadj.zzgq().zzhc());
                                zzgh.zzawy[i].zzaxd = Long.valueOf(currentTimeMillis);
                                zzgi = zzgh.zzawy[i];
                                this.zzadj.zzgr();
                                zzgi.zzaxs = Boolean.valueOf(false);
                                if (obj2 == null) {
                                    zzgh.zzawy[i].zzaya = null;
                                }
                            }
                            if (this.zzadj.zzgo().isLoggable(2)) {
                                obj2 = zzjo().zzb(zzgh);
    ...
    private static zzgg[] zza(zzgg[] zzggArr, @NonNull String str) {
        ...
        while (i < zzggArr.length) {
            if (str.equals(zzggArr[i].name)) {
                break;
            }
            i++;
        }
        i = -1;
        return i < 0 ? zzggArr : zza(zzggArr, i);
    }
    ...
    private static zzgg[] zza(zzgg[] zzggArr, int i, String str) {
        ...
        zzgg3.name = "_ev";
        zzgg3.zzamp = str;
        obj[obj.length - 2] = zzgg2;
        obj[obj.length - 1] = zzgg3;
        return obj;
    }
    ...
    private final void zzb(zzg zzg) {
        ...
        if (!TextUtils.isEmpty(zzg.getGmpAppId()) || (zzn.zzic() && !TextUtils.isEmpty(zzg.zzgw()))) {
            ...
            try {
                ...
                charSequence = zzln().zzcg(zzg.zzal());
                ...
                zzav zzfd = new zzfd(this);
                zzlo.zzaf();
                zzlo.zzcl();
                Preconditions.checkNotNull(url);
                Preconditions.checkNotNull(zzfd);
                zzlo.zzgn().zzd(new zzax(zzlo, zzal, url, null, map, zzfd));
                return;
            } catch (MalformedURLException e) {
    ...
    final void zzd(zzh zzh) {
        ...
        zzh zza = zza(this.zzadj.getContext(), zzh.packageName, zzh.zzafx, zzh.zzagg, zzh.zzagi, zzh.zzagj, zzh.zzagx, zzh.zzagk);
    ...
    private final zzh zza(Context context, String str, String str2, boolean z, boolean z2, boolean z3, long j, String str3) {
        ...
        try {
            ...
            return new zzh(str, str2, str5, (long) i, str4, this.zzadj.zzgq().zzhc(), this.zzadj.zzgm().zzd(context, str), null, z, false, "", 0, j2, 0, z2, z3, false, str3);
    ...
    @WorkerThread
    final void zzb(zzfh zzfh, zzh zzh) {
        int i = 0;
        zzaf();
        zzlr();
        if (!TextUtils.isEmpty(zzh.zzafx) || !TextUtils.isEmpty(zzh.zzagk)) {
            if (zzh.zzagg) {
                ...
                if (this.zzadj.zzgq().zze(zzh.packageName, zzaf.zzalj) && "_ap".equals(zzfh.name)) {
                    zzi = zzjq().zzi(zzh.packageName, "_ap");
                ...
                if (zzcs != 0) {
                    this.zzadj.zzgm();
                    zza = zzfk.zza(zzfh.name, 24, true);
                    if (zzfh.name != null) {
                        i = zzfh.name.length();
                    }
                    this.zzadj.zzgm().zza(zzh.packageName, zzcs, "_ev", zza, i);
                    return;
                }
                zzcs = this.zzadj.zzgm().zzi(zzfh.name, zzfh.getValue());
                if (zzcs != 0) {
                    this.zzadj.zzgm();
                    zza = zzfk.zza(zzfh.name, 24, true);
                ...
                if (zzj != null) {
                    zzi = new zzfj(zzh.packageName, zzfh.origin, zzfh.name, zzfh.zzaue, zzj);
    ...
    @WorkerThread
    final void zzc(zzfh zzfh, zzh zzh) {
        zzaf();
        zzlr();
        if (!TextUtils.isEmpty(zzh.zzafx) || !TextUtils.isEmpty(zzh.zzagk)) {
            if (zzh.zzagg) {
    ...
    final void zzf(zzh zzh) {
        ...
        if (!TextUtils.isEmpty(zzh.zzafx) || !TextUtils.isEmpty(zzh.zzagk)) {
            ...
            if (!(zzbl == null || !TextUtils.isEmpty(zzbl.getGmpAppId()) || TextUtils.isEmpty(zzh.zzafx))) {
                zzbl.zzy(0);
                zzjq().zza(zzbl);
                zzln().zzci(zzh.packageName);
            }
            if (zzh.zzagg) {
                int i;
                Bundle bundle;
                ...
                if (i2 == 0 || i2 == 1) {
                    ...
                    this.zzadj.zzgo().zzjg().zze("Incorrect app type, assuming installed app. appId, appType", zzap.zzbv(zzh.packageName), Integer.valueOf(i2));
                    i = 0;
                }
                zzjq().beginTransaction();
                zzco zzjq;
                String zzal;
                try {
                    zzbl = zzjq().zzbl(zzh.packageName);
                    if (zzbl != null) {
                        this.zzadj.zzgm();
                        if (zzfk.zza(zzh.zzafx, zzbl.getGmpAppId(), zzh.zzagk, zzbl.zzgw())) {
                ...
                if (zzbl != null) {
                    if (zzbl.zzha() != -2147483648L) {
                        if (zzbl.zzha() != zzh.zzagd) {
                            bundle = new Bundle();
                            bundle.putString("_pv", zzbl.zzak());
                            zzc(new zzad("_au", new zzaa(bundle), "auto", j), zzh);
                        }
                    } else if (!(zzbl.zzak() == null || zzbl.zzak().equals(zzh.zzts))) {
                        bundle = new Bundle();
                        bundle.putString("_pv", zzbl.zzak());
                        zzc(new zzad("_au", new zzaa(bundle), "auto", j), zzh);
                    }
                ...
                zzz zzz = null;
                if (i == 0) {
                    zzz = zzjq().zzg(zzh.packageName, "_f");
                } else if (i == 1) {
                    zzz = zzjq().zzg(zzh.packageName, "_v");
                }
                if (zzz == null) {
                    long j2 = (1 + (j / 3600000)) * 3600000;
                    if (i == 0) {
                        zzb(new zzfh("_fot", j, Long.valueOf(j2), "auto"), zzh);
                        ...
                        if (this.zzadj.getContext().getPackageManager() == null) {
                            ...
                            try {
                                ...
                                this.zzadj.zzgo().zzjd().zze("Package info is null, first open report might be inaccurate. appId", zzap.zzbv(zzh.packageName), e2);
                            }
                            if (packageInfo != null) {
                                if (packageInfo.firstInstallTime != 0) {
                                    ...
                                    zzb(new zzfh("_fi", j, Long.valueOf(obj != null ? 1 : 0), "auto"), zzh);
                                }
                            }
                            try {
                                ...
                                this.zzadj.zzgo().zzjd().zze("Application info is null, first open report might be inaccurate. appId", zzap.zzbv(zzh.packageName), e22);
                        ...
                        zzc(new zzad("_f", new zzaa(bundle2), "auto", j), zzh);
                    } else if (i == 1) {
                        zzb(new zzfh("_fvt", j, Long.valueOf(j2), "auto"), zzh);
                        zzaf();
                        zzlr();
                        bundle = new Bundle();
                        bundle.putLong("_c", 1);
                        ...
                        zzc(new zzad("_v", new zzaa(bundle), "auto", j), zzh);
                    }
                    bundle = new Bundle();
                    bundle.putLong("_et", 1);
                    zzc(new zzad("_e", new zzaa(bundle), "auto", j), zzh);
                } else if (zzh.zzagw) {
                    zzc(new zzad("_cd", new zzaa(new Bundle()), "auto", j), zzh);
                }
                zzjq().setTransactionSuccessful();
                zzjq().endTransaction();
                return;
    ...
    @WorkerThread
    final void zzb(zzl zzl, zzh zzh) {
        boolean z = true;
            ...
            if (zzh.zzagg) {
                ...
                try {
                    ...
                    if (zzj != null && zzj.active) {
                        ...
                        zzl2.zzahb = new zzfh(zzl2.zzahb.name, zzj.zzahb.zzaue, zzl2.zzahb.getValue(), zzj.zzahb.origin);
                        z = false;
                    } else if (TextUtils.isEmpty(zzl2.triggerEventName)) {
                        zzl2.zzahb = new zzfh(zzl2.zzahb.name, zzl2.creationTimestamp, zzl2.zzahb.getValue(), zzl2.zzahb.origin);
                        zzl2.active = true;
                    } else {
                        z = false;
                    }
                    if (zzl2.active) {
                        zzfh zzfh = zzl2.zzahb;
                        zzfj zzfj = new zzfj(zzl2.packageName, zzl2.origin, zzfh.name, zzfh.zzaue, zzfh.getValue());
                        if (zzjq().zza(zzfj)) {
    ...
    @WorkerThread
    final void zzc(zzl zzl, zzh zzh) {
        Preconditions.checkNotNull(zzl);
        Preconditions.checkNotEmpty(zzl.packageName);
        Preconditions.checkNotNull(zzl.zzahb);
        Preconditions.checkNotEmpty(zzl.zzahb.name);
    ...
    @WorkerThread
    public final byte[] zza(@NonNull zzad zzad, @Size(min = 1) String str) {
        zzlr();
        zzaf();
        this.zzadj.zzga();
        ...
        try {
            ...
            if (zzbl == null) {
                ...
                zzgi.zzaxu = num;
                zzgi.zzaxm = Long.valueOf(zzbl.zzhc());
                zzgi.zzafx = zzbl.getGmpAppId();
                if (TextUtils.isEmpty(zzgi.zzafx)) {
                    zzgi.zzawj = zzbl.zzgw();
                }
                zzgi.zzaxq = Long.valueOf(zzbl.zzhd());
                ...
                zzfj zzfj = null;
                if (zzax) {
                    zzfj zzi = zzjq().zzi(zzgi.zztt, "_lte");
                    if (zzi == null || zzi.value == null) {
                        zzfj = new zzfj(zzgi.zztt, "auto", "_lte", this.zzadj.zzbx().currentTimeMillis(), valueOf);
                    } else if (valueOf.longValue() > 0) {
                        zzfj = new zzfj(zzgi.zztt, "auto", "_lte", this.zzadj.zzbx().currentTimeMillis(), Long.valueOf(((Long) zzi.value).longValue() + valueOf.longValue()));
                    } else {
                        zzfj = zzi;
                    }
                }
                ...
                while (i < zzbk.size()) {
                    ...
                    zzgl.zzayl = Long.valueOf(((zzfj) zzbk.get(i)).zzaue);
                    zzjo().zza(zzgl, ((zzfj) zzbk.get(i)).value);
                    if (zzax && "_lte".equals(zzgl.name)) {
                        zzgl.zzawx = (Long) zzfj.value;
                        zzgl.zzayl = Long.valueOf(this.zzadj.zzbx().currentTimeMillis());
                        zzgl3 = zzgl;
                    } else {
                        zzgl3 = zzgl2;
                    }
                ...
                if (zzax && zzgl2 == null) {
                    ...
                    zzgl.zzayl = Long.valueOf(this.zzadj.zzbx().currentTimeMillis());
                    zzgl.zzawx = (Long) zzfj.value;
                    zzgi.zzaxc = (zzgl[]) Arrays.copyOf(zzgi.zzaxc, zzgi.zzaxc.length + 1);
                    zzgi.zzaxc[zzgi.zzaxc.length - 1] = zzgl;
                }
                if (valueOf.longValue() > 0) {
                    zzjq().zza(zzfj);
                }
                Bundle zziv = zzad.zzaid.zziv();
                if ("_iap".equals(zzad.name)) {
                    zziv.putLong("_c", 1);
                    this.zzadj.zzgo().zzjk().zzbx("Marking in-app purchase as real-time");
                    zziv.putLong("_r", 1);
                }
                zziv.putString("_o", zzad.origin);
                if (this.zzadj.zzgm().zzcw(zzgi.zztt)) {
                    this.zzadj.zzgm().zza(zziv, "_dbg", Long.valueOf(1));
                    this.zzadj.zzgm().zza(zziv, "_r", Long.valueOf(1));
                }
                zzz zzg = zzjq().zzg(str, zzad.name);
                if (zzg == null) {
                    zzjq().zza(new zzz(str, zzad.name, 1, 0, zzad.zzaip, 0, null, null, null, null));
                    j = 0;
                } else {
                    j = zzg.zzaig;
                    zzjq().zza(zzg.zzai(zzad.zzaip).zziu());
                }
                zzy zzy = new zzy(this.zzadj, zzad.origin, str, zzad.name, zzad.zzaip, j, zziv);
                zzgf zzgf = new zzgf();
                zzgi.zzaxb = new zzgf[]{zzgf};
                zzgf.zzawu = Long.valueOf(zzy.timestamp);
                zzgf.name = zzy.name;
                ...
                while (it.hasNext()) {
                    ...
                    zzgf.zzawt[i2] = zzgg;
                    zzgg.name = str2;
                    zzjo().zza(zzgg, zzy.zzaid.get(str2));
                    i2 = i;
                }
                zzgi.zzaxt = zza(zzbl.zzal(), zzgi.zzaxc, zzgi.zzaxb);
                zzgi.zzaxe = zzgf.zzawu;
                zzgi.zzaxf = zzgf.zzawu;
                zzha = zzbl.zzgz();
                zzgi.zzaxh = zzha != 0 ? Long.valueOf(zzha) : null;
                long zzgy = zzbl.zzgy();
                if (zzgy != 0) {
                    zzha = zzgy;
                }
                zzgi.zzaxg = zzha != 0 ? Long.valueOf(zzha) : null;
                zzbl.zzhh();
                zzgi.zzaxr = Integer.valueOf((int) zzbl.zzhe());
                zzgi.zzaxn = Long.valueOf(this.zzadj.zzgq().zzhc());
                zzgi.zzaxd = Long.valueOf(this.zzadj.zzbx().currentTimeMillis());
                zzgi.zzaxs = Boolean.TRUE;
                zzbl.zzs(zzgi.zzaxe.longValue());
                zzbl.zzt(zzgi.zzaxf.longValue());
                zzjq().zza(zzbl);
                zzjq().setTransactionSuccessful();
                zzjq().endTransaction();
                try {
                    bArr = new byte[zzgh.zzvu()];
    ...
    final String zzh(zzh zzh) {
        Object e;
        try {
            return (String) this.zzadj.zzgn().zzb(new zzfe(this, zzh)).get(30000, TimeUnit.MILLISECONDS);
