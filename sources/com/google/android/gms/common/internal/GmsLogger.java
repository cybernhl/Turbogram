...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void m564d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void m565d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void m566e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void m567e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void m568i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void m569i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void m570v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void m571v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void m572w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void m573w(String str, String str2, Throwable th) {
        if (canLog(5)) {
