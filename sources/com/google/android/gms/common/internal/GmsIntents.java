...
public class GmsIntents {
    ...
    public static Intent createPlayStoreLightPurchaseFlowIntent(Context context, @Nullable String str, String str2) {
    ...
    public static Intent createShareOnPlusIntent(Activity activity, String str, String str2) {
        Intent intent = IntentBuilder.from(activity).setSubject(str).setText(str2).setType("text/plain").getIntent();
