...
public class Logger {
    ...
    /* renamed from: d */
    public void m574d(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: d */
    public void m575d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: e */
    public void m576e(String str, Throwable th, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr), th);
    }

    /* renamed from: e */
    public void m577e(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: i */
    public void m578i(String str, Throwable th, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr), th);
    }

    /* renamed from: i */
    public void m579i(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: v */
    public void m580v(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: v */
    public void m581v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: w */
    public void m582w(String str, Throwable th, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr), th);
    }

    /* renamed from: w */
    public void m583w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    /* renamed from: w */
    public void m584w(Throwable th) {
        Log.w(this.mTag, th);
    }
