...
public final class WalletFragmentOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final class Builder {
        ...
        public final Builder setFragmentStyle(int i) {
            this.zzgc.zzgb = new WalletFragmentStyle().setStyleResourceId(i);
            return this;
        }
    ...
    public static WalletFragmentOptions zza(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0391R.styleable.WalletFragmentOptions);
        int i = obtainStyledAttributes.getInt(C0391R.styleable.WalletFragmentOptions_appTheme, 0);
        int i2 = obtainStyledAttributes.getInt(C0391R.styleable.WalletFragmentOptions_environment, 1);
        int resourceId = obtainStyledAttributes.getResourceId(C0391R.styleable.WalletFragmentOptions_fragmentStyle, 0);
        int i3 = obtainStyledAttributes.getInt(C0391R.styleable.WalletFragmentOptions_fragmentMode, 1);
