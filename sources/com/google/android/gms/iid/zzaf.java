            ...
            if ("com.google.android.c2dm.intent.REGISTRATION".equals(action) || "com.google.android.gms.iid.InstanceID".equals(action)) {
                ...
                if (stringExtra == null) {
                    ...
                    if (Log.isLoggable("InstanceID", 3)) {
                        ...
                        Log.d(valueOf, action.length() != 0 ? str2.concat(action) : new String(str2));
                    }
                    if (stringExtra2.startsWith("|")) {
                        ...
                        if (split.length > 2) {
                            ...
                            if (valueOf.startsWith(":")) {
                                stringExtra2 = valueOf.substring(1);
                            } else {
                                str = valueOf;
                            }
                        } else {
                ...
                if (matcher.matches()) {
                    ...
                    stringExtra2 = intent.getExtras();
                    stringExtra2.putString("registration_id", valueOf);
                    zzd(action2, stringExtra2);
                } else if (Log.isLoggable("InstanceID", 3)) {
                    valueOf = "InstanceID";
                    str = "Unexpected response string: ";
                    action2 = String.valueOf(stringExtra);
                    Log.d(valueOf, action2.length() != 0 ? str.concat(action2) : new String(str));
                }
            } else if (Log.isLoggable("InstanceID", 3)) {
                valueOf = "InstanceID";
