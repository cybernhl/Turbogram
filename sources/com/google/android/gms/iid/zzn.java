...
final class zzn {
    ...
    private static com.google.android.gms.iid.zzo zzd(java.io.File r8) throws com.google.android.gms.iid.zzp, java.io.IOException {
        /*
        r1 = 0;
    ...
    L_0x0024:
        return r0;
    L_0x0025:
        r2 = zzg(r2, r3);	 Catch:{ Throwable -> 0x0044, all -> 0x004d }
        r3 = "cre";
        r0 = r0.getProperty(r3);	 Catch:{ NumberFormatException -> 0x003d }
        r6 = java.lang.Long.parseLong(r0);	 Catch:{ NumberFormatException -> 0x003d }
        r0 = new com.google.android.gms.iid.zzo;	 Catch:{ Throwable -> 0x0044, all -> 0x004d }
        r0.<init>(r2, r6);	 Catch:{ Throwable -> 0x0044, all -> 0x004d }
        zzd(r1, r4);
        goto L_0x0024;
    L_0x003d:
        r0 = move-exception;
        r2 = new com.google.android.gms.iid.zzp;	 Catch:{ Throwable -> 0x0044, all -> 0x004d }
