...
public class zzaj implements zzm {
            ...
            try {
                ...
                if (inputStream != null) {
                    try {
                        ...
                        zzaf.m587v("Error occurred when closing InputStream", new Object[0]);
                    }
                }
                this.zzbq.zza(null);
                zzau.close();
    ...
    L_0x00f2:
        ...
        r7 = r21.getUrl();
        r5[r6] = r7;
        com.google.android.gms.internal.ads.zzaf.m586e(r2, r5);
    ...
    L_0x01bc:
        ...
        r9[r2] = r6;	 Catch:{ SocketTimeoutException -> 0x0066, MalformedURLException -> 0x009a, IOException -> 0x01e5 }
        com.google.android.gms.internal.ads.zzaf.m585d(r5, r9);	 Catch:{ SocketTimeoutException -> 0x0066, MalformedURLException -> 0x009a, IOException -> 0x01e5 }
    L_0x01d7:
