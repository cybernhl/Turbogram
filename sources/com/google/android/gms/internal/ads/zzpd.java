...
public class zzpd implements zzoz {
            ...
            for (Entry entry : map.entrySet()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        ...
                        jSONObject3.put(MonthView.VIEW_PARAMS_HEIGHT, zzv(view2.getMeasuredHeight()));
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            zzb = new JSONObject();
                            zzb.put("width", 0);
                            zzb.put(MonthView.VIEW_PARAMS_HEIGHT, 0);
    ...
    private final JSONObject zzb(Rect rect) throws JSONException {
        ...
        jSONObject.put(MonthView.VIEW_PARAMS_HEIGHT, zzv(rect.bottom - rect.top));
    ...
    private final JSONObject zzo(View view) {
        ...
        if (view != null) {
            try {
                ...
                jSONObject2.put(MonthView.VIEW_PARAMS_HEIGHT, zzv(view.getMeasuredHeight()));
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.m588e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        }
    }
    ...
    public final boolean recordImpression(Bundle bundle) {
        ...
        zzane.m588e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
        return false;
    }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.m588e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        }
    }
    ...
    public void zza(View view, Map<String, WeakReference<View>> map, Bundle bundle, View view2) {
        ...
        } else if (ExifInterface.GPS_MEASUREMENT_2D.equals(this.zzbjb.zzkb())) {
    ...
    public final void zzf(Map<String, WeakReference<View>> map) {
        ...
        if (ExifInterface.GPS_MEASUREMENT_2D.equals(this.zzbjb.zzkb())) {
