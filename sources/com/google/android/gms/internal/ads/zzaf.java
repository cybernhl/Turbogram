...
public class zzaf {
    ...
    static class zza {
        ...
        protected final void finalize() throws Throwable {
            if (!this.zzbm) {
                ...
                zzaf.m586e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
        ...
        public final synchronized void zzc(String str) {
            ...
            if (j > 0) {
                ...
                zzaf.m585d("(%-4d ms) %s", Long.valueOf(j), str);
                j = j2;
                for (zzag zzag : this.zzbl) {
                    zzaf.m585d("(+%-4d) [%2d] %s", Long.valueOf(zzag.time - j), Long.valueOf(zzag.zzbn), zzag.name);
                    j = zzag.time;
                }
            }
        }
    ...
    /* renamed from: d */
    public static void m585d(String str, Object... objArr) {
        Log.d(TAG, zza(str, objArr));
    }

    /* renamed from: e */
    public static void m586e(String str, Object... objArr) {
        Log.e(TAG, zza(str, objArr));
    }

    /* renamed from: v */
    public static void m587v(String str, Object... objArr) {
        if (DEBUG) {
