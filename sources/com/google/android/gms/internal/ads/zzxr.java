    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                ...
                zzjn = (zzjn) zzel.zza(parcel, zzjn.CREATOR);
                zzjj = (zzjj) zzel.zza(parcel, zzjj.CREATOR);
                ...
                if (readStrongBinder == null) {
                    ...
                    zzxt2 = queryLocalInterface instanceof zzxt ? (zzxt) queryLocalInterface : new zzxv(readStrongBinder);
                }
                zza(asInterface, zzjn, zzjj, readString, zzxt2);
            ...
            case 3:
                ...
                zza(asInterface2, zzjj3, readString2, zzxt);
                parcel2.writeNoException();
                break;
            case 4:
                showInterstitial();
            ...
            case 6:
                ...
                zza(asInterface, zzjn, zzjj, readString, readString3, zzxt);
                parcel2.writeNoException();
                break;
            case 7:
                asInterface = Stub.asInterface(parcel.readStrongBinder());
                zzjj2 = (zzjj) zzel.zza(parcel, zzjj.CREATOR);
                readString2 = parcel.readString();
                readString = parcel.readString();
                readStrongBinder = parcel.readStrongBinder();
                if (readStrongBinder == null) {
                ...
                zza(asInterface, zzjj2, readString2, readString, zzxt2);
                parcel2.writeNoException();
                break;
            case 8:
                pause();
            ...
            case 14:
                ...
                zza(asInterface, zzjj2, readString2, readString, zzxt2, (zzpl) zzel.zza(parcel, zzpl.CREATOR), parcel.createStringArrayList());
                parcel2.writeNoException();
                break;
            case 15:
