        ...
        if (fArr[0] != 0.0f || fArr[1] != 0.0f || fArr[2] != 0.0f) {
            ...
            switch (this.zzcyp.getRotation()) {
                case 1:
                    ...
                    break;
                case 2:
                    SensorManager.remapCoordinateSystem(this.zzcyq, 129, TsExtractor.TS_STREAM_TYPE_HDMV_DTS, this.zzcyr);
                    break;
                case 3:
    ...
    final void start() {
        if (this.zzcyt == null) {
            ...
            if (defaultSensor == null) {
                zzane.m588e("No Sensor of TYPE_ROTATION_VECTOR");
                return;
            }
            ...
            if (!this.zzcyn.registerListener(this, defaultSensor, 0, this.zzcyt)) {
                zzane.m588e("SensorManager.registerListener failed.");
                stop();
            }
        }
    }
