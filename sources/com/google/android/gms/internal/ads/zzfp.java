    ...
    private final void zzm(int i) {
        if (this.zzagi.size() != 0 && this.zzagf != null) {
            ...
            if (z3 || this.zzafd || i != 1) {
                zzfs zzfs = new zzfs(zzbv.zzer().elapsedRealtime(), this.zzaev.isScreenOn(), view != null ? zzbv.zzem().isAttachedToWindow(view) : false, view != null ? view.getWindowVisibility() : 8, zza(this.zzafh), zza(rect), zza(rect2), z, zza(rect3), z2, zza(rect4), this.zzagj.density, z3);
                Iterator it = this.zzagi.iterator();
                while (it.hasNext()) {
                    ((zzft) it.next()).zza(zzfs);
                }
                this.zzafd = z3;
            }
        }
