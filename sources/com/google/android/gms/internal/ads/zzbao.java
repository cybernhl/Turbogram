...
class zzbao extends zzban {
    ...
    final void zza(zzbag zzbag) throws IOException {
    ...
    final boolean zza(zzbah zzbah, int i, int i2) {
        if (i2 > zzbah.size()) {
            throw new IllegalArgumentException("Length too large: " + i2 + size());
        } else if (i2 > zzbah.size()) {
            throw new IllegalArgumentException("Ran off end of other: 0, " + i2 + ", " + zzbah.size());
