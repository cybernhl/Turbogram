...
public final class zzxg {
    ...
    public static void zza(Context context, String str, zzajh zzajh, String str2, boolean z, List<String> list) {
        if (list != null && !list.isEmpty()) {
            String str3 = z ? "1" : "0";
            for (String zza : list) {
                String zza2 = zza(zza(zza(zza(zza(zza(zza(zza2, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzajh.zzcod.zzbst), "@gw_sdkver@", str), "@gw_sessid@", zzkb.zzih()), "@gw_seqnum@", zzajh.zzccy), "@gw_adnetstatus@", zzajh.zzcoe);
                if (zzajh.zzbtw != null) {
    ...
    public static void zza(Context context, String str, List<String> list, String str2, @Nullable zzaig zzaig) {
        if (list != null && !list.isEmpty()) {
