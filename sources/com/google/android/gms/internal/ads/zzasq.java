    ...
    protected final synchronized void onMeasure(int i, int i2) {
        if (isDestroyed()) {
            ...
            if (aspectRatio == 0.0f) {
                ...
                int i4 = (int) (((float) r4) * aspectRatio);
                r1 = (int) (((float) r5) / aspectRatio);
                if (r4 == 0 && r1 != 0) {
                    i3 = (int) (aspectRatio * ((float) r1));
                    r0 = r1;
                    r4 = r1;
                } else if (r5 != 0 || i4 == 0) {
                    r0 = r1;
            ...
            if (((Boolean) zzkb.zzik().zzd(zznk.zzbfe)).booleanValue()) {
                obj = (((float) this.zzddh.widthPixels) / this.zzdeu > ((float) i5) / this.zzdeu || ((float) this.zzddh.heightPixels) / this.zzdeu > ((float) r4) / this.zzdeu) ? null : 1;
                if (obj2 == null) {
                    obj = obj2;
                }
            } else {
            ...
            if (obj != null) {
                zzane.zzdk("Not enough space to show ad. Needs " + ((int) (((float) this.zzddh.widthPixels) / this.zzdeu)) + "x" + ((int) (((float) this.zzddh.heightPixels) / this.zzdeu)) + " dp, but only has " + ((int) (((float) size) / this.zzdeu)) + "x" + ((int) (((float) r5) / this.zzdeu)) + " dp.");
                if (getVisibility() != 8) {
                    setVisibility(4);
                }
                setMeasuredDimension(0, 0);
