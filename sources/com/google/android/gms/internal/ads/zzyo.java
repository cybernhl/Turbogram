...
public final class zzyo implements NativeMediationAdRequest {
    ...
    public zzyo(@Nullable Date date, int i, @Nullable Set<String> set, @Nullable Location location, boolean z, int i2, zzpl zzpl, List<String> list, boolean z2) {
        this.zzhl = date;
        this.zzaqn = i;
        this.zzhn = set;
        this.zzhp = location;
    ...
    public final boolean isAppInstallAdRequested() {
        return this.zzyc != null && (this.zzyc.contains(ExifInterface.GPS_MEASUREMENT_2D) || this.zzyc.contains("6"));
    }
    ...
    public final boolean zzna() {
        return this.zzyc != null && this.zzyc.contains(ExifInterface.GPS_MEASUREMENT_3D);
    }
