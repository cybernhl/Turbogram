...
public final class zzoo extends zzql implements zzpc {
    ...
    public final void performClick(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m588e("#001 Attempt to perform click before app native ad initialized.");
                return;
            }
    ...
    public final boolean recordImpression(Bundle bundle) {
        ...
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m588e("#002 Attempt to record impression before native ad initialized.");
                z = false;
            } else {
    ...
    public final void reportTouchEvent(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m588e("#003 Attempt to report touch event before native ad initialized.");
                return;
            }
