...
public final class zzapv {
    ...
    private static boolean zza(JSONObject jSONObject, String str, zzna<Boolean> zzna) {
        if (jSONObject != null) {
            try {
    ...
    private static int zzb(JSONObject jSONObject, String str, zzna<Integer> zzna) {
        if (jSONObject != null) {
            try {
    ...
    private static String zzc(JSONObject jSONObject, String str, zzna<String> zzna) {
        if (jSONObject != null) {
            try {
