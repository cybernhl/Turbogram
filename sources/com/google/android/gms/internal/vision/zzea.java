...
final class zzea {
    static String zza(zzdx zzdx, String str) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("# ").append(str);
        zza(zzdx, stringBuilder, 0);
        return stringBuilder.toString();
    }

    private static void zza(zzdx zzdx, StringBuilder stringBuilder, int i) {
        Map hashMap = new HashMap();
        Map hashMap2 = new HashMap();
        Set<String> treeSet = new TreeSet();
        for (Method method : zzdx.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (!(!replaceFirst.endsWith("List") || replaceFirst.endsWith("OrBuilderList") || replaceFirst.equals("List"))) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(stringBuilder, i, zzj(valueOf), zzcr.zza(method2, (Object) zzdx, new Object[0]));
                }
            }
        ...
        if (zzdx instanceof zzc) {
            Iterator it = ((zzc) zzdx).zzkx.iterator();
            if (it.hasNext()) {
                ((Entry) it.next()).getKey();
                throw new NoSuchMethodError();
            }
        }
        if (((zzcr) zzdx).zzkr != null) {
            ((zzcr) zzdx).zzkr.zza(stringBuilder, i);
        }
    }
    ...
    static final void zza(StringBuilder stringBuilder, int i, String str, Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                stringBuilder.append(": \"").append(zzfb.zzd(zzbo.zzg((String) obj))).append('\"');
            } else if (obj instanceof zzbo) {
                stringBuilder.append(": \"").append(zzfb.zzd((zzbo) obj)).append('\"');
            } else if (obj instanceof zzcr) {
                stringBuilder.append(" {");
                zza((zzcr) obj, stringBuilder, i + 2);
                stringBuilder.append("\n");
                while (i2 < i) {
                    stringBuilder.append(' ');
                    i2++;
