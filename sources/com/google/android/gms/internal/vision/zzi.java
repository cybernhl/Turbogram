...
public final class zzi extends zza implements zzh {
    ...
    public final Barcode[] zza(IObjectWrapper iObjectWrapper, zzm zzm) throws RemoteException {
    ...
    public final Barcode[] zzb(IObjectWrapper iObjectWrapper, zzm zzm) throws RemoteException {
        Parcel obtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
        zzc.zza(obtainAndWriteInterfaceToken, (IInterface) iObjectWrapper);
        zzc.zza(obtainAndWriteInterfaceToken, (Parcelable) zzm);
