...
interface zzfz {
    ...
    void zza(int i, zzbo zzbo) throws IOException;

    <K, V> void zza(int i, zzdq<K, V> zzdq, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzen zzen) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzen zzen) throws IOException;

    void zza(int i, List<Integer> list, boolean z) throws IOException;

    @Deprecated
    void zzac(int i) throws IOException;

    @Deprecated
    void zzad(int i) throws IOException;

    void zzb(int i, long j) throws IOException;

    @Deprecated
    void zzb(int i, Object obj, zzen zzen) throws IOException;

    void zzb(int i, List<zzbo> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzen zzen) throws IOException;
