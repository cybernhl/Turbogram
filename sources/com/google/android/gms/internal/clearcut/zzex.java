...
abstract class zzex<T, B> {
    ...
    abstract void zza(B b, int i, zzbb zzbb);

    abstract void zza(T t, zzfr zzfr) throws IOException;

    abstract void zzc(Object obj);

    abstract void zzc(T t, zzfr zzfr) throws IOException;
