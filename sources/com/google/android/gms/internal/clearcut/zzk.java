    ...
    public static long zza(byte[] bArr) {
        ...
        if (length < 0 || length > bArr.length) {
            ...
            if (length > 16) {
                ...
                r10 = zzb(bArr, 8);
                r12 = zzb(bArr, (length + 0) - 8) * r6;
                return zza((zzb(bArr, (length + 0) - 16) * -7286425919675154353L) + (Long.rotateRight(r4 + r10, 43) + Long.rotateRight(r12, 30)), (r4 + Long.rotateRight(-7286425919675154353L + r10, 18)) + r12, r6);
            } else if (length >= 8) {
                r6 = -7286425919675154353L + ((long) (length << 1));
                r4 = -7286425919675154353L + zzb(bArr, 0);
                long zzb = zzb(bArr, (length + 0) - 8);
                return zza((Long.rotateRight(zzb, 37) * r6) + r4, (Long.rotateRight(r4, 25) + zzb) * r6, r6);
            } else if (length >= 4) {
            ...
            r6 = -7286425919675154353L + ((long) (length << 1));
            r10 = zzb(bArr, 0) * -7286425919675154353L;
            r4 = zzb(bArr, 8);
            r12 = zzb(bArr, (length + 0) - 8) * r6;
            r2 = (zzb(bArr, (length + 0) - 16) * -7286425919675154353L) + (Long.rotateRight(r10 + r4, 43) + Long.rotateRight(r12, 30));
            r4 = zza(r2, (Long.rotateRight(r4 - 7286425919675154353L, 18) + r10) + r12, r6);
            r12 = zzb(bArr, 16) * r6;
            long zzb2 = zzb(bArr, 24);
            long zzb3 = (r2 + zzb(bArr, (length + 0) - 32)) * r6;
            return zza(((zzb(bArr, (length + 0) - 24) + r4) * r6) + (Long.rotateRight(r12 + zzb2, 43) + Long.rotateRight(zzb3, 30)), (Long.rotateRight(zzb2 + r10, 18) + r12) + zzb3, r6);
        } else {
            int i2 = 0;
            ...
            int i3 = (((length - 1) / 64) << 6) + 0;
            int i4 = (((length - 1) & 63) + i3) - 63;
            while (true) {
                r10 = Long.rotateRight(((r10 + r6) + jArr[0]) + zzb(bArr, i2 + 8), 37) * -5435081209227447693L;
                long j = r10 ^ jArr2[1];
                long rotateRight = (Long.rotateRight((r6 + jArr[1]) + zzb(bArr, i2 + 48), 42) * -5435081209227447693L) + (jArr[0] + zzb(bArr, i2 + 40));
                long rotateRight2 = Long.rotateRight(r4 + jArr2[0], 33) * -5435081209227447693L;
                zza(bArr, i2, jArr[1] * -5435081209227447693L, jArr2[0] + j, jArr);
                byte[] bArr2 = bArr;
                zza(bArr2, i2 + 32, rotateRight2 + jArr2[1], rotateRight + zzb(bArr, i2 + 16), jArr2);
                i2 += 64;
                if (i2 == i3) {
                    ...
                    r2 = Long.rotateRight(((rotateRight2 + rotateRight) + jArr[0]) + zzb(bArr, i4 + 8), 37) * j2;
                    r4 = Long.rotateRight((jArr[1] + rotateRight) + zzb(bArr, i4 + 48), 42) * j2;
                    rotateRight = r2 ^ (jArr2[1] * 9);
                    rotateRight2 = r4 + ((jArr[0] * 9) + zzb(bArr, i4 + 40));
                    j = Long.rotateRight(jArr2[0] + j, 33) * j2;
                    zza(bArr, i4, jArr[1] * j2, rotateRight + jArr2[0], jArr);
                    bArr2 = bArr;
                    zza(bArr2, i4 + 32, j + jArr2[1], rotateRight2 + zzb(bArr, i4 + 16), jArr2);
