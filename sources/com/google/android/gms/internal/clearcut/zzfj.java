...
final class zzfj extends zzfg {
    ...
    L_0x003e:
        r2 = 1;
        r2 = r2 + r4;
        r1 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r4);
    ...
    L_0x004f:
        r6 = 1;
        r6 = r6 + r2;
        r2 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r2);
    ...
    L_0x008c:
        ...
        r2 = 1;
        r6 = r4 + r2;
        r2 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r4);
        r3 = -65;
    ...
    L_0x00aa:
        r2 = 1;
        r2 = r2 + r6;
        r1 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r6);
        r4 = -65;
        if (r1 <= r4) goto L_0x003a;
    L_0x00b5:
        r0 = -1;
    ...
    L_0x00bf:
        ...
        r2 = 1;
        r2 = r2 + r4;
        r4 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r4);
        r5 = -65;
    ...
    L_0x00d5:
        r4 = 1;
        r4 = r4 + r2;
        r1 = com.google.android.gms.internal.clearcut.zzfd.zza(r10, r2);
        r2 = -65;
    ...
    final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt < '' && j3 < j2) {
                ...
                r12 = j3 + 1;
                zzfd.zza(bArr, j3, (byte) ((charAt >>> 6) | 960));
                j = 1 + r12;
                zzfd.zza(bArr, r12, (byte) ((charAt & 63) | 128));
            } else if ((charAt < '?' || '?' < charAt) && j3 <= j2 - 3) {
                j = 1 + j3;
                zzfd.zza(bArr, j3, (byte) ((charAt >>> 12) | 480));
                j3 = 1 + j;
                zzfd.zza(bArr, j, (byte) (((charAt >>> 6) & 63) | 128));
                j = 1 + j3;
                zzfd.zza(bArr, j3, (byte) ((charAt & 63) | 128));
            } else if (j3 <= j2 - 4) {
                if (i3 + 1 != length) {
                    i3++;
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        j = 1 + j3;
                        zzfd.zza(bArr, j3, (byte) ((toCodePoint >>> 18) | PsExtractor.VIDEO_STREAM_MASK));
                        j3 = 1 + j;
                        zzfd.zza(bArr, j, (byte) (((toCodePoint >>> 12) & 63) | 128));
                        r12 = j3 + 1;
                        zzfd.zza(bArr, j3, (byte) (((toCodePoint >>> 6) & 63) | 128));
                        j = 1 + r12;
                        zzfd.zza(bArr, r12, (byte) ((toCodePoint & 63) | 128));
                    }
                }
    ...
    final void zzb(java.lang.CharSequence r17, java.nio.ByteBuffer r18) {
        /*
        r16 = this;
        r8 = com.google.android.gms.internal.clearcut.zzfd.zzb(r18);
        r2 = r18.position();
        r2 = (long) r2;
        r4 = r8 + r2;
        r2 = r18.limit();
    ...
    L_0x005d:
        ...
        r6 = r6 + r4;
        r12 = (byte) r12;
        com.google.android.gms.internal.clearcut.zzfd.zza(r4, r12);
        r2 = r2 + 1;
        r4 = r6;
        goto L_0x0051;
    L_0x0068:
    ...
    L_0x0083:
        ...
        r4 = r4 + r6;
        r12 = (byte) r12;
        com.google.android.gms.internal.clearcut.zzfd.zza(r6, r12);
    L_0x008a:
        r2 = r2 + 1;
        r6 = r4;
        goto L_0x0073;
    ...
    L_0x009a:
        ...
        r4 = r4 | 960;
        r4 = (byte) r4;
        com.google.android.gms.internal.clearcut.zzfd.zza(r6, r4);
        r4 = 1;
        r4 = r4 + r14;
        r6 = r12 & 63;
        r6 = r6 | 128;
        r6 = (byte) r6;
        com.google.android.gms.internal.clearcut.zzfd.zza(r14, r6);
        goto L_0x008a;
    L_0x00b2:
    ...
    L_0x00c4:
        ...
        r13 = r13 | 480;
        r13 = (byte) r13;
        com.google.android.gms.internal.clearcut.zzfd.zza(r6, r13);
        r6 = 1;
        r6 = r6 + r4;
        r13 = r12 >>> 6;
        r13 = r13 & 63;
        r13 = r13 | 128;
        r13 = (byte) r13;
        com.google.android.gms.internal.clearcut.zzfd.zza(r4, r13);
        r4 = 1;
        r4 = r4 + r6;
        r12 = r12 & 63;
        r12 = r12 | 128;
    ...
    L_0x0102:
        r4 = new com.google.android.gms.internal.clearcut.zzfi;
        r2 = r2 + -1;
        r4.<init>(r2, r3);
        throw r4;
    L_0x010a:
