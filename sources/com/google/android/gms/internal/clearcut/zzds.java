...
final class zzds<T> implements zzef<T> {
    ...
    private final int zza(T t, byte[] bArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, int i8, zzay zzay) throws IOException {
        ...
        switch (i7) {
            ...
            case 59:
                ...
                } else if ((536870912 & i6) == 0 || zzff.zze(bArr, i9, i9 + zzb)) {
            ...
            if (zzai != -1) {
                ...
                if (i14 <= 17) {
                    ...
                    switch (i14) {
                        ...
                        case 8:
                            if (i9 == 2) {
                                i4 = (536870912 & i13) == 0 ? zzax.zzc(bArr, i11, zzay) : zzax.zzd(bArr, i11, zzay);
                                unsafe.putObject(t, j, zzay.zzff);
                                i7 |= i15;
                                i9 = i4;
                                continue;
                        ...
                        case 9:
                            if (i9 == 2) {
                                i9 = zza(zzad(zzai), bArr, i11, i2, zzay);
                                if ((i7 & i15) == 0) {
                                    unsafe.putObject(t, j, zzay.zzff);
                                } else {
                        ...
                        case 12:
                            if (i9 == 0) {
                                ...
                                if (zzaf != null && zzaf.zzb(i4) == null) {
                                    zzn(t).zzb(i8, Long.valueOf((long) i4));
                                    break;
                                }
                        ...
                        case 17:
                            if (i9 == 3) {
                                i9 = zza(zzad(zzai), bArr, i11, i2, (i12 << 3) | 4, zzay);
                                if ((i7 & i15) == 0) {
                                    unsafe.putObject(t, j, zzay.zzff);
                                } else {
                                    unsafe.putObject(t, j, zzci.zza(unsafe.getObject(t, j), zzay.zzff));
                    ...
                    i9 = i11;
                    if (i8 == i3 || i3 == 0) {
                        i9 = zza(i8, bArr, i9, i2, (Object) t, zzay);
                        i7 = i4;
                        i6 = i5;
                    } else {
                        if (i5 != -1) {
                    ...
                    if (i9 == 2) {
                        ...
                        i9 = zza(zzad(zzai), i8, bArr, i11, i2, zzcn, zzay);
                    }
                } else if (i14 <= 49) {
                    i9 = zza((Object) t, bArr, i11, i2, i8, i12, i9, zzai, (long) i13, i14, j, zzay);
                    if (i9 == i11) {
                        i4 = i7;
                        i5 = i6;
                        if (i8 == i3) {
                    ...
                    i9 = zza((Object) t, bArr, i11, i2, i8, i12, i9, i13, i14, j, zzai, zzay);
                    if (i9 == i11) {
                        i4 = i7;
                        i5 = i6;
                        if (i8 == i3) {
                    ...
                    i9 = zza(t, bArr, i11, i2, zzai, i12, j, zzay);
                    if (i9 == i11) {
                        i4 = i7;
                        i5 = i6;
                        if (i8 == i3) {
            ...
            if (zzco.next()) {
                ...
                while (true) {
                    ...
                    if (zzcx >= zzec.zzcv() || i3 >= ((zzcx - i) << 2)) {
                        ...
                        iArr[i3] = zzco.zzcx();
                        iArr[i3 + 1] = zza | (((zzco.zzdi() ? 536870912 : 0) | (zzco.zzdh() ? 268435456 : 0)) | (zzco.zzcy() << 20));
    ...
    private final void zzb(T t, zzfr zzfr) throws IOException {
        ...
        while (i3 < length) {
            ...
            while (entry2 != null && this.zzmy.zza(entry2) <= i6) {
            ...
            switch (i7) {
                ...
                case 9:
                    ...
                    zzfr.zza(i6, unsafe.getObject(t, j), zzad(i3));
                    break;
                case 10:
                    if ((i5 & i4) == 0) {
                        break;
                ...
                case 17:
                    ...
                    zzfr.zzb(i6, unsafe.getObject(t, j), zzad(i3));
                    break;
                case 18:
                    zzeh.zza(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 19:
                    zzeh.zzb(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 20:
                    zzeh.zzc(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 21:
                    zzeh.zzd(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 22:
                    zzeh.zzh(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 23:
                    zzeh.zzf(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 24:
                    zzeh.zzk(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 25:
                    zzeh.zzn(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 26:
                    zzeh.zza(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr);
                    break;
                case 27:
                    zzeh.zza(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, zzad(i3));
                    break;
                case 28:
                    zzeh.zzb(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr);
                    break;
                case NalUnitTypes.NAL_TYPE_RSV_VCL29 /*29*/:
                    zzeh.zzi(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case NalUnitTypes.NAL_TYPE_RSV_VCL30 /*30*/:
                    zzeh.zzm(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case NalUnitTypes.NAL_TYPE_RSV_VCL31 /*31*/:
                    zzeh.zzl(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 32:
                    zzeh.zzg(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 33:
                    zzeh.zzj(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 34:
                    zzeh.zze(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, false);
                    break;
                case 35:
                    zzeh.zza(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 36:
                    zzeh.zzb(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 37:
                    zzeh.zzc(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 38:
                    zzeh.zzd(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 39:
                    zzeh.zzh(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case MotionEventCompat.AXIS_GENERIC_9 /*40*/:
                    zzeh.zzf(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 41:
                    zzeh.zzk(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 42:
                    zzeh.zzn(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 43:
                    zzeh.zzi(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 44:
                    zzeh.zzm(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case MotionEventCompat.AXIS_GENERIC_14 /*45*/:
                    zzeh.zzl(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case MotionEventCompat.AXIS_GENERIC_15 /*46*/:
                    zzeh.zzg(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case MotionEventCompat.AXIS_GENERIC_16 /*47*/:
                    zzeh.zzj(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 48:
                    zzeh.zze(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, true);
                    break;
                case 49:
                    zzeh.zzb(this.zzmi[i3], (List) unsafe.getObject(t, j), zzfr, zzad(i3));
                    break;
                case 50:
                    zza(zzfr, i6, unsafe.getObject(t, j), i3);
                    break;
                case 51:
                ...
                if (zzai >= 0) {
                    ...
                    if (i8 <= 17) {
                        switch (i8) {
                            ...
                            case 8:
                                if (i3 == 2) {
                                    int zzc = (536870912 & i7) == 0 ? zzax.zzc(bArr, i4, zzay) : zzax.zzd(bArr, i4, zzay);
                                    unsafe.putObject(t, j, zzay.zzff);
                                    i3 = zzc;
                                    continue;
                                }
    ...
    public final int zzm(T t) {
        ...
        if (this.zzmq) {
            ...
            for (i2 = 0; i2 < this.zzmi.length; i2 += 4) {
                int i5;
                zzag = zzag(i2);
                i5 = (267386880 & zzag) >>> 20;
                i3 = this.zzmi[i2];
                long j = (long) (zzag & 1048575);
                i4 = (i5 < zzcb.DOUBLE_LIST_PACKED.id() || i5 > zzcb.SINT64_LIST_PACKED.id()) ? 0 : this.zzmi[i2 + 2] & 1048575;
                switch (i5) {
                    case 0:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzb(i3, (double) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                        break;
                    case 1:
                        if (!zza((Object) t, i2)) {
                            break;
                    ...
                    case 2:
                        ...
                        i += zzbn.zzd(i3, zzfd.zzk(t, j));
                        break;
                    case 3:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zze(i3, zzfd.zzk(t, j));
                        break;
                    case 4:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzg(i3, zzfd.zzj(t, j));
                        break;
                    case 5:
                        if (!zza((Object) t, i2)) {
                            break;
                    ...
                    case 8:
                        ...
                        zzo = zzfd.zzo(t, j);
                        if (!(zzo instanceof zzbb)) {
                            i += zzbn.zzb(i3, (String) zzo);
                            break;
                        }
                        i += zzbn.zzc(i3, (zzbb) zzo);
                        break;
                    case 9:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzeh.zzc(i3, zzfd.zzo(t, j), zzad(i2));
                        break;
                    case 10:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzc(i3, (zzbb) zzfd.zzo(t, j));
                        break;
                    case 11:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzh(i3, zzfd.zzj(t, j));
                        break;
                    case 12:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzl(i3, zzfd.zzj(t, j));
                        break;
                    case 13:
                        if (!zza((Object) t, i2)) {
                            break;
                    ...
                    case 15:
                        ...
                        i += zzbn.zzi(i3, zzfd.zzj(t, j));
                        break;
                    case 16:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzf(i3, zzfd.zzk(t, j));
                        break;
                    case 17:
                        if (!zza((Object) t, i2)) {
                            break;
                        }
                        i += zzbn.zzc(i3, (zzdo) zzfd.zzo(t, j), zzad(i2));
                        break;
                    case 18:
                        i += zzeh.zzw(i3, zzd(t, j), false);
                        break;
                    case 19:
                        i += zzeh.zzv(i3, zzd(t, j), false);
                        break;
                    case 20:
                        i += zzeh.zzo(i3, zzd(t, j), false);
                        break;
                    case 21:
                        i += zzeh.zzp(i3, zzd(t, j), false);
                        break;
                    case 22:
                        i += zzeh.zzs(i3, zzd(t, j), false);
                        break;
                    case 23:
                        i += zzeh.zzw(i3, zzd(t, j), false);
                        break;
                    case 24:
                        ...
                        break;
                    case 25:
                        i += zzeh.zzx(i3, zzd(t, j), false);
                        break;
                    case 26:
                        i += zzeh.zzc(i3, zzd(t, j));
                        break;
                    case 27:
                        i += zzeh.zzc(i3, zzd(t, j), zzad(i2));
                        break;
                    case 28:
                        i += zzeh.zzd(i3, zzd(t, j));
                        break;
                    case NalUnitTypes.NAL_TYPE_RSV_VCL29 /*29*/:
                        i += zzeh.zzt(i3, zzd(t, j), false);
                        break;
                    case NalUnitTypes.NAL_TYPE_RSV_VCL30 /*30*/:
                        i += zzeh.zzr(i3, zzd(t, j), false);
                        break;
                    case NalUnitTypes.NAL_TYPE_RSV_VCL31 /*31*/:
                        i += zzeh.zzv(i3, zzd(t, j), false);
                        break;
                    case 32:
                        ...
                        break;
                    case 33:
                        i += zzeh.zzu(i3, zzd(t, j), false);
                        break;
                    case 34:
                        i += zzeh.zzq(i3, zzd(t, j), false);
                        break;
                    case 35:
                        zzag = zzeh.zzi((List) unsafe.getObject(t, j));
                        if (zzag > 0) {
                            if (this.zzmr) {
                                unsafe.putInt(t, (long) i4, zzag);
                            }
                            i += zzag + (zzbn.zzr(i3) + zzbn.zzt(zzag));
                            break;
                        }
                        break;
                    case 36:
                    ...
                    case 48:
                        ...
                        break;
                    case 49:
                        i += zzeh.zzd(i3, zzd(t, j), zzad(i2));
                        break;
                    case 50:
                        i += this.zzmz.zzb(i3, zzfd.zzo(t, j), zzae(i2));
                        break;
                    case 51:
                    ...
                    case 53:
                        ...
                        i += zzbn.zzd(i3, zzh(t, j));
                        break;
                    case 54:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                        }
                        i += zzbn.zze(i3, zzh(t, j));
                        break;
                    case 55:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                        }
                        i += zzbn.zzg(i3, zzg(t, j));
                        break;
                    case 56:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                    ...
                    case 62:
                        ...
                        i += zzbn.zzh(i3, zzg(t, j));
                        break;
                    case HtmlCompat.FROM_HTML_MODE_COMPACT /*63*/:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                        }
                        i += zzbn.zzl(i3, zzg(t, j));
                        break;
                    case 64:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                    ...
                    case 66:
                        ...
                        i += zzbn.zzi(i3, zzg(t, j));
                        break;
                    case 67:
                        if (!zza((Object) t, i3, i2)) {
                            break;
                        }
                        i += zzbn.zzf(i3, zzh(t, j));
                        break;
                    case 68:
                        if (!zza((Object) t, i3, i2)) {
                            break;
        ...
        for (i2 = 0; i2 < this.zzmi.length; i2 += 4) {
            ...
            if (i8 <= 17) {
                ...
                i5 = 1 << (i3 >>> 20);
                if (zzag != i4) {
                    i = unsafe2.getInt(t, (long) zzag);
                    i4 = zzag;
                }
                zzag = i5;
            } else {
                i3 = (!this.zzmr || i8 < zzcb.DOUBLE_LIST_PACKED.id() || i8 > zzcb.SINT64_LIST_PACKED.id()) ? 0 : this.zzmi[i2 + 2] & 1048575;
            }
            ...
            switch (i8) {
                case 0:
                    ...
                    i6 += zzbn.zzb(i7, (double) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                    break;
                case 1:
                    if ((zzag & i) == 0) {
                        break;
    ...
    public final boolean zzo(T t) {
        ...
        while (i3 < length) {
            ...
            if (!this.zzmq) {
                ...
                i7 = 1 << (i7 >>> 20);
                if (i4 != i) {
                    i2 = zzmh.getInt(t, (long) i4);
                    i5 = i7;
                    if (((268435456 & zzag) == 0 ? 1 : null) == null && !zza((Object) t, zzai, i2, i5)) {
                        return false;
                    }
                    switch ((267386880 & zzag) >>> 20) {
                        case 9:
                        case 17:
                            if (zza((Object) t, zzai, i2, i5) && !zza((Object) t, zzag, zzad(zzai))) {
                                return false;
                            }
                        case 27:
                        case 49:
                        ...
                        case 60:
                        case 68:
                            if (zza((Object) t, i6, zzai) && !zza((Object) t, zzag, zzad(zzai))) {
                                return false;
                            }
                        default:
                            break;
            ...
            if (((268435456 & zzag) == 0 ? 1 : null) == null) {
            }
            switch ((267386880 & zzag) >>> 20) {
                case 9:
                case 17:
