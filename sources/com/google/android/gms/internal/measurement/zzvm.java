...
public abstract class zzvm<MessageType extends zzvm<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zztw<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzvm<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zztx<MessageType, BuilderType> {
        ...
        public MessageType zzwg() {
            ...
            zzvm zzvm = this.zzbyq;
            zzxf.zzxn().zzag(zzvm).zzu(zzvm);
            this.zzbyr = true;
            return this.zzbyq;
        }
        ...
        public final MessageType zzwh() {
            ...
            byte byteValue = ((Byte) zzvm.zza(zze.zzbyt, null, null)).byteValue();
            if (byteValue == (byte) 1) {
                z = true;
            } else if (byteValue == (byte) 0) {
                z = false;
            } else {
                boolean zzaf = zzxf.zzxn().zzag(zzvm).zzaf(zzvm);
                if (booleanValue) {
                    Object obj;
                    int i = zze.zzbyu;
                    if (zzaf) {
        ...
        public final BuilderType zza(MessageType messageType) {
            if (this.zzbyr) {
                zzvm zzvm = (zzvm) this.zzbyq.zza(zze.zzbyw, null, null);
                zza(zzvm, this.zzbyq);
                this.zzbyq = zzvm;
                this.zzbyr = false;
            }
        ...
        protected final /* synthetic */ zztx zza(zztw zztw) {
            return zza((zzvm) zztw);
        }
        ...
        public /* synthetic */ Object clone() throws CloneNotSupportedException {
            zza zza = (zza) this.zzbyp.zza(zze.zzbyx, null, null);
            zza.zza((zzvm) zzwi());
            return zza;
        }
    }
    ...
    public enum zze {
        ...
        public static int[] m592x126d66cb() {
    ...
    static <T extends zzvm<T, ?>> T zza(T t, zzuo zzuo, zzuz zzuz) throws zzvt {
        zzvm zzvm = (zzvm) t.zza(zze.zzbyw, null, null);
        try {
            zzxf.zzxn().zzag(zzvm).zza(zzvm, zzur.zza(zzuo), zzuz);
            zzxf.zzxn().zzag(zzvm).zzu(zzvm);
            return zzvm;
        } catch (IOException e) {
            ...
            throw new zzvt(e.getMessage()).zzg(zzvm);
    ...
    public final /* synthetic */ zzwu zzwd() {
        zza zza = (zza) zza(zze.zzbyx, null, null);
        zza.zza(this);
        return zza;
    }
