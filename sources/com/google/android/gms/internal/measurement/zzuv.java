...
final class zzuv implements zzyw {
    ...
    public static zzuv zza(zzut zzut) {
        if (zzut.zzbuw != null) {
            return zzut.zzbuw;
        }
    ...
    private zzuv(zzut zzut) {
        this.zzbuf = (zzut) zzvo.zza(zzut, "output");
    }
    ...
    public final void zza(int i, Object obj, zzxj zzxj) throws IOException {
        this.zzbuf.zza(i, (zzwt) obj, zzxj);
    }

    public final void zzb(int i, Object obj, zzxj zzxj) throws IOException {
        zzut zzut = this.zzbuf;
        zzwt zzwt = (zzwt) obj;
        zzut.zzc(i, 3);
        zzxj.zza(zzwt, zzut.zzbuw);
        zzut.zzc(i, 4);
    }
    ...
    public final void zza(int i, List<?> list, zzxj zzxj) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zza(i, list.get(i2), zzxj);
        }
    }

    public final void zzb(int i, List<?> list, zzxj zzxj) throws IOException {
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzb(i, list.get(i2), zzxj);
        }
    }

    public final <K, V> void zza(int i, zzwm<K, V> zzwm, Map<K, V> map) throws IOException {
        for (Entry entry : map.entrySet()) {
            this.zzbuf.zzc(i, 2);
            this.zzbuf.zzay(zzwl.zza(zzwm, entry.getKey(), entry.getValue()));
            zzwl.zza(this.zzbuf, zzwm, entry.getKey(), entry.getValue());
        }
    }
}
