...
public final class zzzh {
    ...
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        if (obj instanceof zzzg) {
            ...
            if (str != null) {
                stringBuffer2.append(stringBuffer).append(zzgc(str)).append(" <\n");
                stringBuffer.append("  ");
            }
        ...
        if (obj instanceof String) {
            obj = (String) obj;
            if (!obj.startsWith("http") && obj.length() > Callback.DEFAULT_DRAG_ANIMATION_DURATION) {
                obj = String.valueOf(obj.substring(0, Callback.DEFAULT_DRAG_ANIMATION_DURATION)).concat("[...]");
            }
