...
public final class DownloadManager {
    ...
    /* renamed from: com.google.android.exoplayer2.offline.DownloadManager$2 */
    ...
    private static final class Task implements Runnable {
        ...
        private void cancel() {
            if (changeStateAndNotify(0, 5)) {
                this.downloadManager.handler.post(new C03111());
    ...
    public DownloadManager(DownloaderConstructorHelper constructorHelper, int maxSimultaneousDownloads, int minRetryCount, File actionFile, Deserializer... deserializers) {
        ...
        if (deserializers.length <= 0) {
            deserializers = DownloadAction.getDefaultDeserializers();
        }
    ...
    private void loadActions() {
        this.fileIOHandler.post(new C03092());
    }
