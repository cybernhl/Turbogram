...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(text), C0246C.TIME_UNSET, C0246C.TIME_UNSET, null, null, "");
    }
    ...
    public boolean isActive(long timeUs) {
        return (this.startTimeUs == C0246C.TIME_UNSET && this.endTimeUs == C0246C.TIME_UNSET) || ((this.startTimeUs <= timeUs && this.endTimeUs == C0246C.TIME_UNSET) || ((this.startTimeUs == C0246C.TIME_UNSET && timeUs < this.endTimeUs) || (this.startTimeUs <= timeUs && timeUs < this.endTimeUs)));
    }
    ...
    private void getEventTimes(TreeSet<Long> out, boolean descendsPNode) {
        ...
        if (descendsPNode || isPNode) {
            if (this.startTimeUs != C0246C.TIME_UNSET) {
                out.add(Long.valueOf(this.startTimeUs));
            }
            if (this.endTimeUs != C0246C.TIME_UNSET) {
    ...
    public List<Cue> getCues(long timeUs, Map<String, TtmlStyle> globalStyles, Map<String, TtmlRegion> regionMap) {
        ...
        for (Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            ...
            cues.add(new Cue(cleanUpText((SpannableStringBuilder) entry.getValue()), null, region.line, region.lineType, region.lineAnchor, region.position, Integer.MIN_VALUE, region.width, region.textSizeType, region.textSize));
        }
        return cues;
    }
