...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    private long initialStartTimeUs = C0246C.TIME_UNSET;
    ...
    private final class MediaPlaylistBundle implements Callback<ParsingLoadable<HlsPlaylist>>, Runnable {
        ...
        public boolean isSnapshotValid() {
            ...
            long snapshotValidityDurationMs = Math.max(30000, C0246C.usToMs(this.playlistSnapshot.durationUs));
        ...
        public LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> loadable, long elapsedRealtimeMs, long loadDurationMs, IOException error, int errorCount) {
            ...
            boolean z;
            boolean shouldBlacklist = DefaultHlsPlaylistTracker.this.playlistLoadErrorHandlingPolicy.getBlacklistDurationMsFor(loadable, loadDurationMs, error, errorCount) != C0246C.TIME_UNSET;
            ...
            if (blacklistingFailed) {
                ...
                loadErrorAction = retryDelay != C0246C.TIME_UNSET ? Loader.createRetryAction(false, retryDelay) : Loader.DONT_RETRY_FATAL;
            } else {
        ...
        private void processLoadedPlaylist(HlsMediaPlaylist loadedPlaylist) {
            ...
            if (this.playlistSnapshot != oldPlaylist) {
                ...
                } else if (((double) (currentTimeMs - this.lastSnapshotChangeMs)) > ((double) C0246C.usToMs(this.playlistSnapshot.targetDurationUs)) * DefaultHlsPlaylistTracker.PLAYLIST_STUCK_TARGET_DURATION_COEFFICIENT) {
            ...
            this.earliestNextLoadTimeMs = C0246C.usToMs(this.playlistSnapshot != oldPlaylist ? this.playlistSnapshot.targetDurationUs : this.playlistSnapshot.targetDurationUs / 2) + currentTimeMs;
    ...
    public void stop() {
        ...
        this.initialStartTimeUs = C0246C.TIME_UNSET;
    ...
    public LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> loadable, long elapsedRealtimeMs, long loadDurationMs, IOException error, int errorCount) {
        ...
        boolean isFatal = retryDelayMs == C0246C.TIME_UNSET;
