...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public static final class Segment implements Comparable<Long> {
        ...
        public Segment(String uri, long byterangeOffset, long byterangeLength) {
            this(uri, null, "", 0, -1, C0246C.TIME_UNSET, null, null, byterangeOffset, byterangeLength, false);
        }

        public Segment(String url, @Nullable Segment initializationSegment, String title, long durationUs, int relativeDiscontinuitySequence, long relativeStartTimeUs, @Nullable String fullSegmentEncryptionKeyUri, @Nullable String encryptionIV, long byterangeOffset, long byterangeLength, boolean hasGapTag) {
            this.url = url;
    ...
    public HlsMediaPlaylist(int playlistType, String baseUri, List<String> tags, long startOffsetUs, long startTimeUs, boolean hasDiscontinuitySequence, int discontinuitySequence, long mediaSequence, int version, long targetDurationUs, boolean hasIndependentSegments, boolean hasEndTag, boolean hasProgramDateTime, DrmInitData drmInitData, List<Segment> segments) {
        ...
        if (startOffsetUs == C0246C.TIME_UNSET) {
            startOffsetUs = C0246C.TIME_UNSET;
