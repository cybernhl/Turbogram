...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long startUs, long endUs) throws IllegalClippingException {
            ...
            if (window.durationUs != C0246C.TIME_UNSET) {
            ...
            this.durationUs = resolvedEndUs == C0246C.TIME_UNSET ? C0246C.TIME_UNSET : resolvedEndUs - startUs;
            boolean z = window.isDynamic && (resolvedEndUs == C0246C.TIME_UNSET || (window.durationUs != C0246C.TIME_UNSET && resolvedEndUs == window.durationUs));
            this.isDynamic = z;
        }
        ...
        public Window getWindow(int windowIndex, Window window, boolean setTag, long defaultPositionProjectionUs) {
            ...
            if (window.defaultPositionUs != C0246C.TIME_UNSET) {
                long j;
                window.defaultPositionUs = Math.max(window.defaultPositionUs, this.startUs);
                if (this.endUs == C0246C.TIME_UNSET) {
            ...
            long startMs = C0246C.usToMs(this.startUs);
            if (window.presentationStartTimeMs != C0246C.TIME_UNSET) {
                window.presentationStartTimeMs += startMs;
            }
            if (window.windowStartTimeMs != C0246C.TIME_UNSET) {
        ...
        public Period getPeriod(int periodIndex, Period period, boolean setIds) {
            long periodDurationUs = C0246C.TIME_UNSET;
    ...
    protected long getMediaTimeForChildMediaTime(Void id, long mediaTimeMs) {
        ...
        if (this.endUs != Long.MIN_VALUE) {
            return Math.min(C0246C.usToMs(this.endUs) - startMs, clippedTimeMs);
        }
