...
public class DashManifest implements FilterableManifest<DashManifest> {
    ...
    public final long getPeriodDurationMs(int index) {
        ...
        if (this.durationMs == C0246C.TIME_UNSET) {
    ...
    public final long getPeriodDurationUs(int index) {
        return C0246C.msToUs(getPeriodDurationMs(index));
    }
    ...
    public final DashManifest copy(List<StreamKey> streamKeys) {
        ...
        return new DashManifest(this.availabilityStartTimeMs, this.durationMs != C0246C.TIME_UNSET ? this.durationMs - shiftMs : C0246C.TIME_UNSET, this.minBufferTimeMs, this.dynamic, this.minUpdatePeriodMs, this.timeShiftBufferDepthMs, this.suggestedPresentationDelayMs, this.publishTimeMs, this.utcTiming, this.location, copyPeriods);
    }
