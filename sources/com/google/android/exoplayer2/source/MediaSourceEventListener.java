...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        @CheckResult
        public EventDispatcher withParameters(int windowIndex, @Nullable MediaPeriodId mediaPeriodId, long mediaTimeOffsetMs) {
        ...
        final /* synthetic */ void m561xa9fff584(MediaSourceEventListener listener, MediaPeriodId mediaPeriodId) {
        ...
        final /* synthetic */ void m562xb596e71e(MediaSourceEventListener listener, MediaPeriodId mediaPeriodId) {
        ...
        public void loadStarted(DataSpec dataSpec, Uri uri, int dataType, long elapsedRealtimeMs) {
            loadStarted(dataSpec, uri, dataType, -1, null, 0, null, C0246C.TIME_UNSET, C0246C.TIME_UNSET, elapsedRealtimeMs);
        }

        public void loadStarted(DataSpec dataSpec, Uri uri, int dataType, int trackType, @Nullable Format trackFormat, int trackSelectionReason, @Nullable Object trackSelectionData, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs) {
        ...
        public void loadCompleted(DataSpec dataSpec, Uri uri, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCompleted(dataSpec, uri, dataType, -1, null, 0, null, C0246C.TIME_UNSET, C0246C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }

        public void loadCompleted(DataSpec dataSpec, Uri uri, int dataType, int trackType, @Nullable Format trackFormat, int trackSelectionReason, @Nullable Object trackSelectionData, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
        ...
        public void loadCanceled(DataSpec dataSpec, Uri uri, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCanceled(dataSpec, uri, dataType, -1, null, 0, null, C0246C.TIME_UNSET, C0246C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }

        public void loadCanceled(DataSpec dataSpec, Uri uri, int dataType, int trackType, @Nullable Format trackFormat, int trackSelectionReason, @Nullable Object trackSelectionData, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
        ...
        public void loadError(DataSpec dataSpec, Uri uri, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded, IOException error, boolean wasCanceled) {
            loadError(dataSpec, uri, dataType, -1, null, 0, null, C0246C.TIME_UNSET, C0246C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded, error, wasCanceled);
        }

        public void loadError(DataSpec dataSpec, Uri uri, int dataType, int trackType, @Nullable Format trackFormat, int trackSelectionReason, @Nullable Object trackSelectionData, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded, IOException error, boolean wasCanceled) {
        ...
        final /* synthetic */ void m563xcce9218(MediaSourceEventListener listener, MediaPeriodId mediaPeriodId, MediaLoadData mediaLoadData) {
        ...
        public void downstreamFormatChanged(int trackType, @Nullable Format trackFormat, int trackSelectionReason, @Nullable Object trackSelectionData, long mediaTimeUs) {
            downstreamFormatChanged(new MediaLoadData(1, trackType, trackFormat, trackSelectionReason, trackSelectionData, adjustMediaTime(mediaTimeUs), C0246C.TIME_UNSET));
        }
        ...
        final /* synthetic */ void m560x9a021abe(MediaSourceEventListener listener, MediaLoadData mediaLoadData) {
            listener.onDownstreamFormatChanged(this.windowIndex, this.mediaPeriodId, mediaLoadData);
        }

        private long adjustMediaTime(long mediaTimeUs) {
            long mediaTimeMs = C0246C.usToMs(mediaTimeUs);
            if (mediaTimeMs == C0246C.TIME_UNSET) {
