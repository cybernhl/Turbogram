...
public final class DeferredMediaPeriod implements MediaPeriod, Callback {
    ...
    private long preparePositionOverrideUs = C0246C.TIME_UNSET;
    ...
    public long selectTracks(TrackSelection[] selections, boolean[] mayRetainStreamFlags, SampleStream[] streams, boolean[] streamResetFlags, long positionUs) {
        if (this.preparePositionOverrideUs != C0246C.TIME_UNSET && positionUs == 0) {
            positionUs = this.preparePositionOverrideUs;
            this.preparePositionOverrideUs = C0246C.TIME_UNSET;
        }
