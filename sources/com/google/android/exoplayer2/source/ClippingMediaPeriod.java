...
public final class ClippingMediaPeriod implements MediaPeriod, Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean enableInitialDiscontinuity, long startUs, long endUs) {
        ...
        this.pendingInitialDiscontinuityPositionUs = enableInitialDiscontinuity ? startUs : C0246C.TIME_UNSET;
    ...
    public long selectTracks(TrackSelection[] selections, boolean[] mayRetainStreamFlags, SampleStream[] streams, boolean[] streamResetFlags, long positionUs) {
        ...
        long j = (isPendingInitialDiscontinuity() && positionUs == this.startUs && shouldKeepInitialDiscontinuity(this.startUs, selections)) ? enablePositionUs : C0246C.TIME_UNSET;
    ...
    public long readDiscontinuity() {
        ...
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C0246C.TIME_UNSET;
            long childDiscontinuityUs = readDiscontinuity();
            return childDiscontinuityUs != C0246C.TIME_UNSET ? childDiscontinuityUs : initialDiscontinuityUs;
        } else {
            long discontinuityUs = this.mediaPeriod.readDiscontinuity();
            if (discontinuityUs == C0246C.TIME_UNSET) {
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C0246C.TIME_UNSET;
    }
