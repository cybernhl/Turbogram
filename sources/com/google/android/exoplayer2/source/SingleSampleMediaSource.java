...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    private SingleSampleMediaSource(Uri uri, com.google.android.exoplayer2.upstream.DataSource.Factory dataSourceFactory, Format format, long durationUs, int minLoadableRetryCount, boolean treatLoadErrorsAsEndOfStream, @Nullable Object tag) {
    ...
    public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator) {
        ...
        return new SingleSampleMediaPeriod(this.dataSpec, this.dataSourceFactory, this.transferListener, this.format, this.durationUs, this.minLoadableRetryCount, createEventDispatcher(id), this.treatLoadErrorsAsEndOfStream);
    }
