...
public final class LoopingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class LoopingTimeline extends AbstractConcatenatedTimeline {
        ...
        public LoopingTimeline(Timeline childTimeline, int loopCount) {
            ...
            if (this.childPeriodCount > 0) {
                if (loopCount <= Integer.MAX_VALUE / this.childPeriodCount) {
                    z = true;
                }
    ...
    protected void onChildSourceInfoRefreshed(Void id, MediaSource mediaSource, Timeline timeline, @Nullable Object manifest) {
        ...
        refreshSourceInfo(this.loopCount != Integer.MAX_VALUE ? new LoopingTimeline(timeline, this.loopCount) : new InfinitelyLoopingTimeline(timeline), manifest);
    }
}
