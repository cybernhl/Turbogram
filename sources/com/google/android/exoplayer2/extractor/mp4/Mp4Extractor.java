...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public SeekPoints getSeekPoints(long timeUs) {
        ...
        long firstTimeUs;
        long firstOffset;
        long secondTimeUs = C0246C.TIME_UNSET;
        long secondOffset = -1;
        ...
        for (int i = 0; i < this.tracks.length; i++) {
            if (i != this.firstVideoTrackIndex) {
                ...
                if (secondTimeUs != C0246C.TIME_UNSET) {
    ...
    private void processMoovAtom(ContainerAtom moov) throws ParserException {
        ...
        long durationUs = C0246C.TIME_UNSET;
        ...
        try {
            trackSampleTables = getTrackSampleTables(moov, gaplessInfoHolder, (this.flags & 1) != 0);
        } catch (UnhandledEditListException e) {
        ...
        for (int i = 0; i < trackCount; i++) {
            ...
            durationUs = Math.max(durationUs, track.durationUs != C0246C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs);
    ...
    private ArrayList<TrackSampleTable> getTrackSampleTables(ContainerAtom moov, GaplessInfoHolder gaplessInfoHolder, boolean ignoreEditLists) throws ParserException {
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            if (atom.type == Atom.TYPE_trak) {
                Track track = AtomParsers.parseTrak(atom, moov.getLeafAtomOfType(Atom.TYPE_mvhd), C0246C.TIME_UNSET, null, ignoreEditLists, this.isQuickTime);
                if (track != null) {
