...
public final class AmrExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C02751();
    ...
    /* renamed from: com.google.android.exoplayer2.extractor.amr.AmrExtractor$1 */
    static class C02751 implements ExtractorsFactory {
        C02751() {
        }
    ...
    private void maybeOutputSeekMap(long inputLength, int sampleReadResult) {
        if (!this.hasOutputSeekMap) {
            if ((this.flags & 1) == 0 || inputLength == -1 || !(this.firstSampleSize == -1 || this.firstSampleSize == this.currentSampleSize)) {
                this.seekMap = new Unseekable(C0246C.TIME_UNSET);
