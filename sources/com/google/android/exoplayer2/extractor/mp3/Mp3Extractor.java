...
public final class Mp3Extractor implements Extractor {
    ...
    public Mp3Extractor(int flags, long forcedFirstSampleTimestampUs) {
        ...
        this.basisTimeUs = C0246C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C0246C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C0246C.TIME_UNSET) {
    ...
    L_0x001e:
        r3 = com.google.android.exoplayer2.extractor.GaplessInfoHolder.GAPLESS_INFO_ID3_FRAME_PREDICATE;
    L_0x0020:
        r10 = r14.id3Peeker;
    ...
    L_0x0082:
        r10 = new com.google.android.exoplayer2.ParserException;
