...
final class XingSeeker implements Seeker {
    ...
    public long getTimeUs(long position) {
        ...
        return Math.round(((double) (nextTimeUs - prevTimeUs)) * (prevScaledPosition == nextScaledPosition ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : (scaledPosition - ((double) prevScaledPosition)) / ((double) (nextScaledPosition - prevScaledPosition)))) + prevTimeUs;
    }
