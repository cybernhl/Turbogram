        ...
        while (true) {
            ...
            if (startCodeValue == 0 || startCodeValue == START_SEQUENCE_HEADER) {
                ...
                if (!this.startedFirstSample || this.sampleHasPicture) {
                    ...
                    long j = this.pesTimeUs != C0246C.TIME_UNSET ? this.pesTimeUs : this.startedFirstSample ? this.sampleTimeUs + this.frameDurationUs : 0;
                    this.sampleTimeUs = j;
                    this.sampleIsKeyframe = false;
                    this.pesTimeUs = C0246C.TIME_UNSET;
