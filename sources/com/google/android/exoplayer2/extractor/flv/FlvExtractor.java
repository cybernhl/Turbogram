...
public final class FlvExtractor implements Extractor {
    ...
    private long mediaTagTimestampOffsetUs = C0246C.TIME_UNSET;
    ...
    public void seek(long position, long timeUs) {
        this.state = 1;
        this.mediaTagTimestampOffsetUs = C0246C.TIME_UNSET;
    ...
    private void ensureReadyForMediaOutput() {
        if (!this.outputSeekMap) {
            this.extractorOutput.seekMap(new Unseekable(C0246C.TIME_UNSET));
            this.outputSeekMap = true;
        }
        if (this.mediaTagTimestampOffsetUs == C0246C.TIME_UNSET) {
            this.mediaTagTimestampOffsetUs = this.metadataReader.getDurationUs() == C0246C.TIME_UNSET ? -this.tagTimestampUs : 0;
        }
    }
}
