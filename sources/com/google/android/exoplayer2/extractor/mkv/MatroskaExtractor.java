...
public final class MatroskaExtractor implements Extractor {
    ...
    MatroskaExtractor(EbmlReader reader, int flags) {
        ...
        this.timecodeScale = C0246C.TIME_UNSET;
        this.durationTimecode = C0246C.TIME_UNSET;
        this.durationUs = C0246C.TIME_UNSET;
        this.cuesContentPosition = -1;
        this.seekPositionAfterBuildingCues = -1;
        this.clusterTimecodeUs = C0246C.TIME_UNSET;
        this.reader = reader;
    ...
    void endMasterElement(int id) throws ParserException {
        switch (id) {
            ...
            case ID_CONTENT_ENCODING /*25152*/:
                ...
                this.currentTrack.drmInitData = new DrmInitData(new SchemeData(C0246C.UUID_NIL, MimeTypes.VIDEO_WEBM, this.currentTrack.cryptoData.encryptionKey));
                return;
            case ID_CONTENT_ENCODINGS /*28032*/:
                ...
                return;
            case 357149030:
                if (this.timecodeScale == C0246C.TIME_UNSET) {
                    this.timecodeScale = 1000000;
                }
                if (this.durationTimecode != C0246C.TIME_UNSET) {
        ...
        switch (id) {
            ...
            case ID_SIMPLE_BLOCK /*163*/:
                if (this.blockState == 0) {
                    ...
                    this.blockDurationUs = C0246C.TIME_UNSET;
                    this.blockState = 1;
                    this.scratch.reset();
                }
    ...
    private static void setSampleDuration(byte[] subripSampleData, long durationUs, String timecodeFormat, int endTimecodeOffset, long lastTimecodeValueScalingFactor, byte[] emptyTimecode) {
        byte[] timeCodeData;
        if (durationUs == C0246C.TIME_UNSET) {
    ...
    private SeekMap buildSeekMap() {
        if (this.segmentContentPosition == -1 || this.durationUs == C0246C.TIME_UNSET || this.cueTimesUs == null || this.cueTimesUs.size() == 0 || this.cueClusterPositions == null || this.cueClusterPositions.size() != this.cueTimesUs.size()) {
