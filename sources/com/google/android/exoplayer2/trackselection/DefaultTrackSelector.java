...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class Parameters implements Parcelable {
        public static final Creator<Parameters> CREATOR = new C03461();
        ...
        static class C03461 implements Creator<Parameters> {
            C03461() {
            }
        ...
        public int hashCode() {
            ...
            int i4 = ((result * 31) + this.disabledTextTrackSelectionFlags) * 31;
            ...
            i4 = (((((i4 + i) * 31) + this.maxVideoWidth) * 31) + this.maxVideoHeight) * 31;
            ...
            i = (((((((((i + i2) * 31) + this.viewportWidth) * 31) + this.viewportHeight) * 31) + this.maxVideoBitrate) * 31) + this.tunnelingAudioSessionId) * 31;
            if (this.preferredAudioLanguage == null) {
                i2 = 0;
            } else {
                i2 = this.preferredAudioLanguage.hashCode();
            }
            i2 = (i + i2) * 31;
    ...
    public static final class SelectionOverride implements Parcelable {
        public static final Creator<SelectionOverride> CREATOR = new C03471();
        public final int groupIndex;
        public final int length;
        public final int[] tracks;

        /* renamed from: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$SelectionOverride$1 */
        static class C03471 implements Creator<SelectionOverride> {
            C03471() {
            }
    ...
    @Nullable
    protected TrackSelection selectAudioTrack(TrackGroupArray groups, int[][] formatSupports, int mixedMimeTypeAdaptationSupports, Parameters params, @Nullable Factory adaptiveTrackSelectionFactory) throws ExoPlaybackException {
        ...
        if (!(params.forceLowestBitrate || adaptiveTrackSelectionFactory == null)) {
            ...
            if (adaptiveTracks.length > 0) {
                return adaptiveTrackSelectionFactory.createTrackSelection(selectedGroup, getBandwidthMeter(), adaptiveTracks);
            }
        }
    ...
    protected static boolean formatHasNoLanguage(Format format) {
        return TextUtils.isEmpty(format.language) || formatHasLanguage(format, C0246C.LANGUAGE_UNDETERMINED);
    }
