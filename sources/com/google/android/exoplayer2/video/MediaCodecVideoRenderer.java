...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    public MediaCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector, long allowedJoiningTimeMs, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, boolean playClearSamplesWithoutKeys, @Nullable Handler eventHandler, @Nullable VideoRendererEventListener eventListener, int maxDroppedFramesToNotify) {
        ...
        this.outputStreamOffsetUs = C0246C.TIME_UNSET;
        this.lastInputTimeUs = C0246C.TIME_UNSET;
        this.joiningDeadlineMs = C0246C.TIME_UNSET;
        this.currentWidth = -1;
    ...
    protected void onStreamChanged(Format[] formats, long offsetUs) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == C0246C.TIME_UNSET) {
    ...
    protected void onPositionReset(long positionUs, boolean joining) throws ExoPlaybackException {
        ...
        this.initialPositionUs = C0246C.TIME_UNSET;
    ...
    public boolean isReady() {
        if (super.isReady() && (this.renderedFirstFrame || ((this.dummySurface != null && this.surface == this.dummySurface) || getCodec() == null || this.tunneling))) {
            this.joiningDeadlineMs = C0246C.TIME_UNSET;
            return true;
        } else if (this.joiningDeadlineMs == C0246C.TIME_UNSET) {
            return false;
        } else {
    ...
    protected void onOutputFormatChanged(MediaCodec codec, MediaFormat outputFormat) {
        ...
        if (hasCrop) {
            ...
            integer = outputFormat.getInteger(MonthView.VIEW_PARAMS_HEIGHT);
        }
    ...
    protected boolean processOutputBuffer(long positionUs, long elapsedRealtimeUs, MediaCodec codec, ByteBuffer buffer, int bufferIndex, int bufferFlags, long bufferPresentationTimeUs, boolean shouldSkip) throws ExoPlaybackException {
        if (this.initialPositionUs == C0246C.TIME_UNSET) {
    ...
    private void setJoiningDeadlineMs() {
        this.joiningDeadlineMs = this.allowedJoiningTimeMs > 0 ? SystemClock.elapsedRealtime() + this.allowedJoiningTimeMs : C0246C.TIME_UNSET;
    }
    ...
    protected MediaFormat getMediaFormat(Format format, CodecMaxValues codecMaxValues, float codecOperatingRate, boolean deviceNeedsAutoFrcWorkaround, int tunnelingAudioSessionId) {
        ...
        mediaFormat.setInteger(MonthView.VIEW_PARAMS_HEIGHT, format.height);
