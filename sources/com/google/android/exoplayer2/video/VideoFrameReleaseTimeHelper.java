...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static final class VSyncSampler implements Callback, FrameCallback {
        ...
        public volatile long sampledVsyncTimeNs = C0246C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (this.observerCount == 0) {
                ...
                this.sampledVsyncTimeNs = C0246C.TIME_UNSET;
            }
        }
    }
    ...
    public VideoFrameReleaseTimeHelper(@Nullable Context context) {
        ...
        if (this.windowManager != null) {
            DefaultDisplayListener maybeBuildDefaultDisplayListenerV17;
            if (Util.SDK_INT >= 17) {
                maybeBuildDefaultDisplayListenerV17 = maybeBuildDefaultDisplayListenerV17(context);
            } else {
                maybeBuildDefaultDisplayListenerV17 = null;
            }
        ...
        this.vsyncDurationNs = C0246C.TIME_UNSET;
        this.vsyncOffsetNs = C0246C.TIME_UNSET;
    }
    ...
    public long adjustReleaseTime(long framePresentationTimeUs, long unadjustedReleaseTimeNs) {
        ...
        if (this.vsyncSampler == null || this.vsyncDurationNs == C0246C.TIME_UNSET) {
            return adjustedReleaseTimeNs;
        }
        long sampledVsyncTimeNs = this.vsyncSampler.sampledVsyncTimeNs;
        return sampledVsyncTimeNs != C0246C.TIME_UNSET ? closestVsync(adjustedReleaseTimeNs, sampledVsyncTimeNs, this.vsyncDurationNs) - this.vsyncOffsetNs : adjustedReleaseTimeNs;
    }
