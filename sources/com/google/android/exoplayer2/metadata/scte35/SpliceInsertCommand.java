...
public final class SpliceInsertCommand extends SpliceCommand {
    public static final Creator<SpliceInsertCommand> CREATOR = new C03001();
    ...
    static class C03001 implements Creator<SpliceInsertCommand> {
        C03001() {
        }
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray sectionData, long ptsAdjustment, TimestampAdjuster timestampAdjuster) {
        ...
        long programSplicePts = C0246C.TIME_UNSET;
        ...
        if (!spliceEventCancelIndicator) {
            ...
            if (!programSpliceFlag) {
                ...
                for (int i = 0; i < componentCount; i++) {
                    ...
                    long componentSplicePts = C0246C.TIME_UNSET;
