...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final LoadErrorAction DONT_RETRY = new LoadErrorAction(2, C0246C.TIME_UNSET);
    public static final LoadErrorAction DONT_RETRY_FATAL = new LoadErrorAction(3, C0246C.TIME_UNSET);
    public static final LoadErrorAction RETRY = createRetryAction(false, C0246C.TIME_UNSET);
    public static final LoadErrorAction RETRY_RESET_ERROR_COUNT = createRetryAction(true, C0246C.TIME_UNSET);
                    ...
                    switch (msg.what) {
                        ...
                        case 3:
                            ...
                            if (action.type == 3) {
                                ...
                                if (action.retryDelayMillis != C0246C.TIME_UNSET) {
