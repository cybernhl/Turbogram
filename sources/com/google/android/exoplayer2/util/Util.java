...
public final class Util {
    ...
    public static long parseXsDuration(String value) {
        ...
        durationSeconds += months != null ? Double.parseDouble(months) * 2629739.0d : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        String days = matcher.group(7);
        durationSeconds += days != null ? Double.parseDouble(days) * 86400.0d : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        String hours = matcher.group(10);
        durationSeconds += hours != null ? Double.parseDouble(hours) * 3600.0d : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        String minutes = matcher.group(12);
        durationSeconds += minutes != null ? Double.parseDouble(minutes) * 60.0d : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE;
        String seconds = matcher.group(14);
        long durationMillis = (long) (1000.0d * (durationSeconds + (seconds != null ? Double.parseDouble(seconds) : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE)));
        if (negated) {
    ...
    public static UUID getDrmUuid(String drmScheme) {
        ...
        switch (obj) {
            case null:
                return C0246C.WIDEVINE_UUID;
            case 1:
                return C0246C.PLAYREADY_UUID;
            case 2:
                return C0246C.CLEARKEY_UUID;
            default:
                try {
    ...
    public static int getDefaultBufferSize(int trackType) {
        switch (trackType) {
            case 0:
                return 16777216;
            case 1:
                return C0246C.DEFAULT_AUDIO_BUFFER_SIZE;
            case 2:
                return C0246C.DEFAULT_VIDEO_BUFFER_SIZE;
            case 3:
            case 4:
                return 131072;
            default:
