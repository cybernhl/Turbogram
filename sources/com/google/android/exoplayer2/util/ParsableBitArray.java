...
public final class ParsableBitArray {
    ...
    public void readBits(byte[] buffer, int offset, int numBits) {
        ...
        if (bitsLeft != 0) {
            ...
            if (this.bitOffset + bitsLeft > 8) {
                ...
                buffer[to] = (byte) (b | ((bArr2[i3] & 255) << this.bitOffset));
                this.bitOffset -= 8;
            }
    ...
    public void putInt(int value, int numBits) {
        ...
        this.data[this.byteOffset] = (byte) (this.data[this.byteOffset] & ((MotionEventCompat.ACTION_POINTER_INDEX_MASK >> this.bitOffset) | ((1 << firstByteRightPaddingSize) - 1)));
        this.data[this.byteOffset] = (byte) (this.data[this.byteOffset] | ((value >>> (numBits - firstByteReadSize)) << firstByteRightPaddingSize));
        ...
        this.data[currentByteIndex] = (byte) (this.data[currentByteIndex] | ((value & ((1 << remainingBitsToRead) - 1)) << lastByteRightPaddingSize));
        skipBits(numBits);
        assertValidOffset();
    }
