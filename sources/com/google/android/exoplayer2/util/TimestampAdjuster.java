...
public final class TimestampAdjuster {
    ...
    private volatile long lastSampleTimestamp = C0246C.TIME_UNSET;
    ...
    public synchronized void setFirstSampleTimestampUs(long firstSampleTimestampUs) {
        Assertions.checkState(this.lastSampleTimestamp == C0246C.TIME_UNSET);
    ...
    public long getLastAdjustedTimestampUs() {
        if (this.lastSampleTimestamp != C0246C.TIME_UNSET) {
            return this.lastSampleTimestamp;
        }
        return this.firstSampleTimestampUs != Long.MAX_VALUE ? this.firstSampleTimestampUs : C0246C.TIME_UNSET;
    }
    ...
    public long getTimestampOffsetUs() {
        ...
        return this.lastSampleTimestamp != C0246C.TIME_UNSET ? this.timestampOffsetUs : C0246C.TIME_UNSET;
    }

    public void reset() {
        this.lastSampleTimestamp = C0246C.TIME_UNSET;
    }

    public long adjustTsTimestamp(long pts) {
        if (pts == C0246C.TIME_UNSET) {
    ...
    public synchronized void waitUntilInitialized() throws InterruptedException {
        while (this.lastSampleTimestamp == C0246C.TIME_UNSET) {
            wait();
        }
    }
