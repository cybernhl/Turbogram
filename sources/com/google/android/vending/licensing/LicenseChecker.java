...
public class LicenseChecker implements ServiceConnection {
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (myketPackageInfo == null) {
        ...
        } else if (myketPackageInfo.versionCode < 510) {
            callback.dontAllow(Policy.MYKET_NOT_SUPPORTED);
        } else if (this.mPolicy.allowAccess()) {
            ...
            if (this.mService == null) {
                ...
                try {
                    Intent intent = new Intent(new String(Base64.decode("aXIubXNlcnZpY2VzLm1hcmtldC5JTGljZW5zaW5nU2VydmljZQ==")));
    ...
    private PackageInfo getMyketPackageInfo() {
        try {
            return this.mContext.getPackageManager().getPackageInfo(MYKET_PACKAGE_NAME, 0);
        } catch (NameNotFoundException e) {
            return null;
        }
    }
