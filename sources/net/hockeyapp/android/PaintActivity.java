...
public class PaintActivity extends Activity {
    ...
    class C06221 extends AsyncTask<Void, Object, Integer> {
        C06221() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        AsyncTaskUtils.execute(new C06221());
    }

    public boolean onCreateOptionsMenu(Menu menu) {
        super.onCreateOptionsMenu(menu);
        menu.add(0, 1, 0, getString(C0625R.string.hockeyapp_paint_menu_save));
        menu.add(0, 2, 0, getString(C0625R.string.hockeyapp_paint_menu_undo));
        menu.add(0, 3, 0, getString(C0625R.string.hockeyapp_paint_menu_clear));
        return true;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        OnClickListener dialogClickListener = new C06232();
        new Builder(this).setMessage(C0625R.string.hockeyapp_paint_dialog_message).setPositiveButton(C0625R.string.hockeyapp_paint_dialog_positive_button, dialogClickListener).setNegativeButton(C0625R.string.hockeyapp_paint_dialog_negative_button, dialogClickListener).setNeutralButton(C0625R.string.hockeyapp_paint_dialog_neutral_button, dialogClickListener).show();
        return true;
    }
    ...
    private void showPaintView() {
        ...
        Toast.makeText(this, C0625R.string.hockeyapp_paint_indicator_toast, 1).show();
    }
        ...
        AsyncTaskUtils.execute(new AsyncTask<Void, Object, Boolean>() {
            ...
            protected void onPostExecute(Boolean success) {
                if (success.booleanValue()) {
                    ...
                    intent.putExtra(PaintActivity.EXTRA_IMAGE_URI, Uri.fromFile(this.result));
