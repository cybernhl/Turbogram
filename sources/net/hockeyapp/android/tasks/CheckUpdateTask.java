    ...
    private boolean findNewVersion(Context context, JSONArray json, int versionCode) {
        ...
        while (index < json.length()) {
            try {
                ...
                if (entry.getInt(ProviderConstants.API_COLNAME_FEATURE_VERSION) == versionCode && VersionHelper.isNewerThanLastUpdateTime(context, entry.getLong(Param.TIMESTAMP))) {
                    newerApkFile = true;
                } else {
                    newerApkFile = false;
                }
