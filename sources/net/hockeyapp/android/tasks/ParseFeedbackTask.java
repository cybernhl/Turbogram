...
public class ParseFeedbackTask extends AsyncTask<Void, Void, FeedbackResponse> {
    ...
    private static void showNewAnswerNotification(Context context, String urlString) {
        ...
        Util.sendNotification(context, 2, Util.createNotification(context, PendingIntent.getActivity(context, 0, intent, 1073741824), context.getString(C0625R.string.hockeyapp_feedback_notification_title), context.getString(C0625R.string.hockeyapp_feedback_new_answer_notification_message), iconId, FeedbackManager.NOTIFICATION_CHANNEL_ID), FeedbackManager.NOTIFICATION_CHANNEL_ID, context.getString(C0625R.string.hockeyapp_feedback_notification_channel));
    }
}
