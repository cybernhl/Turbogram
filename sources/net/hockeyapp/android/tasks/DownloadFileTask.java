...
public class DownloadFileTask extends AsyncTask<Void, Integer, Long> {
    ...
    protected void onProgressUpdate(Integer... args) {
        try {
            if (this.mProgressDialog == null) {
                ...
                this.mProgressDialog.setMessage(this.mContext.getString(C0625R.string.hockeyapp_update_loading));
    ...
    protected void onPostExecute(Long result) {
        ...
        try {
            ...
            builder.setTitle(C0625R.string.hockeyapp_download_failed_dialog_title);
            if (this.mDownloadErrorMessage == null) {
                message = this.mContext.getString(C0625R.string.hockeyapp_download_failed_dialog_message);
            } else {
                message = this.mDownloadErrorMessage;
            }
            builder.setMessage(message);
            builder.setNegativeButton(C0625R.string.hockeyapp_download_failed_dialog_negative_button, new C06411());
            builder.setPositiveButton(C0625R.string.hockeyapp_download_failed_dialog_positive_button, new C06422());
            builder.create().show();
        } catch (Exception e2) {
        }
    }
