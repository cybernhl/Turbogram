...
class VersionedParcelStream extends VersionedParcel {
    ...
    private static final Charset UTF_16 = Charset.forName(C0246C.UTF16_NAME);
    ...
    public boolean readField(int fieldId) {
        ...
        while (true) {
            try {
                ...
                buffer = new InputBuffer((fieldInfo >> 16) & 65535, size, this.mMasterInput);
