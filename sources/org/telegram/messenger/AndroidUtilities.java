...
public class AndroidUtilities {
    ...
    static class C06645 extends CrashManagerListener {
        C06645() {
        }
...
*/
    ...
    L_0x006c:
        r7 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r7);	 Catch:{ Exception -> 0x006c, all -> 0x0076 }
        if (r6 == 0) goto L_0x0004;
    L_0x0072:
        r6.close();
        goto L_0x0004;
    ...
    public static int[] calcDrawableColor(Drawable drawable) {
        ...
        hsv[2] = Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, hsv[2] * 0.65d);
    ...
    private static double[] rgbToHsv(int r, int g, int b) {
        ...
        double d = max - min;
        double s = max == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : d / max;
        if (max == min) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Typeface getTypeface(java.lang.String r7) {
        /*
        r5 = typefaceCache;
        monitor-enter(r5);
        r2 = 0;
        r4 = turbogram.Utilities.TurboConfig.fontType;	 Catch:{ Exception -> 0x0094 }
        switch(r4) {
    ...
    L_0x0009:
        r4 = typefaceCache;	 Catch:{ all -> 0x00d8 }
        r4 = r4.containsKey(r7);	 Catch:{ all -> 0x00d8 }
        if (r4 != 0) goto L_0x0046;
    L_0x0011:
        r4 = android.os.Build.VERSION.SDK_INT;	 Catch:{ Exception -> 0x00a9 }
        r6 = 26;
        if (r4 < r6) goto L_0x009a;
    L_0x0017:
        r0 = new android.graphics.Typeface$Builder;	 Catch:{ Exception -> 0x00a9 }
        r4 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Exception -> 0x00a9 }
        r4 = r4.getAssets();	 Catch:{ Exception -> 0x00a9 }
        r0.<init>(r4, r7);	 Catch:{ Exception -> 0x00a9 }
        r4 = "medium";
        r4 = r7.contains(r4);	 Catch:{ Exception -> 0x00a9 }
        if (r4 == 0) goto L_0x0030;
    L_0x002b:
        r4 = 700; // 0x2bc float:9.81E-43 double:3.46E-321;
        r0.setWeight(r4);	 Catch:{ Exception -> 0x00a9 }
    L_0x0030:
        r4 = "italic";
        r4 = r7.contains(r4);	 Catch:{ Exception -> 0x00a9 }
    ...
    L_0x0039:
        r4 = 1;
        r0.setItalic(r4);	 Catch:{ Exception -> 0x00a9 }
    L_0x003d:
        r3 = r0.build();	 Catch:{ Exception -> 0x00a9 }
    L_0x0041:
        r4 = typefaceCache;	 Catch:{ Exception -> 0x00a9 }
        r4.put(r7, r3);	 Catch:{ Exception -> 0x00a9 }
    L_0x0046:
        r4 = typefaceCache;	 Catch:{ all -> 0x00d8 }
        r4 = r4.get(r7);	 Catch:{ all -> 0x00d8 }
        r4 = (android.graphics.Typeface) r4;	 Catch:{ all -> 0x00d8 }
    ...
    L_0x0052:
        ...
        goto L_0x0009;
    L_0x0056:
        r7 = "fonts/iransans_ultralight.ttf";
        goto L_0x0009;
    L_0x005a:
        r7 = "fonts/iransans_light.ttf";
        goto L_0x0009;
    L_0x005e:
        r7 = "fonts/iransans.ttf";
        goto L_0x0009;
    L_0x0062:
        r7 = "fonts/iransans_medium.ttf";
        goto L_0x0009;
    L_0x0066:
        r7 = "fonts/iransans_bold.ttf";
        goto L_0x0009;
    L_0x006a:
        r7 = "fonts/afsaneh.ttf";
        goto L_0x0009;
    L_0x006e:
        r7 = "fonts/dastnevis.ttf";
        goto L_0x0009;
    L_0x0072:
        r7 = "fonts/hama.ttf";
        goto L_0x0009;
    L_0x0076:
        r7 = "fonts/morvarid.ttf";
        goto L_0x0009;
    L_0x007a:
        r7 = "fonts/titr.ttf";
        goto L_0x0009;
    ...
    L_0x0082:
        ...
        goto L_0x0009;
    L_0x0086:
        r7 = "fonts/iranyekan_light.ttf";
        goto L_0x0009;
    L_0x008a:
        r7 = "fonts/iranyekan.ttf";
        goto L_0x0009;
    L_0x008f:
        r7 = "fonts/iranyekan_bold.ttf";
        goto L_0x0009;
    L_0x0094:
        r1 = move-exception;
        r7 = "fonts/iransans_light.ttf";
        goto L_0x0009;
    L_0x009a:
        r3 = android.graphics.Typeface.DEFAULT;	 Catch:{ Exception -> 0x00a9 }
        if (r2 != 0) goto L_0x0041;
    L_0x009e:
        r4 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Exception -> 0x00a9 }
        r4 = r4.getAssets();	 Catch:{ Exception -> 0x00a9 }
        r3 = android.graphics.Typeface.createFromAsset(r4, r7);	 Catch:{ Exception -> 0x00a9 }
        goto L_0x0041;
    L_0x00a9:
        r1 = move-exception;
        r4 = org.telegram.messenger.BuildVars.LOGS_ENABLED;	 Catch:{ all -> 0x00d8 }
        if (r4 == 0) goto L_0x00d4;
    L_0x00ae:
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00d8 }
        r4.<init>();	 Catch:{ all -> 0x00d8 }
        r6 = "Could not get typeface '";
        r4 = r4.append(r6);	 Catch:{ all -> 0x00d8 }
        r4 = r4.append(r7);	 Catch:{ all -> 0x00d8 }
        r6 = "' because ";
        r4 = r4.append(r6);	 Catch:{ all -> 0x00d8 }
        r6 = r1.getMessage();	 Catch:{ all -> 0x00d8 }
        r4 = r4.append(r6);	 Catch:{ all -> 0x00d8 }
        r4 = r4.toString();	 Catch:{ all -> 0x00d8 }
        org.telegram.messenger.FileLog.m1222e(r4);	 Catch:{ all -> 0x00d8 }
    L_0x00d4:
        r4 = 0;
        monitor-exit(r5);	 Catch:{ all -> 0x00d8 }
        goto L_0x004f;
    L_0x00d8:
        ...
        throw r4;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.AndroidUtilities.getTypeface(java.lang.String):android.graphics.Typeface");
    }
    ...
    public static void checkDisplaySize(Context context, Configuration newConfiguration) {
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1222e("display size = " + displaySize.x + " " + displaySize.y + " " + displayMetrics.xdpi + "x" + displayMetrics.ydpi);
            }
        } catch (Throwable e) {
            FileLog.m1224e(e);
        }
    ...
    private static void registerLoginContentObserver(boolean shouldRegister, final String number) {
        if (shouldRegister) {
            if (callLogContentObserver == null) {
                ...
                ContentObserver c06612 = new ContentObserver(new Handler()) {
                ...
                callLogContentObserver = c06612;
                contentResolver.registerContentObserver(uri, true, c06612);
                Runnable c06623 = new Runnable() {
                    public void run() {
                        AndroidUtilities.unregisterRunnable = null;
                        AndroidUtilities.registerLoginContentObserver(false, number);
                    }
                };
                unregisterRunnable = c06623;
                runOnUIThread(c06623, 10000);
            }
    ...
    public static void checkForCrashes(Activity context) {
        CrashManager.register(context, BuildVars.DEBUG_VERSION ? BuildVars.HOCKEY_APP_HASH_DEBUG : BuildVars.HOCKEY_APP_HASH, new C06645());
    }
    ...
    private static File getAlbumDir() {
        ...
        if ("mounted".equals(Environment.getExternalStorageState())) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1221d("failed to create directory");
            }
            return null;
        } else if (!BuildVars.LOGS_ENABLED) {
            return null;
        } else {
            FileLog.m1221d("External storage is not mounted READ/WRITE.");
            return null;
        }
    }
    ...
    L_0x0103:
        r2 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r2);
        goto L_0x0050;
        */
        ...
        if (f != null && f.exists()) {
            ...
            if (VERSION.SDK_INT < 26 || realMimeType == null || !realMimeType.equals("application/vnd.android.package-archive") || ApplicationLoader.applicationContext.getPackageManager().canRequestPackageInstalls()) {
                if (VERSION.SDK_INT >= 24) {
                    intent.setDataAndType(FileProvider.getUriForFile(activity, "com.baranak.turbogramf.provider", f), realMimeType != null ? realMimeType : "text/plain");
                } else {
                ...
                if (realMimeType != null) {
                    try {
                        ...
                        if (VERSION.SDK_INT >= 24) {
                            intent.setDataAndType(FileProvider.getUriForFile(activity, "com.baranak.turbogramf.provider", f), "text/plain");
                        } else {
                    ...
                    if (scheme.equals("http") || scheme.equals("https")) {
                        ...
                        if (host.equals("telegram.me") || host.equals("t.me") || host.equals("telegram.dog") || host.equals("telesco.pe")) {
                            ...
                            if (path != null && (path.startsWith("/socks") || path.startsWith("/proxy"))) {
                                ...
                                secret = data.getQueryParameter(LoginActivity.EXTRA_SECRET);
                            }
                        }
        ...
        textView.doneButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str3)) {
                    ...
                    info = new SharedConfig$ProxyInfo(str, p, str5, str4, "");
                } else {
                    editor.remove("proxy_pass");
                    editor.remove("proxy_user");
                    editor.putString("proxy_secret", str3);
                    info = new SharedConfig$ProxyInfo(str, p, "", "", str3);
                }
                editor.commit();
