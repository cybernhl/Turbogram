...
final /* synthetic */ class MessagesController$$Lambda$64 implements Runnable {
    ...
    MessagesController$$Lambda$64(MessagesController messagesController, TLRPC$messages_Messages tLRPC$messages_Messages, long j, boolean z, int i, int i2, boolean z2, int i3, int i4, int i5, int i6, int i7, boolean z3, int i8, int i9, int i10, int i11, boolean z4) {
