        ...
        if (MediaController.access$000(this.this$0) != null) {
            ...
            if (len > 0) {
                ...
                if (len != 0) {
                    MediaController.access$900(this.this$0).postRunnable(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MediaController.access$800(MediaController$1.this.this$0).postRunnable(new C08321());
                        }
                    });
                }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        NotificationCenter.getInstance(MediaController.access$1200(MediaController$1.this.this$0)).postNotificationName(NotificationCenter.recordProgressChanged, Long.valueOf(System.currentTimeMillis() - MediaController.access$1100(MediaController$1.this.this$0)), Double.valueOf(amplitude));
                    }
                });
                return;
            }
