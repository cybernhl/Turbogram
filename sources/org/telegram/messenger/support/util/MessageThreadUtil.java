...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> callback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C09111();
            ...
            class C09111 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem msg = C09121.this.mQueue.next();
                    while (msg != null) {
                        switch (msg.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> callback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C09131();
            ...
            class C09131 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem msg = C09142.this.mQueue.next();
                        if (msg != null) {
                            switch (msg.what) {
                                case 1:
                                    C09142.this.mQueue.removeMessages(1);
                                    callback.refresh(msg.arg1);
                                    break;
                                case 2:
                                    C09142.this.mQueue.removeMessages(2);
                                    C09142.this.mQueue.removeMessages(3);
                        ...
                        C09142.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
