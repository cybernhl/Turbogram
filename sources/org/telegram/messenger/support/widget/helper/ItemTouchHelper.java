...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C09222();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C09211();
    ...
    class C09222 implements OnItemTouchListener {
        C09222() {
        }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C09281 implements AnimatorUpdateListener {
            C09281() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C09281());
    ...
    class C09255 implements ChildDrawingOrderCallback {
        C09255() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C09261();
        private static final Interpolator sDragViewScrollCapInterpolator = new C09272();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: org.telegram.messenger.support.widget.helper.ItemTouchHelper$Callback$1 */
        static class C09261 implements Interpolator {
            C09261() {
            }
        ...
        static class C09272 implements Interpolator {
            C09272() {
            }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C09255();
            }
