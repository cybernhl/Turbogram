...
public class StaggeredGridLayoutManager$SavedState implements Parcelable {
    public static final Creator<StaggeredGridLayoutManager$SavedState> CREATOR = new C09201();
    ...
    static class C09201 implements Creator<StaggeredGridLayoutManager$SavedState> {
        C09201() {
        }
