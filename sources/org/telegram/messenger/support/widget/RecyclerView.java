...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C07223();
    ...
    static class C07223 implements Interpolator {
        C07223() {
        }
    ...
    class C07234 implements ProcessCallback {
        C07234() {
        }
    ...
    class C07245 implements Callback {
        C07245() {
        }
    ...
    class C07256 implements Callback {
        C07256() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new RecyclerView$LayoutManager$1(this);
        ...
        private final Callback mVerticalBoundCheckCallback = new RecyclerView$LayoutManager$2(this);
        private int mWidth;
    ...
    public static class RecycledViewPool {
        ...
        public void setMaxRecycledViews(int viewType, int max) {
            RecyclerView$RecycledViewPool$ScrapData scrapData = getScrapDataForType(viewType);
        ...
        int size() {
            int count = 0;
            for (int i = 0; i < this.mScrap.size(); i++) {
                ArrayList<ViewHolder> viewHolders = ((RecyclerView$RecycledViewPool$ScrapData) this.mScrap.valueAt(i)).mScrapHeap;
                if (viewHolders != null) {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new RecyclerView$SavedState$1();
    ...
    public static abstract class SmoothScroller {
        ...
        protected abstract void onSeekTargetStep(int i, int i2, State state, RecyclerView$SmoothScroller$Action recyclerView$SmoothScroller$Action);

        protected abstract void onStart();

        protected abstract void onStop();

        protected abstract void onTargetFound(View view, State state, RecyclerView$SmoothScroller$Action recyclerView$SmoothScroller$Action);
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C07201();
        ...
        this.mItemAnimatorRunner = new C07212();
        this.mViewInfoProcessCallback = new C07234();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C07245());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C07256());
    }
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, this.mScrollOffset, 0)) {
            ...
            if (!(ev == null || MotionEventCompat.isFromSource(ev, InputDeviceCompat.SOURCE_MOUSE))) {
