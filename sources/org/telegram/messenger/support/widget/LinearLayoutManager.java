...
public class LinearLayoutManager extends LayoutManager implements RecyclerView$SmoothScroller$ScrollVectorProvider, ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C09151();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        /* renamed from: org.telegram.messenger.support.widget.LinearLayoutManager$SavedState$1 */
        static class C09151 implements Creator<SavedState> {
            C09151() {
            }
