...
public class MrzRecognizer {
    ...
    private static Result recognizeBarcode(Bitmap bitmap) {
        ...
        if (bitmap.getWidth() > ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED || bitmap.getHeight() > ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED) {
    ...
    private static Result recognizeMRZ(Bitmap bitmap) {
        ...
        } else if (bitmap.getWidth() > ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED || bitmap.getHeight() > ConnectionResult.DRIVE_EXTERNAL_STORAGE_REQUIRED) {
