...
public class CameraController implements OnInfoListener {
    ...
    class C08841 implements Runnable {
        ...
        class C08801 implements Comparator<Size> {
            C08801() {
            }
        ...
        class C08812 implements Runnable {
            C08812() {
            }
        ...
        class C08823 implements Runnable {
            C08823() {
            }
        ...
        public void run() {
            try {
                if (CameraController.this.cameraInfos == null) {
                    ...
                    Comparator<Size> comparator = new C08801();
                ...
                AndroidUtilities.runOnUIThread(new C08812());
            } catch (Exception e) {
                AndroidUtilities.runOnUIThread(new C08823());
            }
        }
    }
    ...
    public void initCamera(Runnable onInitRunnable) {
        ...
        if (!this.loadingCameras && !this.cameraInitied) {
            ...
            this.threadPool.execute(new C08841());
        }
    }
