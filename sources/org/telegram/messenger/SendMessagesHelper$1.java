...
class SendMessagesHelper$1 implements LocationProviderDelegate {
    ...
    public void onUnableLocationAcquire() {
        ...
        NotificationCenter.getInstance(SendMessagesHelper.access$200(this.this$0)).postNotificationName(NotificationCenter.wasUnableToFindCurrentLocation, waitingForLocationCopy);
        SendMessagesHelper.access$100(this.this$0).clear();
    }
}
