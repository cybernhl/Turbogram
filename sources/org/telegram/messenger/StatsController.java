...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C08741();
    ...
    private Runnable saveRunnable = new C08752();
    ...
    static class C08741 extends ThreadLocal<Long> {
        C08741() {
        }
    ...
    private StatsController(int account) {
        ...
        if (needConvert) {
            ...
            if (account == 0) {
                sharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences(LoggingConstants.LOG_FILE_PREFIX, 0);
            } else {
                sharedPreferences = ApplicationLoader.applicationContext.getSharedPreferences(LoggingConstants.LOG_FILE_PREFIX + account, 0);
            }
            save = false;
            for (a = 0; a < 3; a++) {
