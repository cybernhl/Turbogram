...
public class ContactsController {
    ...
    class C07093 implements RequestDelegate {
        C07093() {
        }
    ...
    class C07104 implements Runnable {
        C07104() {
        }
        ...
        public void run() {
            if (ContactsController.this.checkContactsInternal()) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1221d("detected contacts change");
                }
    ...
    class C07115 implements Runnable {
        C07115() {
        }

        public void run() {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1221d("force import contacts");
            }
    ...
    class C07158 implements RequestDelegate {
        C07158() {
        }
    ...
    class C07169 implements Runnable {
        C07169() {
        }
    ...
    private class MyContentObserver extends ContentObserver {
        private Runnable checkRunnable = new C07171();
...
*/
    ...
    L_0x0064:
        r9 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r9);	 Catch:{ Exception -> 0x0064, all -> 0x00a5 }
        if (r8 == 0) goto L_0x000c;
    L_0x006a:
        r8.close();
        goto L_0x000c;
    ...
    public ContactsController(int instance) {
        ...
        if (instance == 0) {
            Utilities.globalQueue.postRunnable(new C06971());
        }
    }
    ...
    public void cleanup() {
        ...
        this.onlineUsersSectionsDict.clear();
        this.onlineUsersMutualSectionsDict.clear();
        this.onlineSortedUsersSectionsArray.clear();
        this.onlineSortedUsersMutualSectionsArray.clear();
        ...
        Utilities.globalQueue.postRunnable(new C07062());
    ...
    public void checkInviteText() {
        ...
        if (!this.updatingInviteLink) {
            if (this.inviteLink == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) time)) >= 86400) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_help_getInviteText(), new C07093(), 2);
            }
        }
    }

    public String getInviteText(int contacts) {
        String turboInviteText;
        String str = "free";
        int i = -1;
        switch (str.hashCode()) {
            case 110760:
        ...
        switch (i) {
            case 0:
                turboInviteText = LocaleController.getString("MyketInviteText", R.string.MyketInviteText);
                break;
            default:
                turboInviteText = LocaleController.getString("FreeInviteText", R.string.FreeInviteText);
                break;
        }
        String link = this.inviteLink == null ? turboInviteText : this.inviteLink;
        if (contacts <= 1) {
    ...
    public void checkContacts() {
        Utilities.globalQueue.postRunnable(new C07104());
    }

    public void forceImportContacts() {
        Utilities.globalQueue.postRunnable(new C07115());
    }
    ...
    public void syncPhoneBookByAlert(HashMap<String, Contact> contacts, boolean first, boolean schedule, boolean cancel) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            public void run() {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1221d("sync contacts by alert");
                }
    ...
    public void deleteAllContacts(final Runnable runnable) {
        ...
        for (int a = 0; a < size; a++) {
            req.id.add(MessagesController.getInstance(this.currentAccount).getInputUser(((TLRPC$TL_contact) this.contacts.get(a)).user_id));
        }
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
            ...
            class C07131 implements Runnable {
                ...
                public void run() {
                    ...
                    try {
                        ContactsController.this.systemAccount = new Account("" + UserConfig.getInstance(ContactsController.this.currentAccount).getClientUserId(), "org.telegram.messenger");
                        am.addAccountExplicitly(ContactsController.this.systemAccount, "", null);
                    } catch (Exception e) {
                    }
    ...
    public void resetImportedContacts() {
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_contacts_resetSaved(), new C07158());
    }
    ...
    private boolean checkContactsInternal() {
        ...
        try {
            ...
            if (hasContactsPermission()) {
                ...
                Cursor pCur = null;
                try {
                    pCur = cr.query(RawContacts.CONTENT_URI, new String[]{ProviderConstants.API_COLNAME_FEATURE_VERSION}, null, null, null);
                    if (pCur != null) {
                        StringBuilder currentVersion = new StringBuilder();
                        while (pCur.moveToNext()) {
                            currentVersion.append(pCur.getString(pCur.getColumnIndex(ProviderConstants.API_COLNAME_FEATURE_VERSION)));
                        }
    ...
    public void readContacts() {
        synchronized (this.loadContactsSync) {
            ...
            Utilities.stageQueue.postRunnable(new C07169());
        }
    }
    ...
    L_0x0010:
        ...
        org.telegram.messenger.FileLog.m1221d(r3);
    L_0x0016:
    ...
    L_0x0117:
        r15 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r15);	 Catch:{ all -> 0x01ea }
    ...
    L_0x01fa:
        r4 = "PhoneMobile";
        r5 = 2131494658; // 0x7f0c0702 float:1.861283E38 double:1.053098285E-314;
    ...
    L_0x020a:
        r3 = r9.phoneTypes;	 Catch:{ Throwable -> 0x0117 }
        r4 = "PhoneHome";
        r5 = 2131494656; // 0x7f0c0700 float:1.8612827E38 double:1.053098284E-314;
    ...
    L_0x0234:
        r3 = r9.phoneTypes;	 Catch:{ Throwable -> 0x0117 }
        r4 = "PhoneWork";
        r5 = 2131494664; // 0x7f0c0708 float:1.8612843E38 double:1.053098288E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r5);	 Catch:{ Throwable -> 0x0117 }
        r3.add(r4);	 Catch:{ Throwable -> 0x0117 }
        goto L_0x01b1;
    L_0x0245:
    ...
    L_0x024b:
        r3 = r9.phoneTypes;	 Catch:{ Throwable -> 0x0117 }
        r4 = "PhoneMain";
        r5 = 2131494657; // 0x7f0c0701 float:1.8612829E38 double:1.0530982843E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r5);	 Catch:{ Throwable -> 0x0117 }
        r3.add(r4);	 Catch:{ Throwable -> 0x0117 }
        goto L_0x01b1;
    L_0x025c:
        r3 = r9.phoneTypes;	 Catch:{ Throwable -> 0x0117 }
        r4 = "PhoneOther";
        r5 = 2131494663; // 0x7f0c0707 float:1.861284E38 double:1.0530982873E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r5);	 Catch:{ Throwable -> 0x0117 }
        r3.add(r4);	 Catch:{ Throwable -> 0x0117 }
        goto L_0x01b1;
    L_0x026d:
    ...
    L_0x03d9:
        r15 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r15);
        goto L_0x0125;
    L_0x03df:
        r15 = move-exception;
        org.telegram.messenger.FileLog.m1224e(r15);
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            public void run() {
                if (!ContactsController.this.migratingContacts) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("migrated contacts " + migratedMap.size() + " of " + contactHashMap.size());
                    }
        ...
        if (first || this.contactsBookLoaded) {
            ...
            Utilities.globalQueue.postRunnable(new Runnable() {
                        ...
                        if (!(hashMap == null || hashMap.isEmpty())) {
                            try {
                                ...
                                for (a = 0; a < ContactsController.this.contacts.size(); a++) {
                                    user = MessagesController.getInstance(ContactsController.this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) ContactsController.this.contacts.get(a)).user_id));
                ...
                public void run() {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("start read contacts from phone");
                    }
                    if (!z) {
                    ...
                    if (!hashMap.isEmpty()) {
                        for (Entry<String, Contact> pair : contactsMap.entrySet()) {
                            ...
                            if (existing == null || nameChanged) {
                                ...
                                for (a = 0; a < value.phones.size(); a++) {
                                    ...
                                    if (z2) {
                                        contact2 = (TLRPC$TL_contact) ContactsController.this.contactsByPhone.get(sphone);
                                        if (contact2 != null) {
                        ...
                        if (!z3 && hashMap.isEmpty() && toImport.isEmpty() && alreadyImportedContacts == contactsMap.size()) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1221d("contacts not changed!");
                                return;
                            }
                            return;
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("done processing contacts");
                    }
                    if (!z2) {
                        Utilities.stageQueue.postRunnable(new Runnable() {
                            ...
                            public void run() {
                                ...
                                AndroidUtilities.runOnUIThread(new C06821());
                            }
                        });
                        ...
                        Utilities.stageQueue.postRunnable(new Runnable() {
                            ...
                            public void run() {
                                ...
                                AndroidUtilities.runOnUIThread(new C06801());
                            }
                        });
                    } else {
                        int checkType;
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1222e("start import contacts");
                        }
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1221d("new phone book contacts " + newPhonebookContacts + " serverContactsInPhonebook " + serverContactsInPhonebook + " totalContacts " + ContactsController.this.contactsByPhone.size());
                        }
                        if (checkType != 0) {
                            final int i = checkType;
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    NotificationCenter.getInstance(ContactsController.this.currentAccount).postNotificationName(NotificationCenter.hasNewContactsToImport, new Object[]{Integer.valueOf(i), hashMap, Boolean.valueOf(z3), Boolean.valueOf(z)});
                                }
                            });
                        } else if (z6) {
                            Utilities.stageQueue.postRunnable(new Runnable() {
                            ...
                            for (a = 0; a < count; a++) {
                                final TLObject req = new TLRPC$TL_contacts_importContacts();
                                int start = a * 500;
                                ...
                                ConnectionsManager.getInstance(ContactsController.this.currentAccount).sendRequest(req, new RequestDelegate() {
                                    ...
                                    class C06781 implements Runnable {
                                        ...
                                        public void run() {
                                            ...
                                            AndroidUtilities.runOnUIThread(new C06761());
                                            if (hasErrors[0]) {
                                                Utilities.globalQueue.postRunnable(new C06772(), 1800000);
                                            }
                                        }
                                    }
                                    ...
                                    public void run(TLObject response, TLRPC$TL_error error) {
                                        ...
                                        if (error == null) {
                                            if (BuildVars.LOGS_ENABLED) {
                                                FileLog.m1221d("contacts imported");
                                            }
                                            ...
                                            if (!res.retry_contacts.isEmpty()) {
                                                ...
                                                hasErrors[0] = true;
                                                if (BuildVars.LOGS_ENABLED) {
                                                    FileLog.m1221d("result has retry contacts");
                                                }
                                            }
                                            ...
                                            for (a = 0; a < req.contacts.size(); a++) {
                                                contactsMapToSave.remove(contactIdToKey.get((int) ((TLRPC$TL_inputPhoneContact) req.contacts.get(a)).client_id));
                                            }
                                            hasErrors[0] = true;
                                            if (BuildVars.LOGS_ENABLED) {
                                                FileLog.m1221d("import contacts error " + error.text);
                                            }
                                        }
                                        if (ContactsController.this.completedRequestsCount == count) {
                                            ...
                                            Utilities.stageQueue.postRunnable(new C06781());
                                        }
                                    }
                                }, 6);
                            }
    ...
    private int getContactsHash(ArrayList<TLRPC$TL_contact> contacts) {
        ...
        Collections.sort(contacts2, new Comparator<TLRPC$TL_contact>() {
    ...
    public void loadContacts(boolean fromCache, final int hash) {
        ...
        if (fromCache) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1221d("load contacts from cache");
            }
            MessagesStorage.getInstance(this.currentAccount).getContacts();
            return;
        }
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1221d("load contacts from server");
        }
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
            ...
            public void run(TLObject response, TLRPC$TL_error error) {
                if (error == null) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("load contacts don't change");
                    }
                }
            }
        });
    ...
    public void processLoadedContacts(final ArrayList<TLRPC$TL_contact> contactsArr, final ArrayList<User> usersArr, final int from) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                int a;
                boolean z = true;
                ...
                if (!ContactsController.this.contacts.isEmpty()) {
                    ...
                    while (a < contactsArr.size()) {
                        if (ContactsController.this.contactsDict.get(Integer.valueOf(((TLRPC$TL_contact) contactsArr.get(a)).user_id)) != null) {
                ...
                for (a = 0; a < contactsArr.size(); a++) {
                    User user = MessagesController.getInstance(ContactsController.this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) contactsArr.get(a)).user_id));
                    if (user != null) {
                ...
                Utilities.stageQueue.postRunnable(new Runnable() {
                    ...
                    class C06851 implements Comparator<TLRPC$TL_contact> {
                        C06851() {
                        }
                    ...
                    class C06862 implements Comparator<String> {
                        C06862() {
                        }
                    ...
                    class C06873 implements Comparator<String> {
                        C06873() {
                        }
                    ...
                    /* renamed from: org.telegram.messenger.ContactsController$14$1$4 */
                    class C06884 implements Comparator<String> {
                        C06884() {
                        }
                    ...
                    /* renamed from: org.telegram.messenger.ContactsController$14$1$5 */
                    class C06895 implements Comparator<String> {
                        C06895() {
                        }
                    ...
                    public void run() {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1221d("done loading contacts");
                        }
                        ...
                        while (a < contactsArr.size()) {
                            ...
                            if (usersDict.get(contact.user_id) != null || contact.user_id == UserConfig.getInstance(ContactsController.this.currentAccount).getClientUserId()) {
                                ...
                                ContactsController.this.loadContacts(false, 0);
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1221d("contacts are broken, load from server");
                                    return;
                                }
                                return;
                            }
                        ...
                        Collections.sort(contactsArr, new C06851());
                        ...
                        for (a = 0; a < contactsArr.size(); a++) {
                            ...
                            if (user != null && (TurboConfig.hiddenChatsUnlocked || !TurboConfig.containValue("hide_" + user.id))) {
                                ...
                                if (user.id == UserConfig.getInstance(ContactsController.this.currentAccount).getClientUserId() || ((user.status != null && user.status.expires > ConnectionsManager.getInstance(ContactsController.this.currentAccount).getCurrentTime()) || MessagesController.getInstance(ContactsController.this.currentAccount).onlinePrivacy.containsKey(Integer.valueOf(user.id)))) {
                                    arr = (ArrayList) onlineSectionsDict.get(key);
                                    if (arr == null) {
                                        arr = new ArrayList();
                                    ...
                                    if (user.mutual_contact) {
                                        arr = (ArrayList) onlineSectionsDictMutual.get(key);
                                        if (arr == null) {
                                            arr = new ArrayList();
                        ...
                        Collections.sort(onlineSortedSectionsArray, new C06862());
                        Collections.sort(onlineSortedSectionsArrayMutual, new C06873());
                        Collections.sort(sortedSectionsArray, new C06884());
                        Collections.sort(sortedSectionsArrayMutual, new C06895());
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            public void run() {
                                ...
                                ContactsController.this.onlineUsersSectionsDict = onlineSectionsDict;
                                ContactsController.this.onlineUsersMutualSectionsDict = onlineSectionsDictMutual;
                                ContactsController.this.onlineSortedUsersSectionsArray = onlineSortedSectionsArray;
                                ContactsController.this.onlineSortedUsersMutualSectionsArray = onlineSortedSectionsArrayMutual;
                                if (from != 2) {
                                    synchronized (ContactsController.this.loadContactsSync) {
                                        ContactsController.this.loadingContacts = false;
                                    }
                        ...
                        if (contactsByPhonesDictFinal != null) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                ...
                                /* renamed from: org.telegram.messenger.ContactsController$14$1$7$1 */
                                ...
                                public void run() {
                                    Utilities.globalQueue.postRunnable(new C06911());
    ...
    private void reloadContactsStatusesMaybe() {
        try {
            if (MessagesController.getMainSettings(this.currentAccount).getLong("lastReloadStatusTime", 0) < System.currentTimeMillis() - PersianCalendarConstants.MILLIS_OF_A_DAY) {
                reloadContactsStatuses();
            }
        } catch (Throwable e) {
            FileLog.m1224e(e);
    ...
    private void mergePhonebookAndTelegramContacts(HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal, ArrayList<String> phoneBookSectionsArrayFinal, HashMap<String, Contact> phoneBookByShortPhonesFinal) {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() {
            ...
            class C06941 implements Comparator<Object> {
                C06941() {
                }
            ...
            class C06952 implements Comparator<String> {
                C06952() {
                }
            ...
            class C06963 implements Runnable {
                C06963() {
                }
            ...
            public void run() {
                ...
                for (int a = 0; a < size; a++) {
                    User user = MessagesController.getInstance(ContactsController.this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) contactsCopy.get(a)).user_id));
                    if (!(user == null || TextUtils.isEmpty(user.phone))) {
                ...
                for (ArrayList<Object> arrayList2 : hashMap2.values()) {
                    Collections.sort(arrayList2, new C06941());
                }
                Collections.sort(arrayList, new C06952());
                AndroidUtilities.runOnUIThread(new C06963());
            }
        });
    }
    ...
    private void applyContactsUpdates(ArrayList<Integer> ids, ConcurrentHashMap<Integer, User> userDict, ArrayList<TLRPC$TL_contact> newC, ArrayList<Integer> contactsTD) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1221d("process update - contacts add = " + newC.size() + " delete = " + contactsTD.size());
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                ...
                for (a = 0; a < contactsToDelete.size(); a++) {
                    ...
                    contact = (TLRPC$TL_contact) ContactsController.this.contactsDict.get(uid);
                    if (contact != null) {
    ...
    public void processContactsUpdates(ArrayList<Integer> ids, ConcurrentHashMap<Integer, User> userDict) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1221d("delay update - contacts add = " + newContacts.size() + " delete = " + contactsToDelete.size());
        }
    }
    ...
    public long addContactToPhoneBook(User user, boolean check) {
        ...
        if (!(this.systemAccount == null || user == null || TextUtils.isEmpty(user.phone) || !hasContactsPermission())) {
            ...
            if (check) {
                try {
                    contentResolver.delete(RawContacts.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").appendQueryParameter(Constants.KEY_ACCOUNT_NAME, this.systemAccount.name).appendQueryParameter("account_type", this.systemAccount.type).build(), "sync2 = " + user.id, null);
                } catch (Throwable e) {
                    FileLog.m1224e(e);
                }
            }
            ...
            builder.withValue(Constants.KEY_ACCOUNT_NAME, this.systemAccount.name);
    ...
    private void deleteContactFromPhoneBook(int uid) {
        if (hasContactsPermission()) {
            ...
            try {
                ApplicationLoader.applicationContext.getContentResolver().delete(RawContacts.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").appendQueryParameter(Constants.KEY_ACCOUNT_NAME, this.systemAccount.name).appendQueryParameter("account_type", this.systemAccount.type).build(), "sync2 = " + uid, null);
            } catch (Throwable e) {
                FileLog.m1224e(e);
            }
            synchronized (this.observerLock) {
                    ...
                    if (error == null) {
                        ...
                        for (int a = 0; a < res.users.size(); a++) {
                            ...
                            if (!TextUtils.isEmpty(u.phone)) {
                                ...
                                MessagesStorage.getInstance(ContactsController.this.currentAccount).applyPhoneBookUpdates(u.phone, "");
    ...
    public void deleteContact(final ArrayList<User> users) {
        if (users != null && !users.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                TLRPC$InputUser inputUser = MessagesController.getInstance(this.currentAccount).getInputUser(user);
                if (inputUser != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                ...
                class C07012 implements Runnable {
                    ...
                    public void run() {
                        ...
                        while (it.hasNext()) {
                            User user = (User) it.next();
                            TLRPC$TL_contact contact = (TLRPC$TL_contact) ContactsController.this.contactsDict.get(Integer.valueOf(user.id));
                            if (contact != null) {
                                remove = true;
                                ContactsController.this.contacts.remove(contact);
                ...
                public void run(TLObject response, TLRPC$TL_error error) {
                    if (error == null) {
                        ...
                        Utilities.phoneBookQueue.postRunnable(new C07001());
                        for (int a = 0; a < users.size(); a++) {
                            User user = (User) users.get(a);
                            if (!TextUtils.isEmpty(user.phone)) {
                                CharSequence name = UserObject.getUserName(user);
                                MessagesStorage.getInstance(ContactsController.this.currentAccount).applyPhoneBookUpdates(user.phone, "");
                        ...
                        AndroidUtilities.runOnUIThread(new C07012());
                    }
                }
            });
        }
    ...
    public void reloadContactsStatuses() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_contacts_getStatuses(), new RequestDelegate() {
    ...
    public void loadPrivacySettings() {
        if (this.loadingDeleteInfo == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getAccountTTL(), new RequestDelegate() {
