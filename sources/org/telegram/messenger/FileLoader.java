...
public class FileLoader {
    ...
    public void uploadFile(String location, boolean encrypted, boolean small, int estimatedSize, int type) {
        if (location != null) {
            ...
            fileLoaderQueue.postRunnable(new Runnable() {
                ...
                class C07871 implements FileUploadOperationDelegate {

                    /* renamed from: org.telegram.messenger.FileLoader$4$1$2 */
                    class C07862 implements Runnable {
                        C07862() {
                        }
                    ...
                    public void didFailedUploadingFile(FileUploadOperation operation) {
                        FileLoader.fileLoaderQueue.postRunnable(new C07862());
                    }
                ...
                public void run() {
                    ...
                    operation.setDelegate(new C07871());
                    if (z2) {
                        if (FileLoader.this.currentUploadSmallOperationsCount < 1) {
                            FileLoader.this.currentUploadSmallOperationsCount = FileLoader.this.currentUploadSmallOperationsCount + 1;
                            operation.start();
    ...
    private void cancelLoadFile(TLRPC$Document document, SecureDocument secureDocument, WebFile webDocument, TLRPC$FileLocation location, String locationExt) {
        if (location != null || document != null || webDocument != null || secureDocument != null) {
            ...
            if (fileName != null) {
                ...
                final SecureDocument secureDocument2 = secureDocument;
                ...
                fileLoaderQueue.postRunnable(new Runnable() {
                    public void run() {
                        ...
                        if (operation != null) {
                            ...
                            } else if (secureDocument2 == null && tLRPC$FileLocation == null && !MessageObject.isImageWebDocument(webFile)) {
    ...
    private FileLoadOperation loadFileInternal(TLRPC$Document document, SecureDocument secureDocument, WebFile webDocument, TLRPC$FileLocation location, String locationExt, int locationSize, boolean force, FileStreamLoadOperation stream, int streamOffset, int cacheType) {
        ...
        if (operation == null) {
            ...
            operation.setDelegate(new FileLoadOperationDelegate() {
                public void didFinishLoadingFile(FileLoadOperation operation, File finalFile) {
                    ...
                    FileLoader.this.checkDownloadQueue(operation.getDatacenterId(), tLRPC$Document, webFile, tLRPC$FileLocation, finalFileName);
                }
    ...
    private void loadFile(TLRPC$Document document, SecureDocument secureDocument, WebFile webDocument, TLRPC$FileLocation location, String locationExt, int locationSize, boolean force, int cacheType) {
        String fileName;
        if (location != null) {
            fileName = getAttachFileName(location, locationExt);
        } else if (document != null) {
        ...
        fileLoaderQueue.postRunnable(new Runnable() {
            public void run() {
                FileLoader.this.loadFileInternal(tLRPC$Document, secureDocument2, webFile, tLRPC$FileLocation, str, i, z, null, 0, i2);
            }
        });
    }

    protected FileLoadOperation loadStreamFile(FileStreamLoadOperation stream, TLRPC$Document document, int offset) {
        ...
        fileLoaderQueue.postRunnable(new Runnable() {
            public void run() {
                result[0] = FileLoader.this.loadFileInternal(tLRPC$Document, null, null, null, null, 0, true, fileStreamLoadOperation, i, 0);
                semaphore.countDown();
            }
        });
        try {
    ...
    private void checkDownloadQueue(int datacenterId, TLRPC$Document document, WebFile webDocument, TLRPC$FileLocation location, String arg1) {
    ...
    public static TLRPC$PhotoSize getClosestPhotoSizeWithSize(ArrayList<TLRPC$PhotoSize> sizes, int side, boolean byMinSide) {
        ...
        for (int a = 0; a < sizes.size(); a++) {
            ...
            if (obj != null) {
                int currentSide;
                if (byMinSide) {
                    currentSide = obj.f793h >= obj.f794w ? obj.f794w : obj.f793h;
                    ...
                    currentSide = obj.f794w >= obj.f793h ? obj.f794w : obj.f793h;
        ...
        if (document != null) {
            if (document.file_name != null) {
                ...
                for (int a = 0; a < document.attributes.size(); a++) {
                    TLRPC$DocumentAttribute documentAttribute = (TLRPC$DocumentAttribute) document.attributes.get(a);
    ...
    public static String getAttachFileName(TLObject attach, String ext) {
        ...
        if (attach instanceof TLRPC$Document) {
            ...
            if (document.version == 0) {
                if (TurboConfig$Storage.keepFilename && !docExt.contains("webp") && !docExt.contains(".mp4") && !docExt.contains(".gif") && !docExt.contains(".ogg")) {
            ...
            location = (TLRPC$FileLocation) attach;
    ...
    public static String getDocName(TLRPC$Document document) {
        ...
        instance.setTimeInMillis((long) (document.date * 1000));
        String format = simpleDateFormat.format(instance.getTime());
        String string = fileName;
        if (pos > 0) {
            return fileName.substring(0, pos) + "_" + format + ext;
        }
        return string;
    }
}
