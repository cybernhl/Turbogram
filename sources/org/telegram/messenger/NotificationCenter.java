...
public class NotificationCenter {
    ...
    public static final int turboNightMode;
    public static final int turboRecievedJoinPush;
    public static final int turboShowToast;
    public static final int turboUnlockChat;
    public static final int turboUpdateInterface;
    ...
    static {
        ...
        i = totalEvents;
        totalEvents = i + 1;
        turboUpdateInterface = i;
        i = totalEvents;
        totalEvents = i + 1;
        turboRecievedJoinPush = i;
        i = totalEvents;
        totalEvents = i + 1;
        turboShowToast = i;
        i = totalEvents;
        ...
        if (BuildVars.DEBUG_VERSION && Thread.currentThread() != ApplicationLoader.applicationHandler.getLooper().getThread()) {
            ...
            if (!(objects == null || objects.isEmpty())) {
                for (a = 0; a < objects.size(); a++) {
                    ((NotificationCenter$NotificationCenterDelegate) objects.get(a)).didReceivedNotification(id, this.currentAccount, args);
                }
            }
            this.broadcasting--;
