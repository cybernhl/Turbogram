...
class MediaController$22 implements Runnable {
    ...
    class C08442 implements Runnable {
        ...
        public void run() {
            try {
                MediaController$22.this.val$finalProgress.dismiss();
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    MediaController$22(int i, String str, File file, boolean[] zArr, AlertDialog alertDialog, String str2) {
        this.val$type = i;
        this.val$name = str;
    ...
    public void run() {
        try {
            ...
            try {
                ...
                for (a = 0; a < size && !this.val$cancelled[0]; a += 4096) {
                    ...
                    if (this.val$finalProgress != null && lastProgress <= System.currentTimeMillis() - 500) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            public void run() {
                                try {
                                    MediaController$22.this.val$finalProgress.setProgress(i);
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
                            }
        ...
        if (this.val$finalProgress != null) {
            AndroidUtilities.runOnUIThread(new C08442());
        }
    }
}
