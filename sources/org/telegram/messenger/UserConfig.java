...
public class UserConfig {
    ...
    public void saveConfig(boolean withFile, File oldFile) {
        synchronized (this.sync) {
            ...
            if (this.currentAccount == 0) {
                editor.putInt(AccountPicker.EXTRA_SELECTED_ACCOUNT, selectedAccount);
            }
            ...
            editor.putBoolean("isRobot", isRobot);
    ...
    public void loadConfig() {
        synchronized (this.sync) {
            ...
            isRobot = preferences.getBoolean("isRobot", false);
            try {
                ...
                try {
                    ...
                    if (update != null) {
                        ...
                        if (arr != null) {
                            ...
                            this.pendingAppUpdate = (TLRPC$TL_help_appUpdate) TLRPC$help_AppUpdate.TLdeserialize(data, data.readInt32(false), false);
                            data.cleanup();
                        }
                    }
                    if (this.pendingAppUpdate != null) {
                        ...
                        if (this.pendingAppUpdateBuildVersion != BuildVars.BUILD_VERSION || this.pendingAppUpdateInstallTime < updateTime) {
                            ...
                            AndroidUtilities.runOnUIThread(new UserConfig$1(this));
                        }
                    }
                } catch (Throwable e22) {
                    FileLog.m1224e(e22);
            ...
            if (string != null) {
                ...
                if (bytes != null) {
                    ...
                    this.tmpPassword = TLRPC$TL_account_tmpPassword.TLdeserialize(data, data.readInt32(false), false);
                    data.cleanup();
                }
            }
