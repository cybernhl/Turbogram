...
public class FastDatePrinter implements Serializable, DatePrinter {
    ...
    public String format(long millis) {
        ...
        if (TurboConfig.persianDate) {
            return new SolarCalendar(c).getTime();
        }
    ...
    public String turboFormat(long millis) {
        ...
        c.setTimeInMillis(millis);
        if (TurboConfig.persianDate) {
            return new SolarCalendar(c).getDesMonthYear();
        }
        return applyRulesToString(c);
    }
    ...
    public String format(Date date) {
        ...
        if (year == dateYear) {
            return new SolarCalendar(c).getShortDesDate();
        }
        return new SolarCalendar(c).getNumDate();
    }
