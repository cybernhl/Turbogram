...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    private static final FormatCache<FastDateFormat> cache = new C09291();
    private static final long serialVersionUID = 2;
    private final FastDateParser parser;
    private final FastDatePrinter printer;

    /* renamed from: org.telegram.messenger.time.FastDateFormat$1 */
    static class C09291 extends FormatCache<FastDateFormat> {
        C09291() {
        }
    ...
    public String turboFormat(long millis) {
        return this.printer.turboFormat(millis);
    }
