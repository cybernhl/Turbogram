...
public class Bitmaps {
    private static final ThreadLocal<byte[]> jpegData = new C06691();
    private static volatile Matrix sScaleMatrix;

    /* renamed from: org.telegram.messenger.Bitmaps$1 */
    static class C06691 extends ThreadLocal<byte[]> {
        C06691() {
        }
    ...
    public static Bitmap createBitmap(Bitmap source, int x, int y, int width, int height, Matrix m, boolean filter) {
        ...
        if (x + width > source.getWidth()) {
            ...
            if (config != null) {
                switch (C06702.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
                    case 1:
