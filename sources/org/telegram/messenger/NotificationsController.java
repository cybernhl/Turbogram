...
import turbogram.Utilities.AnsweringMachine;
...
public class NotificationsController {
    ...
    final /* synthetic */ void m1228xbc86816e(SparseArray deletedMessages, ArrayList popupArrayRemove) {
    ...
    final /* synthetic */ void m1227x6900fe42(SparseIntArray deletedMessages, ArrayList popupArrayRemove) {
        int old_unread_count = this.total_unread_count;
        SharedPreferences preferences = MessagesController.getNotificationsSettings(this.currentAccount);
        for (int a = 0; a < deletedMessages.size(); a++) {
            int key = deletedMessages.keyAt(a);
    ...
    public void processNewMessages(ArrayList<MessageObject> messageObjects, boolean isLast, boolean isFcm) {
        if (!messageObjects.isEmpty()) {
            ...
            ArrayList<MessageObject> turboMessages = new ArrayList();
            notificationsQueue.postRunnable(new NotificationsController$$Lambda$8(this, messageObjects, turboMessages, isFcm, popupArrayAdd, isLast));
            if (TurboConfig.answeringMachine) {
                AnsweringMachine.ProcessMsgs(turboMessages);
            }
        }
    }

    final /* synthetic */ void lambda$processNewMessages$16$NotificationsController(ArrayList messageObjects, ArrayList turboMessages, boolean isFcm, ArrayList popupArrayAdd, boolean isLast) {
        long dialog_id;
        boolean added = false;
        ...
        for (int a = 0; a < messageObjects.size(); a++) {
            turboMessages.add(messageObjects.get(a));
    ...
    public void processLoadedUnreadMessages(LongSparseArray<Integer> dialogs, ArrayList<TLRPC$Message> messages, ArrayList<User> users, ArrayList<TLRPC$Chat> chats, ArrayList<TLRPC$EncryptedChat> encryptedChats) {
    ...
    private String getShortStringForMessage(MessageObject messageObject, String[] userName) {
        ...
        if (messageObject.isFcmMessage()) {
            if (chat_id == 0 && from_id != 0) {
                if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("EnablePreviewAll", true)) {
                    return LocaleController.formatString("NotificationMessageNoText", R.string.NotificationMessageNoText, new Object[]{messageObject.localName});
                ...
                if (MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("EnablePreviewGroup", true)) {
                    ...
                    return LocaleController.formatString("NotificationMessageGroupNoText", R.string.NotificationMessageGroupNoText, new Object[]{messageObject.localUserName, messageObject.localName});
                } else {
                    return LocaleController.formatString("ChannelMessageNoText", R.string.ChannelMessageNoText, new Object[]{messageObject.localName});
                }
            }
        ...
        if (TurboUtils.isHiddenDialog((int) dialog_id)) {
            ...
            if (messageObject.messageOwner instanceof TLRPC$TL_messageService) {
                ...
                if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionUserJoined) {
                    ...
                    return LocaleController.formatString("NotificationUnrecognizedDevice", R.string.NotificationUnrecognizedDevice, new Object[]{UserConfig.getInstance(this.currentAccount).getCurrentUser().first_name, date, messageObject.messageOwner.action.title, messageObject.messageOwner.action.address});
                    ...
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionPhoneCall) {
                        ...
                        if (messageObject.messageOwner.action.user_id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                            ...
                            return LocaleController.formatString("NotificationGroupKickMember", R.string.NotificationGroupKickMember, new Object[]{name, chat.title, UserObject.getUserName(MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(messageObject.messageOwner.action.user_id)))});
                        }
    ...
    private String getStringForMessage(MessageObject messageObject, boolean shortMessage, boolean[] text) {
        ...
        if (!TurboUtils.isHiddenDialog((int) dialog_id)) {
            ...
            if (((int) dialog_id) == 0) {
                ...
                if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("EnablePreviewAll", true)) {
                    msg = LocaleController.formatString("NotificationMessageNoText", R.string.NotificationMessageNoText, new Object[]{name});
                } else if (messageObject.messageOwner instanceof TLRPC$TL_messageService) {
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionUserJoined) {
                        msg = LocaleController.formatString("NotificationContactJoined", R.string.NotificationContactJoined, new Object[]{name});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionUserUpdatedPhoto) {
                        msg = LocaleController.formatString("NotificationContactNewPhoto", R.string.NotificationContactNewPhoto, new Object[]{name});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionLoginUnknownLocation) {
                        String date = LocaleController.formatString("formatDateAtTime", R.string.formatDateAtTime, new Object[]{LocaleController.getInstance().formatterYear.format(((long) messageObject.messageOwner.date) * 1000), LocaleController.getInstance().formatterDay.format(((long) messageObject.messageOwner.date) * 1000)});
                        msg = LocaleController.formatString("NotificationUnrecognizedDevice", R.string.NotificationUnrecognizedDevice, new Object[]{UserConfig.getInstance(this.currentAccount).getCurrentUser().first_name, date, messageObject.messageOwner.action.title, messageObject.messageOwner.action.address});
                    } else if ((messageObject.messageOwner.action instanceof TLRPC$TL_messageActionGameScore) || (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionPaymentSent)) {
                    ...
                    if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = messageObject.messageOwner.media.ttl_seconds != 0 ? LocaleController.formatString("NotificationMessageSDPhoto", R.string.NotificationMessageSDPhoto, new Object[]{name}) : LocaleController.formatString("NotificationMessagePhoto", R.string.NotificationMessagePhoto, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "🖼 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
                    ...
                    if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = messageObject.messageOwner.media.ttl_seconds != 0 ? LocaleController.formatString("NotificationMessageSDVideo", R.string.NotificationMessageSDVideo, new Object[]{name}) : LocaleController.formatString("NotificationMessageVideo", R.string.NotificationMessageVideo, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "📹 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
                } else if (messageObject.isGame()) {
                    msg = LocaleController.formatString("NotificationMessageGame", R.string.NotificationMessageGame, new Object[]{name, messageObject.messageOwner.media.game.title});
                } else if (messageObject.isVoice()) {
                    msg = LocaleController.formatString("NotificationMessageAudio", R.string.NotificationMessageAudio, new Object[]{name});
                } else if (messageObject.isRoundVideo()) {
                    msg = LocaleController.formatString("NotificationMessageRound", R.string.NotificationMessageRound, new Object[]{name});
                } else if (messageObject.isMusic()) {
                    msg = LocaleController.formatString("NotificationMessageMusic", R.string.NotificationMessageMusic, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaContact) {
                    msg = LocaleController.formatString("NotificationMessageContact", R.string.NotificationMessageContact, new Object[]{name});
                    ...
                    msg = LocaleController.formatString("NotificationMessageMap", R.string.NotificationMessageMap, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                    msg = LocaleController.formatString("NotificationMessageLiveLocation", R.string.NotificationMessageLiveLocation, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaDocument) {
                    if (messageObject.isSticker()) {
                        msg = messageObject.getStickerEmoji() != null ? LocaleController.formatString("NotificationMessageStickerEmoji", R.string.NotificationMessageStickerEmoji, new Object[]{name, messageObject.getStickerEmoji()}) : LocaleController.formatString("NotificationMessageSticker", R.string.NotificationMessageSticker, new Object[]{name});
                    } else if (messageObject.isGif()) {
                        if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                            msg = LocaleController.formatString("NotificationMessageGif", R.string.NotificationMessageGif, new Object[]{name});
                        } else {
                            msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "🎬 " + messageObject.messageOwner.message});
                            text[0] = true;
                        }
                    } else if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = LocaleController.formatString("NotificationMessageDocument", R.string.NotificationMessageDocument, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "📎 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
                ...
                if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("EnablePreviewGroup", true)) {
                    msg = (!ChatObject.isChannel(chat) || chat.megagroup) ? LocaleController.formatString("NotificationMessageGroupNoText", R.string.NotificationMessageGroupNoText, new Object[]{name, chat.title}) : LocaleController.formatString("ChannelMessageNoText", R.string.ChannelMessageNoText, new Object[]{name});
                } else if (messageObject.messageOwner instanceof TLRPC$TL_messageService) {
                    if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatAddUser) {
                        ...
                        if (singleUserId == 0) {
                            ...
                            msg = LocaleController.formatString("NotificationGroupAddMember", R.string.NotificationGroupAddMember, new Object[]{name, chat.title, stringBuilder.toString()});
                        } else if (messageObject.messageOwner.to_id.channel_id != 0 && !chat.megagroup) {
                            msg = LocaleController.formatString("ChannelAddedByNotification", R.string.ChannelAddedByNotification, new Object[]{name, chat.title});
                        } else if (singleUserId == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                            msg = LocaleController.formatString("NotificationInvitedToGroup", R.string.NotificationInvitedToGroup, new Object[]{name, chat.title});
                        } else {
                            User u2 = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(singleUserId));
                            if (u2 == null) {
                                return null;
                            }
                            msg = from_id == u2.id ? chat.megagroup ? LocaleController.formatString("NotificationGroupAddSelfMega", R.string.NotificationGroupAddSelfMega, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationGroupAddSelf", R.string.NotificationGroupAddSelf, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationGroupAddMember", R.string.NotificationGroupAddMember, new Object[]{name, chat.title, UserObject.getUserName(u2)});
                        }
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatJoinedByLink) {
                        msg = LocaleController.formatString("NotificationInvitedToGroupByLink", R.string.NotificationInvitedToGroupByLink, new Object[]{name, chat.title});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatEditTitle) {
                        msg = LocaleController.formatString("NotificationEditedGroupName", R.string.NotificationEditedGroupName, new Object[]{name, messageObject.messageOwner.action.title});
                    } else if ((messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatEditPhoto) || (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatDeletePhoto)) {
                        msg = (messageObject.messageOwner.to_id.channel_id == 0 || chat.megagroup) ? LocaleController.formatString("NotificationEditedGroupPhoto", R.string.NotificationEditedGroupPhoto, new Object[]{name, chat.title}) : LocaleController.formatString("ChannelPhotoEditNotification", R.string.ChannelPhotoEditNotification, new Object[]{chat.title});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatDeleteUser) {
                        if (messageObject.messageOwner.action.user_id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                            msg = LocaleController.formatString("NotificationGroupKickYou", R.string.NotificationGroupKickYou, new Object[]{name, chat.title});
                        } else if (messageObject.messageOwner.action.user_id == from_id) {
                            msg = LocaleController.formatString("NotificationGroupLeftMember", R.string.NotificationGroupLeftMember, new Object[]{name, chat.title});
                        } else {
                            if (MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(messageObject.messageOwner.action.user_id)) == null) {
                                return null;
                            }
                            msg = LocaleController.formatString("NotificationGroupKickMember", R.string.NotificationGroupKickMember, new Object[]{name, chat.title, UserObject.getUserName(MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(messageObject.messageOwner.action.user_id)))});
                        }
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChatCreate) {
                        msg = messageObject.messageText.toString();
                        ...
                        msg = LocaleController.formatString("ActionMigrateFromGroupNotify", R.string.ActionMigrateFromGroupNotify, new Object[]{chat.title});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionChannelMigrateFrom) {
                        msg = LocaleController.formatString("ActionMigrateFromGroupNotify", R.string.ActionMigrateFromGroupNotify, new Object[]{messageObject.messageOwner.action.title});
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionScreenshotTaken) {
                        msg = messageObject.messageText.toString();
                        ...
                        if (chat == null || !chat.megagroup) {
                            if (messageObject.replyMessageObject == null) {
                                msg = LocaleController.formatString("NotificationActionPinnedNoTextChannel", R.string.NotificationActionPinnedNoTextChannel, new Object[]{chat.title});
                            } else {
                                object = messageObject.replyMessageObject;
                                if (object.isMusic()) {
                                    msg = LocaleController.formatString("NotificationActionPinnedMusicChannel", R.string.NotificationActionPinnedMusicChannel, new Object[]{chat.title});
                                } else if (object.isVideo()) {
                                    if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                        msg = LocaleController.formatString("NotificationActionPinnedVideoChannel", R.string.NotificationActionPinnedVideoChannel, new Object[]{chat.title});
                                    } else {
                                        message = "📹 " + object.messageOwner.message;
                                        msg = LocaleController.formatString("NotificationActionPinnedTextChannel", R.string.NotificationActionPinnedTextChannel, new Object[]{chat.title, message});
                                    }
                                } else if (object.isGif()) {
                                    if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                        msg = LocaleController.formatString("NotificationActionPinnedGifChannel", R.string.NotificationActionPinnedGifChannel, new Object[]{chat.title});
                                    } else {
                                        message = "🎬 " + object.messageOwner.message;
                                        msg = LocaleController.formatString("NotificationActionPinnedTextChannel", R.string.NotificationActionPinnedTextChannel, new Object[]{chat.title, message});
                                    }
                                } else if (object.isVoice()) {
                                    msg = LocaleController.formatString("NotificationActionPinnedVoiceChannel", R.string.NotificationActionPinnedVoiceChannel, new Object[]{chat.title});
                                } else if (object.isRoundVideo()) {
                                    msg = LocaleController.formatString("NotificationActionPinnedRoundChannel", R.string.NotificationActionPinnedRoundChannel, new Object[]{chat.title});
                                } else if (object.isSticker()) {
                                    msg = object.getStickerEmoji() != null ? LocaleController.formatString("NotificationActionPinnedStickerEmojiChannel", R.string.NotificationActionPinnedStickerEmojiChannel, new Object[]{chat.title, object.getStickerEmoji()}) : LocaleController.formatString("NotificationActionPinnedStickerChannel", R.string.NotificationActionPinnedStickerChannel, new Object[]{chat.title});
                                } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaDocument) {
                                    if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                        msg = LocaleController.formatString("NotificationActionPinnedFileChannel", R.string.NotificationActionPinnedFileChannel, new Object[]{chat.title});
                                    } else {
                                        message = "📎 " + object.messageOwner.message;
                                        msg = LocaleController.formatString("NotificationActionPinnedTextChannel", R.string.NotificationActionPinnedTextChannel, new Object[]{chat.title, message});
                                    }
                                } else if ((object.messageOwner.media instanceof TLRPC$TL_messageMediaGeo) || (object.messageOwner.media instanceof TLRPC$TL_messageMediaVenue)) {
                                    msg = LocaleController.formatString("NotificationActionPinnedGeoChannel", R.string.NotificationActionPinnedGeoChannel, new Object[]{chat.title});
                                } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                                    msg = LocaleController.formatString("NotificationActionPinnedGeoLiveChannel", R.string.NotificationActionPinnedGeoLiveChannel, new Object[]{chat.title});
                                } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaContact) {
                                    msg = LocaleController.formatString("NotificationActionPinnedContactChannel", R.string.NotificationActionPinnedContactChannel, new Object[]{chat.title});
                                } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaPhoto) {
                                    if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                        msg = LocaleController.formatString("NotificationActionPinnedPhotoChannel", R.string.NotificationActionPinnedPhotoChannel, new Object[]{chat.title});
                                    } else {
                                        message = "🖼 " + object.messageOwner.message;
                                        msg = LocaleController.formatString("NotificationActionPinnedTextChannel", R.string.NotificationActionPinnedTextChannel, new Object[]{chat.title, message});
                                    }
                                } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaGame) {
                                    msg = LocaleController.formatString("NotificationActionPinnedGameChannel", R.string.NotificationActionPinnedGameChannel, new Object[]{chat.title});
                                } else if (object.messageText == null || object.messageText.length() <= 0) {
                                    msg = LocaleController.formatString("NotificationActionPinnedNoTextChannel", R.string.NotificationActionPinnedNoTextChannel, new Object[]{chat.title});
                                } else {
                                    message2 = object.messageText;
                                    ...
                                    msg = LocaleController.formatString("NotificationActionPinnedTextChannel", R.string.NotificationActionPinnedTextChannel, new Object[]{chat.title, message2});
                                }
                            }
                        } else if (messageObject.replyMessageObject == null) {
                            msg = LocaleController.formatString("NotificationActionPinnedNoText", R.string.NotificationActionPinnedNoText, new Object[]{name, chat.title});
                        } else {
                            object = messageObject.replyMessageObject;
                            if (object.isMusic()) {
                                msg = LocaleController.formatString("NotificationActionPinnedMusic", R.string.NotificationActionPinnedMusic, new Object[]{name, chat.title});
                            } else if (object.isVideo()) {
                                if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                    msg = LocaleController.formatString("NotificationActionPinnedVideo", R.string.NotificationActionPinnedVideo, new Object[]{name, chat.title});
                                } else {
                                    message = "📹 " + object.messageOwner.message;
                                    msg = LocaleController.formatString("NotificationActionPinnedText", R.string.NotificationActionPinnedText, new Object[]{name, message, chat.title});
                                }
                            } else if (object.isGif()) {
                                if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                    msg = LocaleController.formatString("NotificationActionPinnedGif", R.string.NotificationActionPinnedGif, new Object[]{name, chat.title});
                                } else {
                                    message = "🎬 " + object.messageOwner.message;
                                    msg = LocaleController.formatString("NotificationActionPinnedText", R.string.NotificationActionPinnedText, new Object[]{name, message, chat.title});
                                }
                            } else if (object.isVoice()) {
                                msg = LocaleController.formatString("NotificationActionPinnedVoice", R.string.NotificationActionPinnedVoice, new Object[]{name, chat.title});
                            } else if (object.isRoundVideo()) {
                                msg = LocaleController.formatString("NotificationActionPinnedRound", R.string.NotificationActionPinnedRound, new Object[]{name, chat.title});
                            } else if (object.isSticker()) {
                                msg = object.getStickerEmoji() != null ? LocaleController.formatString("NotificationActionPinnedStickerEmoji", R.string.NotificationActionPinnedStickerEmoji, new Object[]{name, chat.title, object.getStickerEmoji()}) : LocaleController.formatString("NotificationActionPinnedSticker", R.string.NotificationActionPinnedSticker, new Object[]{name, chat.title});
                            } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaDocument) {
                                if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                    msg = LocaleController.formatString("NotificationActionPinnedFile", R.string.NotificationActionPinnedFile, new Object[]{name, chat.title});
                                } else {
                                    message = "📎 " + object.messageOwner.message;
                                    msg = LocaleController.formatString("NotificationActionPinnedText", R.string.NotificationActionPinnedText, new Object[]{name, message, chat.title});
                                }
                            } else if ((object.messageOwner.media instanceof TLRPC$TL_messageMediaGeo) || (object.messageOwner.media instanceof TLRPC$TL_messageMediaVenue)) {
                                msg = LocaleController.formatString("NotificationActionPinnedGeo", R.string.NotificationActionPinnedGeo, new Object[]{name, chat.title});
                            } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                                msg = LocaleController.formatString("NotificationActionPinnedGeoLive", R.string.NotificationActionPinnedGeoLive, new Object[]{name, chat.title});
                            } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaContact) {
                                msg = LocaleController.formatString("NotificationActionPinnedContact", R.string.NotificationActionPinnedContact, new Object[]{name, chat.title});
                            } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaPhoto) {
                                if (VERSION.SDK_INT < 19 || TextUtils.isEmpty(object.messageOwner.message)) {
                                    msg = LocaleController.formatString("NotificationActionPinnedPhoto", R.string.NotificationActionPinnedPhoto, new Object[]{name, chat.title});
                                } else {
                                    message = "🖼 " + object.messageOwner.message;
                                    msg = LocaleController.formatString("NotificationActionPinnedText", R.string.NotificationActionPinnedText, new Object[]{name, message, chat.title});
                                }
                            } else if (object.messageOwner.media instanceof TLRPC$TL_messageMediaGame) {
                                msg = LocaleController.formatString("NotificationActionPinnedGame", R.string.NotificationActionPinnedGame, new Object[]{name, chat.title});
                            } else if (object.messageText == null || object.messageText.length() <= 0) {
                                msg = LocaleController.formatString("NotificationActionPinnedNoText", R.string.NotificationActionPinnedNoText, new Object[]{name, chat.title});
                            } else {
                                message2 = object.messageText;
                                ...
                                msg = LocaleController.formatString("NotificationActionPinnedText", R.string.NotificationActionPinnedText, new Object[]{name, message2, chat.title});
                            }
                        }
                    } else if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionGameScore) {
                        msg = messageObject.messageText.toString();
                    ...
                    if (messageObject.isMediaEmpty()) {
                        msg = (shortMessage || messageObject.messageOwner.message == null || messageObject.messageOwner.message.length() == 0) ? LocaleController.formatString("NotificationMessageGroupNoText", R.string.NotificationMessageGroupNoText, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationMessageGroupText", R.string.NotificationMessageGroupText, new Object[]{name, chat.title, messageObject.messageOwner.message});
                    } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaPhoto) {
                        msg = (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) ? LocaleController.formatString("NotificationMessageGroupPhoto", R.string.NotificationMessageGroupPhoto, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationMessageGroupText", R.string.NotificationMessageGroupText, new Object[]{name, chat.title, "🖼 " + messageObject.messageOwner.message});
                    } else if (messageObject.isVideo()) {
                        msg = (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) ? LocaleController.formatString("NotificationMessageGroupVideo", R.string.NotificationMessageGroupVideo, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationMessageGroupText", R.string.NotificationMessageGroupText, new Object[]{name, chat.title, "📹 " + messageObject.messageOwner.message});
                    } else if (messageObject.isVoice()) {
                        msg = LocaleController.formatString("NotificationMessageGroupAudio", R.string.NotificationMessageGroupAudio, new Object[]{name, chat.title});
                    } else if (messageObject.isRoundVideo()) {
                        msg = LocaleController.formatString("NotificationMessageGroupRound", R.string.NotificationMessageGroupRound, new Object[]{name, chat.title});
                    } else if (messageObject.isMusic()) {
                        msg = LocaleController.formatString("NotificationMessageGroupMusic", R.string.NotificationMessageGroupMusic, new Object[]{name, chat.title});
                    } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaContact) {
                        msg = LocaleController.formatString("NotificationMessageGroupContact", R.string.NotificationMessageGroupContact, new Object[]{name, chat.title});
                    } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGame) {
                        msg = LocaleController.formatString("NotificationMessageGroupGame", R.string.NotificationMessageGroupGame, new Object[]{name, chat.title, messageObject.messageOwner.media.game.title});
                    } else if ((messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeo) || (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaVenue)) {
                        msg = LocaleController.formatString("NotificationMessageGroupMap", R.string.NotificationMessageGroupMap, new Object[]{name, chat.title});
                    } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                        msg = LocaleController.formatString("NotificationMessageGroupLiveLocation", R.string.NotificationMessageGroupLiveLocation, new Object[]{name, chat.title});
                    } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaDocument) {
                        if (messageObject.isSticker()) {
                            msg = messageObject.getStickerEmoji() != null ? LocaleController.formatString("NotificationMessageGroupStickerEmoji", R.string.NotificationMessageGroupStickerEmoji, new Object[]{name, chat.title, messageObject.getStickerEmoji()}) : LocaleController.formatString("NotificationMessageGroupSticker", R.string.NotificationMessageGroupSticker, new Object[]{name, chat.title});
                        } else {
                            msg = messageObject.isGif() ? (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) ? LocaleController.formatString("NotificationMessageGroupGif", R.string.NotificationMessageGroupGif, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationMessageGroupText", R.string.NotificationMessageGroupText, new Object[]{name, chat.title, "🎬 " + messageObject.messageOwner.message}) : (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) ? LocaleController.formatString("NotificationMessageGroupDocument", R.string.NotificationMessageGroupDocument, new Object[]{name, chat.title}) : LocaleController.formatString("NotificationMessageGroupText", R.string.NotificationMessageGroupText, new Object[]{name, chat.title, "📎 " + messageObject.messageOwner.message});
                        }
                    }
                } else if (messageObject.isMediaEmpty()) {
                    if (shortMessage || messageObject.messageOwner.message == null || messageObject.messageOwner.message.length() == 0) {
                        msg = LocaleController.formatString("ChannelMessageNoText", R.string.ChannelMessageNoText, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, messageObject.messageOwner.message});
                        text[0] = true;
                    }
                    ...
                    if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = LocaleController.formatString("ChannelMessagePhoto", R.string.ChannelMessagePhoto, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "🖼 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
                    ...
                    if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = LocaleController.formatString("ChannelMessageVideo", R.string.ChannelMessageVideo, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "📹 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
                } else if (messageObject.isVoice()) {
                    msg = LocaleController.formatString("ChannelMessageAudio", R.string.ChannelMessageAudio, new Object[]{name});
                } else if (messageObject.isRoundVideo()) {
                    msg = LocaleController.formatString("ChannelMessageRound", R.string.ChannelMessageRound, new Object[]{name});
                } else if (messageObject.isMusic()) {
                    msg = LocaleController.formatString("ChannelMessageMusic", R.string.ChannelMessageMusic, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaContact) {
                    msg = LocaleController.formatString("ChannelMessageContact", R.string.ChannelMessageContact, new Object[]{name});
                } else if ((messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeo) || (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaVenue)) {
                    msg = LocaleController.formatString("ChannelMessageMap", R.string.ChannelMessageMap, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                    msg = LocaleController.formatString("ChannelMessageLiveLocation", R.string.ChannelMessageLiveLocation, new Object[]{name});
                } else if (messageObject.messageOwner.media instanceof TLRPC$TL_messageMediaDocument) {
                    if (messageObject.isSticker()) {
                        msg = messageObject.getStickerEmoji() != null ? LocaleController.formatString("ChannelMessageStickerEmoji", R.string.ChannelMessageStickerEmoji, new Object[]{name, messageObject.getStickerEmoji()}) : LocaleController.formatString("ChannelMessageSticker", R.string.ChannelMessageSticker, new Object[]{name});
                    } else if (messageObject.isGif()) {
                        if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                            msg = LocaleController.formatString("ChannelMessageGIF", R.string.ChannelMessageGIF, new Object[]{name});
                        } else {
                            msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "🎬 " + messageObject.messageOwner.message});
                            text[0] = true;
                        }
                    } else if (shortMessage || VERSION.SDK_INT < 19 || TextUtils.isEmpty(messageObject.messageOwner.message)) {
                        msg = LocaleController.formatString("ChannelMessageDocument", R.string.ChannelMessageDocument, new Object[]{name});
                    } else {
                        msg = LocaleController.formatString("NotificationMessageText", R.string.NotificationMessageText, new Object[]{name, "📎 " + messageObject.messageOwner.message});
                        text[0] = true;
                    }
            ...
            return msg;
        } else if (TurboConfig.hiddenChatNotification) {
            return LocaleController.getString("YouHaveNewMessage", R.string.YouHaveNewMessage);
        } else {
            return null;
        }
        ...
        try {
            ...
            if (this.pushDialogs.size() != 1 || VERSION.SDK_INT < 23) {
                if (this.pushDialogs.size() == 1) {
                    ...
                    detailText = detailText + LocaleController.formatString("NotificationMessagesPeopleDisplayOrder", R.string.NotificationMessagesPeopleDisplayOrder, new Object[]{LocaleController.formatPluralString("NewMessages", this.total_unread_count), LocaleController.formatPluralString("FromChats", this.pushDialogs.size())});
                }
            }
            if (TurboUtils.isHiddenDialog((int) dialog_id)) {
                name = LocaleController.getString("AppName1", R.string.AppName1);
                contentIntent = null;
            }
            ...
            if (TurboUtils.isHiddenDialog((int) dialog_id)) {
                mBuilder.setLargeIcon(BitmapFactory.decodeResource(ApplicationLoader.applicationContext.getResources(), R.drawable.ic_launcher));
            ...
            if (!(AndroidUtilities.needShowPasscode(false) || SharedConfig.isWaitingForPasscodeEnter || lastMessageObject.getDialogId() != 777000 || lastMessageObject.messageOwner.reply_markup == null)) {
                ...
                int size = rows.size();
                for (int a = 0; a < size; a++) {
                    TLRPC$TL_keyboardButtonRow row = (TLRPC$TL_keyboardButtonRow) rows.get(a);
            ...
            if (!TurboUtils.isHiddenDialog((int) dialog_id) && !hasCallback && VERSION.SDK_INT < 24 && SharedConfig.passcodeHash.length() == 0 && hasMessagesToReply()) {
        ...
        for (int b = 0; b < size; b++) {
            ...
            if (lowerId != 0) {
                ...
                if (dialog_id != globalSecretChatId) {
                    TLRPC$EncryptedChat encryptedChat = MessagesController.getInstance(this.currentAccount).getEncryptedChat(Integer.valueOf(highId));
            ...
            for (a = messageObjects.size() - 1; a >= 0; a--) {
                ...
                if (message != null) {
                    ...
                    if (messageObject.isVoice()) {
                        List<Message> messages = messagingStyle.getMessages();
                        if (!messages.isEmpty()) {
                            Uri uri;
                            File f = FileLoader.getPathToMessage(messageObject.messageOwner);
                            if (VERSION.SDK_INT >= 24) {
                                try {
                                    uri = FileProvider.getUriForFile(ApplicationLoader.applicationContext, "com.baranak.turbogramf.provider", f);
                                } catch (Exception e) {
                                    uri = null;
                                }
                            } else {
                            ...
                            if (uri != null) {
                                ((Message) messages.get(messages.size() - 1)).setData("audio/ogg", uri);
                            }
                        }
                    }
            ...
            if (lowerId == 0) {
                ...
                intent.putExtra(FeedbackActivity.EXTRA_USER_ID, lowerId);
            } else {
            ...
            if (TurboUtils.isHiddenDialog((int) dialog_id)) {
                try {
                    builder.setLargeIcon(BitmapFactory.decodeResource(ApplicationLoader.applicationContext.getResources(), R.drawable.ic_launcher));
                } catch (Throwable th3) {
                }
            } else if (avatarBitmap != null && VERSION.SDK_INT < 28) {
                builder.setLargeIcon(avatarBitmap);
            }
            if (!(AndroidUtilities.needShowPasscode(false) || SharedConfig.isWaitingForPasscodeEnter || rows == null)) {
                int rc = rows.size();
                for (int r = 0; r < rc; r++) {
                    TLRPC$TL_keyboardButtonRow row = (TLRPC$TL_keyboardButtonRow) rows.get(r);
                    int cc = row.buttons.size();
                    for (int c = 0; c < cc; c++) {
                        TLRPC$KeyboardButton button = (TLRPC$KeyboardButton) row.buttons.get(c);
                        if (button instanceof TLRPC$TL_keyboardButtonCallback) {
                            intent = new Intent(ApplicationLoader.applicationContext, NotificationCallbackReceiver.class);
                            intent.putExtra("currentAccount", this.currentAccount);
                            intent.putExtra("did", dialog_id);
            ...
            if (!(lowerId == 0 || jSONObject == null)) {
                try {
                    ...
                    if (lowerId > 0) {
                        jSONObject.put(Param.TYPE, "user");
                    } else if (lowerId < 0) {
                        if (isChannel || isSupergroup) {
                            jSONObject.put(Param.TYPE, "channel");
                        } else {
                            jSONObject.put(Param.TYPE, "group");
                        }
                    }
    ...
    public void updateServerNotificationsSettings(long dialog_id) {
        ...
        if (((int) dialog_id) != 0) {
            ...
            TLRPC$TL_inputPeerNotifySettings tLRPC$TL_inputPeerNotifySettings = req.settings;
            tLRPC$TL_inputPeerNotifySettings.flags |= 1;
            req.settings.show_previews = preferences.getBoolean("preview_" + dialog_id, true);
            tLRPC$TL_inputPeerNotifySettings = req.settings;
            tLRPC$TL_inputPeerNotifySettings.flags |= 2;
            req.settings.silent = preferences.getBoolean("silent_" + dialog_id, false);
            int mute_type = preferences.getInt("notify2_" + dialog_id, -1);
            if (mute_type != -1) {
                tLRPC$TL_inputPeerNotifySettings = req.settings;
                tLRPC$TL_inputPeerNotifySettings.flags |= 4;
                if (mute_type == 3) {
                    ...
                    tLRPC$TL_inputPeerNotifySettings.mute_until = i;
                }
            }
            req.peer = new TLRPC$TL_inputNotifyPeer();
            ((TLRPC$TL_inputNotifyPeer) req.peer).peer = MessagesController.getInstance(this.currentAccount).getInputPeer((int) dialog_id);
    ...
    static final /* synthetic */ void m1226x2618b2a0(TLObject response, TLRPC$TL_error error) {
    }
}
