...
public class SecretChatHelper {
    ...
    protected void processUpdateEncryption(TLRPC$TL_updateEncryption update, ConcurrentHashMap<Integer, User> usersDict) {
        ...
        TLRPC$EncryptedChat existingChat = MessagesController.getInstance(this.currentAccount).getEncryptedChatDB(newChat.id, false);
    ...
    final /* synthetic */ void lambda$processUpdateEncryption$1$SecretChatHelper(TLRPC$TL_dialog dialog) {
    ...
    final /* synthetic */ void lambda$processUpdateEncryption$2$SecretChatHelper(TLRPC$EncryptedChat exist, TLRPC$EncryptedChat newChat) {
        if (exist != null) {
            MessagesController.getInstance(this.currentAccount).putEncryptedChat(newChat, false);
        }
    ...
    final /* synthetic */ void lambda$performSendEncryptedRequest$7$SecretChatHelper(TLRPC$EncryptedChat chat, TLRPC$DecryptedMessage req, TLRPC$Message newMsgObj, TLRPC$InputEncryptedFile encryptedFile, MessageObject newMsg, String originalPath) {
        try {
            TLObject reqToSend;
            ...
            if (encryptedFile != null) {
                ...
                reqToSend = req2;
            } else if (req instanceof TLRPC$TL_decryptedMessageService) {
    ...
    final /* synthetic */ void lambda$null$6$SecretChatHelper(TLRPC$DecryptedMessage req, TLRPC$EncryptedChat chat, TLRPC$Message newMsgObj, MessageObject newMsg, String originalPath, TLObject response, TLRPC$TL_error error) {
        if (error == null && (req.action instanceof TLRPC$TL_decryptedMessageActionNotifyLayer)) {
            TLRPC$EncryptedChat currentChat = MessagesController.getInstance(this.currentAccount).getEncryptedChat(Integer.valueOf(chat.id));
            if (currentChat == null) {
                currentChat = chat;
            }
    ...
    final /* synthetic */ void lambda$null$4$SecretChatHelper(TLRPC$Message newMsgObj, TLRPC$messages_SentEncryptedMessage res, String attachPath) {
    ...
    final /* synthetic */ void lambda$null$3$SecretChatHelper(TLRPC$Message newMsgObj, String attachPath) {
    ...
    final /* synthetic */ void lambda$null$5$SecretChatHelper(TLRPC$Message newMsgObj) {
    ...
    final /* synthetic */ void lambda$applyPeerLayer$8$SecretChatHelper(TLRPC$EncryptedChat chat) {
    ...
    public TLRPC$Message processDecryptedObject(TLRPC$EncryptedChat chat, TLRPC$EncryptedFile file, int date, TLObject object, boolean new_key_used) {
        if (object != null) {
            ...
            if (object instanceof TLRPC$TL_decryptedMessage) {
                ...
                newMessage.flags = Policy.MYKET_NOT_INSTALLED;
                ...
                if (decryptedMessage.media == null || (decryptedMessage.media instanceof TLRPC$TL_decryptedMessageMediaEmpty)) {
                    ...
                    tLRPC$MessageMedia = newMessage.media;
                    ...
                    big.w = decryptedMessage.media.f785w;
                    big.h = decryptedMessage.media.f784h;
                    big.type = "x";
                    big.size = file.size;
                    ...
                    if (thumb == null || thumb.length == 0 || thumb.length > 6000 || decryptedMessage.media.thumb_w > 100 || decryptedMessage.media.thumb_h > 100) {
                        ...
                        newMessage.media.document.thumb.f794w = decryptedMessage.media.thumb_w;
                        newMessage.media.document.thumb.f793h = decryptedMessage.media.thumb_h;
                        newMessage.media.document.thumb.type = "s";
                        newMessage.media.document.thumb.location = new TLRPC$TL_fileLocationUnavailable();
                    }
                    TLRPC$TL_documentAttributeVideo attributeVideo = new TLRPC$TL_documentAttributeVideo();
                    attributeVideo.w = decryptedMessage.media.f785w;
                    attributeVideo.h = decryptedMessage.media.f784h;
    ...
    final /* synthetic */ void lambda$processDecryptedObject$11$SecretChatHelper(long did) {
        TLRPC$TL_dialog dialog = (TLRPC$TL_dialog) MessagesController.getInstance(this.currentAccount).dialogs_dict.get(did);
        if (dialog != null) {
            dialog.unread_count = 0;
    ...
    final /* synthetic */ void lambda$resendMessages$14$SecretChatHelper(int startSeq, TLRPC$EncryptedChat encryptedChat, int endSeq) {
        int sSeq = startSeq;
        try {
            ...
            if (!exists) {
                ...
                if (messagesToResend.size() != 0) {
                    for (a = 0; a < messagesToResend.size(); a++) {
                        messages.add(createDeleteMessage(UserConfig.getInstance(this.currentAccount).getNewMessageId(), messagesToResend.keyAt(a), 0, Utilities.random.nextLong(), encryptedChat));
                    }
                    UserConfig.getInstance(this.currentAccount).saveConfig(false);
                }
    ...
    protected ArrayList<TLRPC$Message> decryptMessage(TLRPC$EncryptedMessage message) {
        TLRPC$EncryptedChat chat = MessagesController.getInstance(this.currentAccount).getEncryptedChatDB(message.chat_id, true);
    ...
    final /* synthetic */ void lambda$decryptMessage$16$SecretChatHelper(TLRPC$TL_encryptedChatDiscarded newChat) {
        MessagesController.getInstance(this.currentAccount).putEncryptedChat(newChat, false);
        MessagesStorage.getInstance(this.currentAccount).updateEncryptedChat(newChat);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    final /* synthetic */ void lambda$processAcceptedSecretChat$17$SecretChatHelper(TLRPC$EncryptedChat encryptedChat) {
    ...
    final /* synthetic */ void lambda$processAcceptedSecretChat$18$SecretChatHelper(TLRPC$TL_encryptedChatDiscarded newChat) {
        MessagesController.getInstance(this.currentAccount).putEncryptedChat(newChat, false);
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    static final /* synthetic */ void lambda$declineSecretChat$19$SecretChatHelper(TLObject response, TLRPC$TL_error error) {
    }
    ...
    final /* synthetic */ void lambda$acceptSecretChat$22$SecretChatHelper(TLRPC$EncryptedChat encryptedChat, TLObject response, TLRPC$TL_error error) {
        if (error == null) {
            int a;
            TLRPC$messages_DhConfig res = (TLRPC$messages_DhConfig) response;
            if (response instanceof TLRPC$TL_messages_dhConfig) {
                if (Utilities.isGoodPrime(res.f804p, res.f803g)) {
                    MessagesStorage.getInstance(this.currentAccount).setSecretPBytes(res.f804p);
                    MessagesStorage.getInstance(this.currentAccount).setSecretG(res.f803g);
    ...
    final /* synthetic */ void lambda$null$21$SecretChatHelper(TLRPC$EncryptedChat encryptedChat, TLObject response1, TLRPC$TL_error error1) {
        this.acceptingChats.remove(encryptedChat.id);
        if (error1 == null) {
    ...
    final /* synthetic */ void lambda$null$20$SecretChatHelper(TLRPC$EncryptedChat newChat) {
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    ...
    final /* synthetic */ void lambda$startSecretChat$29$SecretChatHelper(Context context, AlertDialog progressDialog, User user, TLObject response, TLRPC$TL_error error) {
        if (error == null) {
            TLRPC$messages_DhConfig res = (TLRPC$messages_DhConfig) response;
            if (response instanceof TLRPC$TL_messages_dhConfig) {
                if (Utilities.isGoodPrime(res.f804p, res.f803g)) {
    ...
    final /* synthetic */ void lambda$null$27$SecretChatHelper(Context context, AlertDialog progressDialog, byte[] salt, User user, TLObject response1, TLRPC$TL_error error1) {
        if (error1 == null) {
