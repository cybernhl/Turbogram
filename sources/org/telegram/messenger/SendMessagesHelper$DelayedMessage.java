        ...
        if (this.type == 4 || this.type == 0) {
            ...
            for (int a = 0; a < size; a++) {
                ...
                if (request.request instanceof TLRPC$TL_messages_sendEncryptedMultiMedia) {
                    SecretChatHelper.getInstance(SendMessagesHelper.access$200(this.this$0)).performSendEncryptedRequest((TLRPC$TL_messages_sendEncryptedMultiMedia) request.request, this);
                } else if (request.request instanceof TLRPC$TL_messages_sendMultiMedia) {
                    SendMessagesHelper.access$800(this.this$0, (TLRPC$TL_messages_sendMultiMedia) request.request, request.msgObjs, request.originalPaths);
                } else {
                    SendMessagesHelper.access$900(this.this$0, request.request, request.msgObj, request.originalPath);
                }
            }
            this.requests = null;
        }
    ...
    public void markAsError() {
        if (this.type == 4) {
            for (int a = 0; a < this.messageObjects.size(); a++) {
                ...
                MessagesStorage.getInstance(SendMessagesHelper.access$200(this.this$0)).markMessageAsSendError(obj.messageOwner);
                obj.messageOwner.send_state = 2;
                NotificationCenter.getInstance(SendMessagesHelper.access$200(this.this$0)).postNotificationName(NotificationCenter.messageSendError, Integer.valueOf(obj.getId()));
                this.this$0.processSentMessage(obj.getId());
            }
            SendMessagesHelper.access$1000(this.this$0).remove("group_" + this.groupId);
        } else {
            MessagesStorage.getInstance(SendMessagesHelper.access$200(this.this$0)).markMessageAsSendError(this.obj.messageOwner);
            this.obj.messageOwner.send_state = 2;
            NotificationCenter.getInstance(SendMessagesHelper.access$200(this.this$0)).postNotificationName(NotificationCenter.messageSendError, Integer.valueOf(this.obj.getId()));
