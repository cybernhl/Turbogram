...
public class ChangePhoneActivity extends BaseFragment {
    ...
    class C11781 extends ActionBarMenuOnItemClick {
        C11781() {
        }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenter$NotificationCenterDelegate {
        ...
        class C11886 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C11871());
            }
        }

        /* renamed from: org.telegram.ui.ChangePhoneActivity$LoginActivitySmsView$7 */
        class C11927 extends TimerTask {
            ...
            class C11911 implements Runnable {
                ...
                class C11901 implements RequestDelegate {
                    C11901() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11901(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C11911());
                }
            }
        }
        ...
        public LoginActivitySmsView(Context context, int type) {
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(ChangePhoneActivity.this) {
                ...
                class C11831 implements RequestDelegate {
                    C11831() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11831(), 2);
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C11886(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C11927(), 0, 1000);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C11961 implements CountrySelectActivityDelegate {
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C11951(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C11961());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C11781());
