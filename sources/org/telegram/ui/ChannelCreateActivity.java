...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C12501 implements RequestDelegate {
        C12501() {
        }
    ...
    class C12532 extends ActionBarMenuOnItemClick {
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed) {
                        ...
                        if (ChannelCreateActivity.this.imageUpdater.uploadingImage != null) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C12511());
    ...
    class C12553 implements View.OnClickListener {
    ...
    class C12564 implements TextWatcher {
        C12564() {
        }
    ...
    class C12575 implements OnEditorActionListener {
        C12575() {
        }
    ...
    class C12586 implements TextWatcher {
        C12586() {
        }
    ...
    class C12597 implements View.OnClickListener {
        C12597() {
        }
    ...
    class C12608 implements View.OnClickListener {
        C12608() {
        }
    ...
    class C12619 implements TextWatcher {
        C12619() {
        }
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (this.currentStep == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C12501());
            return;
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12532());
        ...
        if (this.currentStep == 0) {
            ...
            this.avatarImage.setOnClickListener(new C12553());
            ...
            this.nameTextView.addTextChangedListener(new C12564());
            ...
            this.descriptionTextView.setOnEditorActionListener(new C12575());
            this.descriptionTextView.addTextChangedListener(new C12586());
            ...
            this.radioButtonCell1.setOnClickListener(new C12597());
            ...
            this.radioButtonCell2.setOnClickListener(new C12608());
            ...
            this.nameTextView.addTextChangedListener(new C12619());
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_channels_getAdminedPublicChannels(), new RequestDelegate() {
                public void run(final TLObject response, TLRPC$TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C12461 implements View.OnClickListener {
                            C12461() {
                            }
                            ...
                            public void onClick(View view) {
                                ...
                                if (channel.megagroup) {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", R.string.RevokeLinkAlert, new Object[]{MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title})));
                                } else {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", R.string.RevokeLinkAlertChannel, new Object[]{MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title})));
                                }
                                ...
                                builder.setPositiveButton(LocaleController.getString("RevokeButton", R.string.RevokeButton), new OnClickListener() {
                                    ...
                                    class C12441 implements RequestDelegate {
                                        ...
                                        public void run(TLObject response, TLRPC$TL_error error) {
                                            if (response instanceof TLRPC$TL_boolTrue) {
                                                AndroidUtilities.runOnUIThread(new C12431());
                                            }
                                        }
                                    }
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        req.username = "";
                                        ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C12441(), 64);
                                    }
                                });
                                ChannelCreateActivity.this.showDialog(builder.create());
                            }
                        ...
                        public void run() {
                            ...
                            if (response != null && ChannelCreateActivity.this.getParentActivity() != null) {
                                ...
                                while (a < res.chats.size()) {
                                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new C12461());
    ...
    private boolean checkUserName(final String name) {
        ...
        if (name == null || name.length() < 5) {
            ...
            this.checkRunnable = new Runnable() {
                ...
                class C12491 implements RequestDelegate {
                    C12491() {
                    }
                ...
                public void run() {
                    ...
                    ChannelCreateActivity.this.checkReqId = ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C12491(), 2);
                }
            };
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        r10[46] = new ThemeDescription(null, 0, null, null, new Drawable[]{Theme.avatar_photoDrawable, Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, cellDelegate, Theme.key_avatar_text);
