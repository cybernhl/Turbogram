...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    class C17201 extends ActionBarMenuOnItemClick {
        C17201() {
        }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                int a = 0;
                while (a < 4) {
                    editor.putInt("mobileDataDownloadMask" + (a != 0 ? Integer.valueOf(a) : ""), DownloadController.getInstance(DataAutoDownloadActivity.this.currentAccount).mobileDataDownloadMask[a]);
                    editor.putInt("wifiDownloadMask" + (a != 0 ? Integer.valueOf(a) : ""), DownloadController.getInstance(DataAutoDownloadActivity.this.currentAccount).wifiDownloadMask[a]);
                    editor.putInt("roamingDownloadMask" + (a != 0 ? Integer.valueOf(a) : ""), DownloadController.getInstance(DataAutoDownloadActivity.this.currentAccount).roamingDownloadMask[a]);
                    a++;
                }
    ...
    class C17212 implements OnItemClickListener {
        C17212() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17201());
        ...
        this.listView.setOnItemClickListener(new C17212());
