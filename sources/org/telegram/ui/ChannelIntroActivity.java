...
public class ChannelIntroActivity extends BaseFragment {
    ...
    class C12721 extends ActionBarMenuOnItemClick {
        C12721() {
        }
    ...
    class C12743 implements OnTouchListener {
        C12743() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12721());
        ...
        viewGroup.setOnTouchListener(new C12743());
        ...
        this.whatIsChannelText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.descriptionText.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.createChannelText.setOnClickListener(new C12754());
