...
public class ConvertGroupActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C17131 extends ActionBarMenuOnItemClick {
        C17131() {
        }
    ...
    class C17152 implements OnItemClickListener {
        ...
        public void onItemClick(View view, int position) {
            if (position == ConvertGroupActivity.this.convertRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C17141());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17131());
        ...
        this.listView.setOnItemClickListener(new C17152());
