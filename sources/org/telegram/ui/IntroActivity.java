...
import turbogram.IntroLanguageSelectActivity;
...
public class IntroActivity extends Activity implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C18051 implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            if (IntroActivity.this.eglThread == null && surface != null) {
                ...
                IntroActivity.this.eglThread.postRunnable(new C18041());
            }
        }
    ...
    class C18062 implements OnPageChangeListener {
        C18062() {
        }
    ...
    class C18073 implements OnClickListener {
        C18073() {
        }
    ...
    class C18084 implements OnLongClickListener {
        C18084() {
        }
    ...
    class C18095 implements OnClickListener {
        C18095() {
        }

        public void onClick(View v) {
            IntroActivity.this.startActivity(new Intent(IntroActivity.this, IntroLanguageSelectActivity.class));
            IntroActivity.this.finish();
        }
    }

    /* renamed from: org.telegram.ui.IntroActivity$6 */
    class C18106 implements OnClickListener {
        C18106() {
        }
    ...
    /* renamed from: org.telegram.ui.IntroActivity$7 */
    class C18127 implements RequestDelegate {
        C18127() {
        }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C18141();
        private EGL10 egl10;
        ...
        class C18141 implements Runnable {
            ...
            class C18131 implements Runnable {
                C18131() {
                }
            ...
            public void run() {
                ...
                if ((EGLThread.this.eglContext.equals(EGLThread.this.egl10.eglGetCurrentContext()) && EGLThread.this.eglSurface.equals(EGLThread.this.egl10.eglGetCurrentSurface(12377))) || EGLThread.this.egl10.eglMakeCurrent(EGLThread.this.eglDisplay, EGLThread.this.eglSurface, EGLThread.this.eglSurface, EGLThread.this.eglContext)) {
                    ...
                    EGLThread.this.postRunnable(new C18131(), 16);
        ...
        class C18152 implements Runnable {
            C18152() {
            }
    ...
    private class IntroAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            headerTextView.setTypeface(TurboUtils.getTurboTypeFace());
            messageTextView.setTypeface(TurboUtils.getTurboTypeFace());
            return frameLayout;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollView.setSurfaceTextureListener(new C18051());
        ...
        this.viewPager.addOnPageChangeListener(new C18062());
        ...
        scrollView.setOnClickListener(new C18073());
        if (BuildVars.DEBUG_VERSION) {
            scrollView.setOnLongClickListener(new C18084());
        }
        scrollView.setTypeface(TurboUtils.getTurboTypeFace());
        GradientDrawable bgDrawable = new GradientDrawable();
        bgDrawable.setColor(-15035368);
        bgDrawable.setShape(0);
        bgDrawable.setCornerRadius((float) AndroidUtilities.dp(3.0f));
        scrollView.setBackgroundDrawable(bgDrawable);
        this.langButton = new TextView(this);
        this.langButton.setText(LocaleController.getString("ChangeLanguage", R.string.ChangeLanguage));
        this.langButton.setTextColor(-15035368);
        this.langButton.setTextSize(1, 16.0f);
        this.langButton.setGravity(17);
        this.langButton.setTypeface(TurboUtils.getTurboTypeFace());
        this.langButton.setVisibility(8);
        this.langButton.setOnClickListener(new C18095());
        frameLayout.addView(this.langButton, LayoutHelper.createFrame(-2, 30.0f, 81, 0.0f, 0.0f, 0.0f, 20.0f));
        ...
        this.textView.setOnClickListener(new C18106());
        this.textView.setTypeface(TurboUtils.getTurboTypeFace());
        this.textView.setTextColor(-15035368);
    ...
    private void checkContinueText() {
        ...
        if (englishInfo != null && systemInfo != null && englishInfo != systemInfo) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C18127(), 8);
        }
    }
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.suggestedLangpack) {
            checkContinueText();
            this.langButton.setVisibility(this.textView.getText().equals("") ? 0 : 8);
        }
    }
}
