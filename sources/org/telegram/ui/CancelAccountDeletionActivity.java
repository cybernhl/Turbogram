...
public class CancelAccountDeletionActivity extends BaseFragment {
    ...
    class C11001 extends ActionBarMenuOnItemClick {
        C11001() {
        }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenter$NotificationCenterDelegate {
        ...
        class C11085 extends TimerTask {
        ...
        class C11126 extends TimerTask {
            ...
            class C11111 implements Runnable {
                ...
                class C11101 implements RequestDelegate {
                    C11101() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(CancelAccountDeletionActivity.this.currentAccount).sendRequest(req, new C11101(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C11111());
                }
            }
        }
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C11085(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C11126(), 0, 1000);
            }
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C11001());
