...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C21801 extends ActionBarMenuOnItemClick {
        C21801() {
        }
    ...
    class C21812 implements Callback {
        C21812() {
        }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == TwoStepVerificationActivity.this.setPasswordDetailRow) {
                        ...
                        r6 = new Object[1];
                        r6[0] = TwoStepVerificationActivity.this.currentPassword.email_unconfirmed_pattern != null ? TwoStepVerificationActivity.this.currentPassword.email_unconfirmed_pattern : "";
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C21801());
        ...
        this.passwordEditText.setCustomSelectionActionModeCallback(new C21812());
        this.bottomTextView = new TextView(context);
        this.bottomTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.bottomButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
    ...
    final /* synthetic */ void lambda$createView$6$TwoStepVerificationActivity(View v) {
        ...
        if (this.type == 0) {
            if (this.currentPassword.has_recovery) {
                needShowProgress();
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_auth_requestPasswordRecovery(), new TwoStepVerificationActivity$$Lambda$27(this), 10);
    ...
    final /* synthetic */ void lambda$null$3$TwoStepVerificationActivity(TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$30(this, error, response));
    }

    final /* synthetic */ void lambda$null$2$TwoStepVerificationActivity(TLRPC$TL_error error, TLObject response) {
        needHideProgress();
        if (error == null) {
    ...
    final /* synthetic */ void lambda$null$1$TwoStepVerificationActivity(TLRPC$TL_auth_passwordRecovery res, DialogInterface dialogInterface, int i) {
    ...
    public static void initPasswordNewAlgo(TLRPC$TL_account_password password) {
        if (password.new_algo instanceof C0972x72c667f) {
            C0972x72c667f algo = password.new_algo;
    ...
    private void loadPasswordInfo(boolean silent) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new TwoStepVerificationActivity$$Lambda$4(this, silent), 10);
    }

    final /* synthetic */ void lambda$loadPasswordInfo$11$TwoStepVerificationActivity(boolean silent, TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$25(this, error, response, silent));
    }

    final /* synthetic */ void lambda$null$10$TwoStepVerificationActivity(TLRPC$TL_error error, TLObject response, boolean silent) {
        if (error == null) {
            this.loading = false;
    ...
    final /* synthetic */ void lambda$setNewPassword$20$TwoStepVerificationActivity(TLRPC$TL_account_updatePasswordSettings req, boolean clear, String password) {
        ...
        if (password != null && this.currentSecret != null && this.currentSecret.length == 32 && (this.currentPassword.new_secure_algo instanceof TLRPC$TL_securePasswordKdfAlgoPBKDF2HMACSHA512iter100000)) {
        ...
        if (this.currentPassword.new_algo instanceof C0972x72c667f) {
            if (password != null) {
                C0972x72c667f algo = (C0972x72c667f) this.currentPassword.new_algo;
    ...
    final /* synthetic */ void lambda$null$19$TwoStepVerificationActivity(boolean clear, byte[] newPasswordHash, TLRPC$TL_account_updatePasswordSettings req, TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$20(this, error, clear, response, newPasswordHash, req));
    }

    final /* synthetic */ void lambda$null$18$TwoStepVerificationActivity(TLRPC$TL_error error, boolean clear, TLObject response, byte[] newPasswordHash, TLRPC$TL_account_updatePasswordSettings req) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new TwoStepVerificationActivity$$Lambda$21(this, clear), 8);
    }

    final /* synthetic */ void lambda$null$15$TwoStepVerificationActivity(boolean clear, TLObject response2, TLRPC$TL_error error2) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$24(this, error2, response2, clear));
    }

    final /* synthetic */ void lambda$null$14$TwoStepVerificationActivity(TLRPC$TL_error error2, TLObject response2, boolean clear) {
        if (error2 == null) {
    ...
    final /* synthetic */ void lambda$null$16$TwoStepVerificationActivity(byte[] newPasswordHash, TLRPC$TL_account_updatePasswordSettings req, DialogInterface dialogInterface, int i) {
    ...
    final /* synthetic */ void lambda$null$17$TwoStepVerificationActivity(TLRPC$TL_account_updatePasswordSettings req, DialogInterface dialogInterface, int i) {
    ...
    static final /* synthetic */ void lambda$checkSecretValues$21$TwoStepVerificationActivity(TLObject response, TLRPC$TL_error error) {
    }
    ...
    final /* synthetic */ void lambda$processDone$28$TwoStepVerificationActivity(byte[] oldPasswordBytes) {
        ...
        if (this.currentPassword.current_algo instanceof C0972x72c667f) {
            req.password = SRPHelper.startCheck(x_bytes, this.currentPassword.srp_id, this.currentPassword.srp_B, (C0972x72c667f) this.currentPassword.current_algo);
            if (req.password == null) {
                TLRPC$TL_error error = new TLRPC$TL_error();
                error.text = "ALGO_INVALID";
    ...
    final /* synthetic */ void lambda$null$27$TwoStepVerificationActivity(byte[] oldPasswordBytes, byte[] x_bytes, TLObject response, TLRPC$TL_error error) {
        if (error == null) {
    ...
    final /* synthetic */ void lambda$null$23$TwoStepVerificationActivity(byte[] oldPasswordBytes, TLObject response, byte[] x_bytes) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$18(this, checkSecretValues(oldPasswordBytes, (TLRPC$TL_account_passwordSettings) response), x_bytes));
    }
    ...
    final /* synthetic */ void lambda$null$26$TwoStepVerificationActivity(TLRPC$TL_error error) {
        if ("SRP_ID_INVALID".equals(error.text)) {
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new TwoStepVerificationActivity$$Lambda$16(this), 8);
            return;
        }
        needHideProgress();
    ...
    final /* synthetic */ void lambda$null$25$TwoStepVerificationActivity(TLObject response2, TLRPC$TL_error error2) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$17(this, error2, response2));
    }

    final /* synthetic */ void lambda$null$24$TwoStepVerificationActivity(TLRPC$TL_error error2, TLObject response2) {
        if (error2 == null) {
            this.currentPassword = (TLRPC$TL_account_password) response2;
            initPasswordNewAlgo(this.currentPassword);
            processDone();
    ...
    final /* synthetic */ void lambda$processDone$31$TwoStepVerificationActivity(TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new TwoStepVerificationActivity$$Lambda$11(this, error));
    }

    final /* synthetic */ void lambda$null$30$TwoStepVerificationActivity(TLRPC$TL_error error) {
        if (error == null) {
            Builder builder = new Builder(getParentActivity());
