...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C17722 extends ActionBarMenuOnItemClick {
        C17722() {
        }
    ...
    class C17754 implements OnClickListener {

        /* renamed from: org.telegram.ui.GroupCreateFinalActivity$4$1 */
        class C17741 implements DialogInterface.OnClickListener {
            C17741() {
            }
    ...
    class C17765 implements TextWatcher {
        C17765() {
        }
    ...
    class C17776 extends OnScrollListener {
        C17776() {
        }
    ...
    class C17809 implements ThemeDescriptionDelegate {
        C17809() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17722());
        ...
        this.avatarImage.setOnClickListener(new C17754());
        ...
        this.editText.addTextChangedListener(new C17765());
        ...
        this.listView.setOnScrollListener(new C17776());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C17809();
