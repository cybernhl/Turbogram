...
public class ChannelRightsEditActivity extends BaseFragment {
    ...
    class C12811 extends ActionBarMenuOnItemClick {
        C12811() {
        }
    ...
    class C12893 implements OnItemClickListener {

        /* renamed from: org.telegram.ui.ChannelRightsEditActivity$3$1 */
        class C12851 implements OnDateSetListener {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                try {
                    ...
                    dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C12842());
        ...
        class C12862 implements OnClickListener {
            C12862() {
            }
        ...
        class C12873 implements OnClickListener {
            C12873() {
            }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == 0) {
                ...
                if (ChannelRightsEditActivity.this.getParentActivity() != null) {
                    Calendar calendar = Calendar.getInstance();
                    try {
                        DatePickerDialog dialog = new DatePickerDialog(ChannelRightsEditActivity.this.getParentActivity(), new C12851(), calendar.get(1), calendar.get(2), calendar.get(5));
                        ...
                        dialog.setButton(-1, LocaleController.getString("Set", R.string.Set), dialog);
                        dialog.setButton(-3, LocaleController.getString("UserRestrictionsUntilForever", R.string.UserRestrictionsUntilForever), new C12862());
                        dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C12873());
                ...
                if (checkCell.isEnabled()) {
                    ...
                    if (position == ChannelRightsEditActivity.this.changeInfoRow) {
                        ...
                        TLRPC$TL_channelBannedRights access$700;
                        TLRPC$TL_channelBannedRights access$7002;
                        ...
                        if (position == ChannelRightsEditActivity.this.viewMessagesRow) {
                            ...
                            TLRPC$TL_channelBannedRights access$7003 = ChannelRightsEditActivity.this.bannedRights;
                            TLRPC$TL_channelBannedRights access$7004 = ChannelRightsEditActivity.this.bannedRights;
                            r3 = !ChannelRightsEditActivity.this.bannedRights.send_stickers;
                            access$7004.send_inline = r3;
                            access$7003.send_gifs = r3;
                            access$7002.send_games = r3;
                            access$700.send_stickers = r3;
                        ...
                        if (disabled) {
                            ...
                            if ((ChannelRightsEditActivity.this.bannedRights.view_messages || ChannelRightsEditActivity.this.bannedRights.send_messages || ChannelRightsEditActivity.this.bannedRights.send_media) && !ChannelRightsEditActivity.this.bannedRights.send_stickers) {
                                TLRPC$TL_channelBannedRights access$7005 = ChannelRightsEditActivity.this.bannedRights;
                                access$700 = ChannelRightsEditActivity.this.bannedRights;
                                access$7002 = ChannelRightsEditActivity.this.bannedRights;
                                ChannelRightsEditActivity.this.bannedRights.send_inline = true;
                                access$7002.send_gifs = true;
                                access$700.send_games = true;
                                access$7005.send_stickers = true;
    ...
    class C12904 implements ThemeDescriptionDelegate {
        C12904() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12811());
        if (this.canEdit) {
        ...
        this.listView.setOnItemClickListener(new C12893());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C12904();
