...
public class BlockedUsersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate, ContactsActivityDelegate {
    ...
    class C10741 extends ActionBarMenuOnItemClick {
        C10741() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C10741());
