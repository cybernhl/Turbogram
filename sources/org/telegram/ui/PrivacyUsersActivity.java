...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C20511 extends ActionBarMenuOnItemClick {

        /* renamed from: org.telegram.ui.PrivacyUsersActivity$1$1 */
        class C20501 implements GroupCreateActivityDelegate {
            C20501() {
            }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                fragment.setDelegate(new C20501());
    ...
    class C20522 implements OnItemClickListener {
        C20522() {
        }
    ...
    class C20543 implements OnItemLongClickListener {

        /* renamed from: org.telegram.ui.PrivacyUsersActivity$3$1 */
        class C20531 implements OnClickListener {
            C20531() {
            }
        ...
        public boolean onItemClick(View view, int position) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Delete", R.string.Delete)}, new C20531());
    ...
    class C20554 implements ThemeDescriptionDelegate {
        C20554() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20511());
        ...
        this.listView.setOnItemClickListener(new C20522());
        this.listView.setOnItemLongClickListener(new C20543());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C20554();
