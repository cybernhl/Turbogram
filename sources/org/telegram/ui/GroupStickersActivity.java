...
public class GroupStickersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C17893 implements TextWatcher {
    ...
    class C17904 implements OnClickListener {
        C17904() {
        }
    ...
    class C17926 implements OnItemClickListener {
        C17926() {
        }
        ...
        public void onItemClick(View view, int position) {
            if (GroupStickersActivity.this.getParentActivity() != null) {
                if (position == GroupStickersActivity.this.selectedStickerRow) {
                    ...
                    GroupStickersActivity.this.selectedStickerSet = (TLRPC$TL_messages_stickerSet) DataQuery.getInstance(GroupStickersActivity.this.currentAccount).getStickerSets(0).get(position - GroupStickersActivity.this.stickersStartRow);
    ...
    class C17937 extends OnScrollListener {
        C17937() {
        }
    ...
    class C17979 implements Runnable {
        C17979() {
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    long id;
                    boolean z;
                    ArrayList<TLRPC$TL_messages_stickerSet> arrayList = DataQuery.getInstance(GroupStickersActivity.this.currentAccount).getStickerSets(0);
    ...
    public View createView(Context context) {
        ...
        this.usernameTextView.addTextChangedListener(new C17893());
        ...
        this.eraseImageView.setOnClickListener(new C17904());
        ...
        this.listView.setOnItemClickListener(new C17926());
        this.listView.setOnScrollListener(new C17937());
    ...
    private void resolveStickerSet() {
        if (this.listAdapter != null) {
            ...
            TLRPC$TL_messages_stickerSet existingSet = DataQuery.getInstance(this.currentAccount).getStickerSetByName(query);
            if (existingSet != null) {
            ...
            Runnable c17968 = new Runnable() {

                /* renamed from: org.telegram.ui.GroupStickersActivity$8$1 */
                class C17951 implements RequestDelegate {
                    C17951() {
                    }
                ...
                public void run() {
                    if (GroupStickersActivity.this.queryRunnable != null) {
                        ...
                        GroupStickersActivity.this.reqId = ConnectionsManager.getInstance(GroupStickersActivity.this.currentAccount).sendRequest(req, new C17951());
                    }
                }
            };
            this.queryRunnable = c17968;
            AndroidUtilities.runOnUIThread(c17968, 500);
        }
    }

    public void onTransitionAnimationEnd(boolean isOpen, boolean backward) {
        if (isOpen) {
            AndroidUtilities.runOnUIThread(new C17979(), 100);
        }
    }
                    ...
                    public void run() {
                        if (error == null) {
                            ...
                            if (GroupStickersActivity.this.info.stickerset == null) {
                                TLRPC$ChatFull access$2100 = GroupStickersActivity.this.info;
