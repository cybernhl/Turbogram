...
public class ActionBarLayout extends FrameLayout {
    ...
    class C09773 extends ViewOutlineProvider {
        C09773() {
        }
    ...
    class C09784 extends AnimatorListenerAdapter {
        C09784() {
        }
    ...
    class C09817 implements Runnable {
        C09817() {
        }
    ...
    class C09828 extends AnimatorListenerAdapter {
        C09828() {
        }
    ...
    class C09839 extends AnimatorListenerAdapter {
        C09839() {
        }
    ...
    private void startLayoutAnimation(final boolean open, final boolean first, final boolean preview) {
        ...
        this.animationRunnable = c09762;
        AndroidUtilities.runOnUIThread(c09762);
    }
    ...
    public boolean presentFragment(BaseFragment fragment, boolean removeLast, boolean forceWithoutAnimation, boolean check, boolean preview) {
        ...
        if (preview) {
            if (VERSION.SDK_INT >= 21) {
                fragmentView.setOutlineProvider(new C09773());
        ...
        if (!needAnimation && !preview) {
            ...
            this.currentAnimation.addListener(new C09784());
            ...
            if (previousFragment != null) {
                ...
                if (needAnimation) {
                    ...
                    if (animation != null) {
                        ...
                        this.waitingForKeyboardCloseRunnable = new C09817();
                        AndroidUtilities.runOnUIThread(this.waitingForKeyboardCloseRunnable, 200);
                        return;
                    } else {
                ...
                this.currentAnimation.setInterpolator(this.accelerateDecelerateInterpolator);
                this.currentAnimation.setDuration(200);
                this.currentAnimation.addListener(new C09828());
                this.currentAnimation.start();
            } else {
    ...
    public void animateThemedValues(Theme$ThemeInfo theme) {
        ...
        if (startAnimation) {
            ...
            this.themeAnimatorSet.addListener(new C09839());
