...
public class AlertDialog extends Dialog implements Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (AlertDialog.this.titleTextView != null) {
                    if (AlertDialog.this.secondTitleTextView != null) {
                        AlertDialog.this.titleTextView.measure(MeasureSpec.makeMeasureSpec((MeasureSpec.getSize(childWidthMeasureSpec) - AlertDialog.this.secondTitleTextView.getMeasuredWidth()) - AndroidUtilities.dp(8.0f), 1073741824), heightMeasureSpec);
                    } else {
                ...
                if (AlertDialog.this.topImageView != null) {
                    AlertDialog.this.topImageView.measure(MeasureSpec.makeMeasureSpec(width, 1073741824), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp((float) AlertDialog.this.topHeight), 1073741824));
        ...
        this.messageTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                    ...
                    if (totalWidth > availableWidth) {
                        ...
                        if (negative != null && neuntral != null) {
                            if (negative.getMeasuredWidth() < neuntral.getMeasuredWidth()) {
                                neuntral.measure(MeasureSpec.makeMeasureSpec(neuntral.getMeasuredWidth() - (totalWidth - availableWidth), 1073741824), MeasureSpec.makeMeasureSpec(neuntral.getMeasuredHeight(), 1073741824));
                            } else {
                                negative.measure(MeasureSpec.makeMeasureSpec(negative.getMeasuredWidth() - (totalWidth - availableWidth), 1073741824), MeasureSpec.makeMeasureSpec(negative.getMeasuredHeight(), 1073741824));
                            }
                        }
                    }
                }
