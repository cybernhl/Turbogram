...
public class BottomSheet extends Dialog {
    ...
    private Runnable dismissRunnable = new BottomSheet$$Lambda$0(this);
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        class C10041 extends AnimatorListenerAdapter {
            C10041() {
            }
        ...
        private void checkDismiss(float velX, float velY) {
            ...
            if (backAnimation) {
                ...
                this.currentAnimation.addListener(new C10041());
    ...
    class C10014 extends AnimatorListenerAdapter {
        C10014() {
        }
    ...
    class C10036 extends AnimatorListenerAdapter {
        C10036() {
        }
    ...
    public BottomSheet(Context context, boolean needFocus) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.container.setOnApplyWindowInsetsListener(new BottomSheet$$Lambda$1(this));
            this.container.setSystemUiVisibility(1280);
        }
        this.backDrawable.setAlpha(0);
    }

    final /* synthetic */ WindowInsets lambda$new$0$BottomSheet(View v, WindowInsets insets) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.title != null) {
            ...
            titleView.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        ...
        if (this.customView != null) {
            ...
            while (a < this.items.length) {
                if (this.items[a] != null) {
                    ...
                    cell.setOnClickListener(new BottomSheet$$Lambda$3(this));
    ...
    final /* synthetic */ void lambda$onCreate$2$BottomSheet(View v) {
    ...
    public void show() {
        ...
        if (VERSION.SDK_INT >= 18) {
            ...
            Runnable c10003 = new C10003();
            this.startAnimationRunnable = c10003;
            AndroidUtilities.runOnUIThread(c10003, 150);
            return;
        }
        startOpenAnimation();
    }
    ...
    private void startOpenAnimation() {
        if (!this.dismissed) {
            ...
            if (!onCustomOpenAnimation()) {
                ...
                animatorSet.addListener(new C10014());
                animatorSet.start();
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    if (BottomSheet.this.currentSheetAnimation != null && BottomSheet.this.currentSheetAnimation.equals(animation)) {
                        ...
                        AndroidUtilities.runOnUIThread(new BottomSheet$5$$Lambda$0(this));
                    }
                }

                final /* synthetic */ void lambda$onAnimationEnd$0$BottomSheet$5() {
                    try {
                        super.dismiss();
                    } catch (Exception e) {
                        FileLog.e(e);
    ...
    public void dismiss() {
        if ((this.delegate == null || this.delegate.canDismiss()) && !this.dismissed) {
            ...
            if (!this.allowCustomAnimation || !onCustomCloseAnimation()) {
                ...
                animatorSet.setInterpolator(new AccelerateInterpolator());
                animatorSet.addListener(new C10036());
                animatorSet.start();
                this.currentSheetAnimation = animatorSet;
            }
        }
