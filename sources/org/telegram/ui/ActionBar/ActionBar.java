...
public class ActionBar extends FrameLayout {
    ...
    private BackupImageView hiddenImageView;
    ...
    class C09731 extends AnimatorListenerAdapter {
        C09731() {
        }
    ...
    class C09742 extends AnimatorListenerAdapter {
        C09742() {
        }
    ...
    private void createBackButtonImage() {
        if (this.backButtonImageView == null) {
            ...
            GradientDrawable hiddenDrawable = new GradientDrawable();
            hiddenDrawable.setColor(SupportMenu.CATEGORY_MASK);
            hiddenDrawable.setCornerRadius((float) AndroidUtilities.dp(13.0f));
            this.hiddenImageView = new BackupImageView(getContext());
            this.hiddenImageView.setVisibility(4);
            this.hiddenImageView.setRoundRadius(AndroidUtilities.dp(21.0f));
            this.hiddenImageView.setImageDrawable(hiddenDrawable);
            addView(this.hiddenImageView, LayoutHelper.createFrame(9, 9.0f, 51, 16.0f, 35.0f, 0.0f, 0.0f));
        }
    }
    ...
    public void createMenuPhoto() {
        ...
        addView(this.avatarImageView, LayoutHelper.createFrame(35, 35.0f, 83, 16.0f, 0.0f, 0.0f, 9.0f));
        Drawable avatarDrawable = new AvatarDrawable();
        TLObject newPhoto = null;
        if (UserConfig.getInstance(UserConfig.selectedAccount).isClientActivated()) {
            User user = UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser();
            if (user.photo != null) {
    ...
    public void hideMenuPhoto() {
        if (this.avatarImageView != null) {
            this.avatarImageView.setVisibility(4);
        }
    }

    public void showHiddenDot() {
        if (this.hiddenImageView != null) {
            this.hiddenImageView.setVisibility(0);
        }
    }

    public void hideHiddenDot() {
        if (this.hiddenImageView != null) {
            this.hiddenImageView.setVisibility(4);
        }
    }
    ...
    public void showActionMode() {
        if (this.actionMode != null && !this.actionModeVisible) {
            ...
            this.actionModeAnimation.addListener(new C09731());
    ...
    public void hideActionMode() {
        if (this.actionMode != null && this.actionModeVisible) {
            ...
            this.actionModeAnimation.playTogether(animators);
            this.actionModeAnimation.setDuration(200);
            this.actionModeAnimation.addListener(new C09742());
            this.actionModeAnimation.start();
            if (this.titleTextView != null) {
