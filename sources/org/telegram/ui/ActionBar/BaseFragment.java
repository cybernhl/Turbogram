...
public class BaseFragment {
    ...
    class C09971 implements OnDismissListener {
        C09971() {
        }
    ...
    public Dialog turboShowDialog(Dialog dialog) {
        Dialog dialog2 = null;
        if (!(dialog == null || this.parentLayout == null || this.parentLayout.animationInProgress || (this.parentLayout.startedTracking && this.parentLayout.checkTransitionAnimation()))) {
            try {
                this.visibleDialog = dialog;
                this.visibleDialog.setCanceledOnTouchOutside(true);
                this.visibleDialog.setOnDismissListener(new C09971());
                this.visibleDialog.show();
                dialog2 = this.visibleDialog;
            } catch (Exception e) {
