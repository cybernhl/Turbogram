...
public class Theme {
    ...
    private static SensorEventListener ambientSensorListener = new Theme$7();
    ...
    private static HashMap<Long, Drawable> chatWallpapers = new HashMap();
    ...
    public static Drawable[] chat_attachButtonDrawables = new Drawable[11];
    ...
    public static Drawable chat_directOtherDoneIconDrawable = null;
    public static Drawable chat_directOtherIconDrawable = null;
    ...
    public static Drawable chat_favMessageDoneIconDrawable = null;
    public static Drawable chat_favMessageIconDrawable = null;
    ...
    public static Drawable chat_saveToCloudIconDrawable = null;
    ...
    private static Theme$ThemeInfo currentDayTheme = null;
    private static Theme$ThemeInfo currentNightTheme = null;
    private static int currentSelectedColor = 0;
    private static Theme$ThemeInfo currentTheme = null;
    private static HashMap<String, Integer> defaultColors = new HashMap();
    private static Theme$ThemeInfo defaultTheme = null;
    ...
    public static final String key_dialogsBackgroundWhite = "dialogsBackground";
    ...
    public static final String key_muteTabCounter = "muteTabCounter";
    public static final String key_muteTabCounterText = "muteTabCounterText";
    ...
    public static final String key_tabCounterText = "tabCounterText";
    public static final String key_tabIcons = "tabIcons";
    public static final String key_tabSelectedIcon = "tabSelectedIcon";
    public static final String key_tabsBackground = "tabsBackground";
    ...
    private static ArrayList<Theme$ThemeInfo> otherThemes = new ArrayList();
    ...
    private static Runnable switchDayBrightnessRunnable = new Theme$1();
    private static boolean switchDayRunnableScheduled;
    private static Runnable switchNightBrightnessRunnable = new Theme$2();
    private static boolean switchNightRunnableScheduled;
    private static final Object sync = new Object();
    public static Drawable tabs_allDrawable;
    public static Drawable tabs_botDrawable;
    public static Drawable tabs_channelDrawable;
    public static Drawable tabs_contactDrawable;
    public static Drawable tabs_favoriteDrawable;
    public static Drawable tabs_groupDrawable;
    public static Drawable tabs_superGroupDrawable;
    public static Drawable tabs_unreadDrawable;
    private static Drawable themedWallpaper;
    private static int themedWallpaperFileOffset;
    public static ArrayList<Theme$ThemeInfo> themes = new ArrayList();
    private static HashMap<String, Theme$ThemeInfo> themesDict = new HashMap();
    ...
    static {
        ...
        defaultColors.put(key_tabsBackground, Integer.valueOf(-11371101));
        defaultColors.put(key_tabIcons, Integer.valueOf(-1));
        defaultColors.put(key_tabSelectedIcon, Integer.valueOf(-1));
        defaultColors.put(key_tabCounter, Integer.valueOf(-1));
        defaultColors.put(key_tabCounterText, Integer.valueOf(-1));
        defaultColors.put(key_muteTabCounter, Integer.valueOf(-1));
        defaultColors.put(key_muteTabCounterText, Integer.valueOf(-1));
        defaultColors.put(key_dialogsBackgroundWhite, Integer.valueOf(-1));
        ...
        defaultColors.put(key_switch2Thumb, Integer.valueOf(-2402212));
        defaultColors.put(key_switch2Track, Integer.valueOf(-20307));
        defaultColors.put(key_switch2ThumbChecked, Integer.valueOf(-12277526));
        defaultColors.put(key_switch2TrackChecked, Integer.valueOf(-6236422));
        defaultColors.put(key_switch2Check, Integer.valueOf(-1));
        ...
        themeInfo.assetName = "turbo-green.attheme";
        themes.add(themeInfo);
        themesDict.put("green", themeInfo);
        themeInfo = new Theme$ThemeInfo();
        themeInfo.name = "light green";
        themeInfo.assetName = "turbo-light-green.attheme";
        themes.add(themeInfo);
        themesDict.put("light green", themeInfo);
        themeInfo = new Theme$ThemeInfo();
        themeInfo.name = "brown";
        themeInfo.assetName = "turbo-brown.attheme";
        themes.add(themeInfo);
        themesDict.put("brown", themeInfo);
        themeInfo = new Theme$ThemeInfo();
        themeInfo.name = "red";
        themeInfo.assetName = "turbo-red.attheme";
        themes.add(themeInfo);
        themesDict.put("red", themeInfo);
        ...
        if (TextUtils.isEmpty(themesString)) {
            ...
            if (!TextUtils.isEmpty(themesString)) {
                ...
                for (String createWithString : themesArr) {
                    themeInfo = Theme$ThemeInfo.createWithString(createWithString);
                    if (themeInfo != null) {
            ...
            try {
                ...
                for (a = 0; a < jsonArray.length(); a++) {
                    themeInfo = Theme$ThemeInfo.createWithJson(jsonArray.getJSONObject(a));
                    if (themeInfo != null) {
                        otherThemes.add(themeInfo);
                        themes.add(themeInfo);
                        themesDict.put(themeInfo.name, themeInfo);
        ...
        sortThemes();
        Theme$ThemeInfo theme$ThemeInfo = null;
        try {
            preferences = MessagesController.getGlobalMainSettings();
            String theme = preferences.getString("theme", null);
            if (theme != null) {
                theme$ThemeInfo = (Theme$ThemeInfo) themesDict.get(theme);
            }
            theme = preferences.getString("nighttheme", null);
            if (theme != null) {
                Theme$ThemeInfo t = (Theme$ThemeInfo) themesDict.get(theme);
                if (t != null) {
                    currentNightTheme = t;
                }
            }
        ...
        if (theme$ThemeInfo == null) {
            theme$ThemeInfo = defaultTheme;
        } else {
            currentDayTheme = theme$ThemeInfo;
        }
        applyTheme(theme$ThemeInfo, false, false, false);
    ...
    public static Drawable createEditTextDrawable(Context context, boolean alert) {
        ...
        StateListDrawable stateListDrawable = new Theme$4();
    ...
    L_0x0059:
        ...
        r5 = r5.getResources();
        r6 = 2131165708; // 0x7f07020c float:1.794564E38 double:1.052935762E-314;
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new Theme$5();
    ...
    public static Drawable getSelectorDrawableSeparator(boolean whiteBackground) {
        new ShapeDrawable(new RectShape()).setColorFilter(new PorterDuffColorFilter(TurboUtils.getLighterColor(getColor(key_actionBarDefaultSubmenuItem), 0.2f), Mode.MULTIPLY));
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{getSelectorDrawable(whiteBackground), shapeDrawable});
        layerDrawable.setLayerInset(1, 0, 0, 0, AndroidUtilities.dp(47.0f));
    ...
    static final /* synthetic */ int lambda$sortThemes$0$Theme(Theme$ThemeInfo o1, Theme$ThemeInfo o2) {
    ...
    public static Theme$ThemeInfo applyThemeFile(File file, String themeName, boolean temporary) {
        boolean z = true;
        try {
            ...
            Theme$ThemeInfo themeInfo = (Theme$ThemeInfo) themesDict.get(themeName);
            if (themeInfo == null) {
                newTheme = true;
                themeInfo = new Theme$ThemeInfo();
    ...
    public static void applyTheme(Theme$ThemeInfo themeInfo, boolean animated) {
        applyTheme(themeInfo, true, true, animated);
    }

    public static void applyTheme(Theme$ThemeInfo themeInfo, boolean save, boolean removeWallpaperOverride, boolean nightTheme) {
        if (themeInfo != null) {
    ...
    private static void saveOtherThemes() {
        ...
        for (int a = 0; a < otherThemes.size(); a++) {
            JSONObject jsonObject = ((Theme$ThemeInfo) otherThemes.get(a)).getSaveJson();
            if (jsonObject != null) {
    ...
    public static void setCurrentNightTheme(Theme$ThemeInfo theme) {
        ...
        if (previousTheme == null) {
            ...
            if (selectedAutoNightType != 2) {
                ...
                if (lightSensorRegistered) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("light sensor unregistered");
                    }
                }
            }
            int switchToTheme = 0;
            if (selectedAutoNightType == 1) {
                ...
                if (!(lightSensorRegistered || lightSensor == null)) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1221d("light sensor registered");
                    }
                }
    ...
    public static boolean deleteTheme(Theme$ThemeInfo themeInfo) {
    ...
    public static void saveCurrentTheme(String name, boolean finalSave) {
        ...
        try {
            ...
            try {
                ...
                Theme$ThemeInfo newTheme = (Theme$ThemeInfo) themesDict.get(name);
                if (newTheme == null) {
                    newTheme = new Theme$ThemeInfo();
    ...
    private static HashMap<String, Integer> getThemeFileValues(File file, String assetName) {
        ...
        try {
                    ...
                    for (int a = 0; a < read; a++) {
                        if (bytes[a] == (byte) 10) {
                            ...
                            if (idx != -1) {
                                ...
                                if (key.equals(key_dialogsBackgroundWhite)) {
                                    turboTheme = true;
                                }
            ...
            try {
                ...
                if (!turboTheme) {
                    stringMap.put(key_tabsBackground, stringMap.get(key_actionBarDefault));
                    stringMap.put(key_dialogsBackgroundWhite, stringMap.get(key_windowBackgroundWhite));
                }
                return stringMap;
            } catch (Throwable th4) {
                th = th4;
    ...
    public static void createDialogsResources(Context context) {
        ...
        if (dialogs_namePaint == null) {
            ...
            tabs_botDrawable = resources.getDrawable(R.drawable.turbo_tab_bot);
            tabs_channelDrawable = resources.getDrawable(R.drawable.turbo_tab_channel);
            tabs_superGroupDrawable = resources.getDrawable(R.drawable.turbo_tab_supergroup);
            tabs_groupDrawable = resources.getDrawable(R.drawable.turbo_tab_group);
            tabs_contactDrawable = resources.getDrawable(R.drawable.turbo_tab_user);
            tabs_favoriteDrawable = resources.getDrawable(R.drawable.turbo_tab_favs);
            tabs_allDrawable = resources.getDrawable(R.drawable.turbo_tab_all);
            tabs_unreadDrawable = resources.getDrawable(R.drawable.turbo_tab_unread);
            applyDialogsTheme();
        }
    ...
    public static void createChatResources(Context context, boolean fontsOnly) {
        ...
        if (!fontsOnly && chat_msgInDrawable == null) {
            ...
            chat_contextResult_descriptionTextPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
            ...
            chat_attachButtonDrawables[0] = new Theme$AttachCameraDrawable();
            ...
            chat_attachButtonDrawables[7] = createCircleDrawableWithIcon(AndroidUtilities.dp(54.0f), R.drawable.attach_painting_states);
            chat_attachButtonDrawables[8] = createCircleDrawableWithIcon(AndroidUtilities.dp(54.0f), R.drawable.attach_draft_states);
            chat_attachButtonDrawables[9] = createCircleDrawableWithIcon(AndroidUtilities.dp(54.0f), R.drawable.attach_close);
            chat_attachButtonDrawables[10] = createCircleDrawableWithIcon(AndroidUtilities.dp(54.0f), R.drawable.attach_send);
            ...
            chat_directOtherIconDrawable = resources.getDrawable(R.drawable.direct_other);
            chat_directOtherDoneIconDrawable = resources.getDrawable(R.drawable.direct_other_done);
            chat_favMessageIconDrawable = resources.getDrawable(R.drawable.fav_msg);
            chat_favMessageDoneIconDrawable = resources.getDrawable(R.drawable.fav_msg_done);
            chat_saveToCloudIconDrawable = resources.getDrawable(R.drawable.save_cloud);
            ...
            setTickStyle(resources);
            setBubbleStyle(resources);
    ...
    public static void applyChatTheme(boolean fontsOnly) {
        if (chat_msgTextPaint != null && chat_msgInDrawable != null && !fontsOnly) {
            ...
            setDrawableColorByKey(chat_directOtherIconDrawable, key_chat_serviceIcon);
            setDrawableColorByKey(chat_favMessageIconDrawable, key_chat_serviceIcon);
            setDrawableColorByKey(chat_saveToCloudIconDrawable, key_chat_serviceIcon);
            ...
            setCombinedDrawableColor(chat_attachButtonDrawables[9], getColor(key_chat_attachHideBackground), false);
            setCombinedDrawableColor(chat_attachButtonDrawables[9], getColor(key_chat_attachHideIcon), true);
            setCombinedDrawableColor(chat_attachButtonDrawables[10], getColor(key_chat_attachSendBackground), false);
            setCombinedDrawableColor(chat_attachButtonDrawables[10], getColor(key_chat_attachSendIcon), true);
    ...
    public static void createProfileResources(Context context) {
        if (profile_verifiedDrawable == null) {
            ...
            profile_aboutTextPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
            Resources resources = context.getResources();
    ...
    public static void nightMode() {
        Theme$ThemeInfo currentTheme = getCurrentTheme();
        Theme$ThemeInfo dayTheme = (Theme$ThemeInfo) themesDict.get(TurboConfig.dayTheme);
        Theme$ThemeInfo nightTheme = (Theme$ThemeInfo) themesDict.get(TurboConfig.nightTheme);
        Theme$ThemeInfo defaultDayTheme = (Theme$ThemeInfo) themesDict.get("Default");
        Theme$ThemeInfo defaultNightTheme = (Theme$ThemeInfo) themesDict.get("Dark");
        if (currentTheme != nightTheme) {
            TurboConfig.setBooleanValue("day_bg_override", ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).getBoolean("overrideThemeWallpaper", false));
            TurboConfig.setStringValue("day_theme", currentTheme.name);
            if (nightTheme == null) {
                applyTheme(defaultNightTheme, true, false, false);
                return;
            } else {
                applyTheme(nightTheme, true, false, false);
                return;
            }
        }
        Editor editor = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).edit();
        editor.putBoolean("overrideThemeWallpaper", TurboConfig.dayBgOverride);
        editor.commit();
        TurboConfig.removeValue("day_theme");
        TurboConfig.removeValue("day_bg_override");
        if (dayTheme == null) {
            applyTheme(defaultDayTheme, true, false, false);
        } else {
            applyTheme(dayTheme, true, false, false);
        }
    }

    public static void reloadChatWallpaper(long dialog_id) {
        chatWallpapers.remove(Long.valueOf(dialog_id));
        loadChatWallpapers();
    }

    public static Drawable getCachedChatWallpaper(long dialog_id) {
        Drawable drawable;
        synchronized (wallpaperSync) {
            drawable = (Drawable) chatWallpapers.get(Long.valueOf(dialog_id));
        }
        return drawable;
    }

    public static void loadChatWallpapers() {
        ArrayList<Long> wallpapers = new ArrayList();
        DBHelper dbHelper = new DBHelper(ApplicationLoader.applicationContext);
        dbHelper.open();
        try {
            wallpapers.addAll(dbHelper.getAllWallpapers());
            Utilities.searchQueue.postRunnable(new Theme$8(wallpapers));
        } finally {
            dbHelper.close();
        }
    }

    public static void setBubbleStyle(Resources resources) {
        String bubbleStyle = TurboConfig.turboBubbleStyle;
        if (bubbleStyle.equals("Telegram")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out).mutate();
            ...
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo).mutate();
        } else if (bubbleStyle.equals("iOS")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_2).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_2).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_2).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_2).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_2).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_2).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_2).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_2).mutate();
        } else if (bubbleStyle.equals("Telegram_Old")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_3).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_3).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_3).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_3).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_3).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_3).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_3).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_3).mutate();
        } else if (bubbleStyle.equals("Hangout")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_4).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_4).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_4).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_4).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_4).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_4).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_4).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_4).mutate();
        } else if (bubbleStyle.equals("Notepad")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_5).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_5).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_5).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_5).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_in_5).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_in_5).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_out_5).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_out_5).mutate();
        } else if (bubbleStyle.equals("Lex")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_6).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_6).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_6).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_6).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_6).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_6).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_6).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_6).mutate();
        } else if (bubbleStyle.equals("OvaLex")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_7).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_7).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_7).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_7).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_7).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_7).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_7).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_7).mutate();
        } else if (bubbleStyle.equals("LineFineLex")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_8).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_8).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_8).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_8).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_8).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_8).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_8).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_8).mutate();
        } else if (bubbleStyle.equals("PictuLineLex")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_9).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_9).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_9).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_9).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_9).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_9).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_9).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_9).mutate();
        } else if (bubbleStyle.equals("Ed")) {
            chat_msgInDrawable = resources.getDrawable(R.drawable.msg_in_10).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(R.drawable.msg_in_10).mutate();
            chat_msgOutDrawable = resources.getDrawable(R.drawable.msg_out_10).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(R.drawable.msg_out_10).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(R.drawable.msg_photo_10).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_10).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(R.drawable.msg_photo_10).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(R.drawable.msg_photo_10).mutate();
        }
    }

    public static void setTickStyle(Resources resources) {
        String tickStyle = TurboConfig.turboCheckStyle;
        if (tickStyle.equals("Stock")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check).mutate();
            ...
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck).mutate();
        } else if (tickStyle.equals("EdCheck")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_2).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_2).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_2).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_2).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_2).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_2).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_2).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_2).mutate();
        } else if (tickStyle.equals("Lex")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_3).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_3).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_3).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_3).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_3).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_3).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_3).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_3).mutate();
        } else if (tickStyle.equals("Gladiator")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_4).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_4).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_4).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_4).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_4).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_4).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_4).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_4).mutate();
        } else if (tickStyle.equals("MaxChecks")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_5).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_5).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_5).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_5).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_5).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_5).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_5).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_5).mutate();
        } else if (tickStyle.equals("ElipLex")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_6).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_6).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_6).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_6).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_6).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_6).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_6).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_6).mutate();
        } else if (tickStyle.equals("CubeLex")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_7).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_7).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_7).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_7).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_7).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_7).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_7).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_7).mutate();
        } else if (tickStyle.equals("MaxLines")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_8).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_8).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_8).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_8).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_8).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_8).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_8).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_8).mutate();
        } else if (tickStyle.equals("RLex")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_9).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_9).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_9).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_9).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_9).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_9).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_9).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_9).mutate();
        } else if (tickStyle.equals("MaxLinesPro")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_10).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_10).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_10).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_10).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_10).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_10).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_10).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_10).mutate();
        } else if (tickStyle.equals("ReadLex")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_11).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_11).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_11).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_11).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_11).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_11).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_11).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_11).mutate();
        } else if (tickStyle.equals("MaxHeart")) {
            chat_msgOutCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_12).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_check_w_12).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_12).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(R.drawable.msg_check_w_12).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_12).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_12).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_12).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(R.drawable.msg_halfcheck_w_12).mutate();
        }
    }
}
