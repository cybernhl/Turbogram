...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    class C10051 extends AnimatorListenerAdapter {
        C10051() {
        }
    ...
    class C10062 extends AnimatorListenerAdapter {
        C10062() {
        }
    ...
    public void openDrawer(boolean fast) {
        if (this.allowOpenDrawer) {
            ...
            animatorSet.addListener(new C10051());
            animatorSet.start();
    ...
    public void closeDrawer(boolean fast) {
        ...
        animatorSet.addListener(new C10062());
        animatorSet.start();
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (!this.drawerOpened || ev == null || ev.getX() <= this.drawerPosition || this.startedTracking) {
            if (this.allowOpenDrawer && this.parentActionBarLayout.fragmentsStack.size() == 1) {
                ...
                } else if (TurboConfig$Tabs.swipeTabs && ((int) ev.getX()) > 100 && !this.drawerOpened) {
                    return false;
                } else {
