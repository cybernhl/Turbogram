...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C21713 extends ViewOutlineProvider {
        C21713() {
        }
    ...
    class C21735 implements OnPageChangeListener {
        C21735() {
        }
    ...
    class C21746 extends PagerAdapter {
        C21746() {
        }
    ...
    class C21768 implements OnClickListener {
        C21768() {
        }
    ...
    class C21779 implements OnClickListener {
        C21779() {
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C21781 implements ChatMessageCellDelegate {
            C21781() {
            }
        ...
        class C21792 implements ChatActionCellDelegate {
            C21792() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            if (viewType == 0) {
                ...
                ((ChatMessageCell) view).setDelegate(new C21781());
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C21792());
            }
            view.setLayoutParams(new LayoutParams(-1, -2));
            return new Holder(view);
        }
    ...
    public View createView(Context context) {
        ...
        float f2;
        float f3;
        this.page1 = new SizeNotifierFrameLayout(context);
        this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C21691()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        this.page1.setBackgroundImage(Theme.getCachedWallpaper());
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C21713());
        }
        SizeNotifierFrameLayout sizeNotifierFrameLayout = this.page1;
        ...
        sizeNotifierFrameLayout.addView(view, LayoutHelper.createFrame(i2, f, i, f2, 0.0f, f3, 14.0f));
        ...
        viewPager.addOnPageChangeListener(new C21735());
        viewPager.setAdapter(new C21746());
        ...
        frameLayout.addView(viewPager, LayoutHelper.createFrame(-1, 3.0f, 83, 0.0f, 0.0f, 0.0f, 48.0f));
        ...
        cancelButton.setOnClickListener(new C21768());
        ...
        doneButton.setOnClickListener(new C21779());
