...
public class GroupCreateActivity extends BaseFragment implements OnClickListener, NotificationCenter$NotificationCenterDelegate {
    ...
    class C17551 extends ActionBarMenuOnItemClick {
        C17551() {
        }
    ...
    class C17584 implements OnClickListener {
        C17584() {
        }
    ...
    class C17606 implements Callback {
        C17606() {
        }
    ...
    class C17617 implements OnEditorActionListener {
        C17617() {
        }
    ...
    class C17628 implements OnKeyListener {
    ...
    class C17639 implements TextWatcher {
        C17639() {
        }
    ...
    public class GroupCreateAdapter extends FastScrollAdapter {
        ...
        public GroupCreateAdapter(Context ctx) {
            ...
            for (int a = 0; a < arrayList.size(); a++) {
                User user = MessagesController.getInstance(GroupCreateActivity.this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) arrayList.get(a)).user_id));
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C17661 implements Runnable {
                    ...
                    public void run() {
                        ...
                        Utilities.searchQueue.postRunnable(new C17651());
                    }
                }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        class C17691 extends AnimatorListenerAdapter {
            C17691() {
            }
        ...
        public void addSpan(GroupCreateSpan span) {
            ...
            this.currentAnimation.addListener(new C17691());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17551());
        ...
        this.spansContainer.setOnClickListener(new C17584());
        ...
        this.editText.setCustomSelectionActionModeCallback(new C17606());
        this.editText.setOnEditorActionListener(new C17617());
        this.editText.setOnKeyListener(new C17628());
        this.editText.addTextChangedListener(new C17639());
