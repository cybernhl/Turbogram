...
public class PhotoCropActivity extends BaseFragment {
    ...
    class C19811 extends ActionBarMenuOnItemClick {
        C19811() {
        }
    ...
    private class PhotoCropView extends FrameLayout {
        ...
        class C19821 implements OnTouchListener {
            C19821() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19811());
