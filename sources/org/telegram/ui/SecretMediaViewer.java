...
public class SecretMediaViewer implements OnDoubleTapListener, OnGestureListener, NotificationCenter$NotificationCenterDelegate {
    ...
    class C20931 implements VideoPlayerDelegate {
        C20931() {
        }
    ...
    class C20964 implements OnApplyWindowInsetsListener {
        C20964() {
        }
    ...
    class C20975 extends ActionBarMenuOnItemClick {
        C20975() {
        }
    ...
    class C20986 implements Runnable {
        C20986() {
        }
    ...
    class C20997 extends AnimatorListenerAdapter {
        C20997() {
        }
    ...
    class C21019 extends AnimatorListenerAdapter {
        C21019() {
        }
        ...
        private void updateParticles(long dt) {
            ...
            while (a < count) {
                ...
                if (particle.currentTime >= particle.lifeTime) {
                    ...
                    particle.f834x += ((particle.vx * particle.velocity) * ((float) dt)) / 500.0f;
                    particle.f835y += ((particle.vy * particle.velocity) * ((float) dt)) / 500.0f;
        ...
        protected void onDraw(Canvas canvas) {
            if (SecretMediaViewer.this.currentMessageObject != null && SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0) {
                ...
                if (!this.useVideoProgress) {
                    ...
                    if (duration == C0246C.TIME_UNSET || position == C0246C.TIME_UNSET) {
                        progress = 1.0f;
                    } else {
                ...
                for (a = 0; a < count; a++) {
                    ...
                    canvas.drawPoint(particle.f834x, particle.f835y, this.particlePaint);
                }
                ...
                for (a = 0; a < 1; a++) {
                    ...
                    newParticle.f834x = cx;
                    newParticle.f835y = cy;
    ...
    private void preparePlayer(File file) {
        if (this.parentActivity != null) {
            ...
            if (this.videoPlayer == null) {
                ...
                this.videoPlayer.setDelegate(new C20931());
            }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.containerView.setOnApplyWindowInsetsListener(new C20964());
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C20975());
    ...
    public void openMedia(MessageObject messageObject, PhotoViewerProvider provider) {
        if (this.parentActivity != null && messageObject != null && messageObject.needDrawBluredPreview() && provider != null) {
            ...
            if (object != null) {
                ...
                } else if (MessageObject.isGifDocument((TLRPC$Document) document)) {
                ...
                this.photoAnimationEndRunnable = new C20986();
                this.imageMoveAnimation.setDuration(250);
                this.imageMoveAnimation.addListener(new C20997());
    ...
    private void toggleActionBar(boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            if (!show) {
                this.currentActionBarAnimation.addListener(new C21019());
            }
        ...
        if (this.parentActivity != null && this.isPhotoVisible && !checkPhotoAnimation()) {
            ...
            if (animated) {
                ...
                this.imageMoveAnimation.addListener(new AnimatorListenerAdapter() {
                    ...
                    class C20921 implements Runnable {
                        C20921() {
                        }
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        AndroidUtilities.runOnUIThread(new C20921());
                    }
                });
                this.photoTransitionAnimationStartTime = System.currentTimeMillis();
                if (VERSION.SDK_INT >= 18) {
