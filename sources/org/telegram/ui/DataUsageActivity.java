...
public class DataUsageActivity extends BaseFragment {
    ...
    class C17281 extends ActionBarMenuOnItemClick {
        C17281() {
        }
    ...
    class C17302 implements OnItemClickListener {
        ...
        public void onItemClick(View view, int position) {
            if (DataUsageActivity.this.getParentActivity() != null && position == DataUsageActivity.this.resetRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("Reset", R.string.Reset), new C17291());
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 3:
                    ...
                    cell.setText(LocaleController.formatString("NetworkUsageSince", R.string.NetworkUsageSince, new Object[]{LocaleController.getInstance().formatterStats.format(StatsController.getInstance(DataUsageActivity.this.currentAccount).getResetStatsDate(DataUsageActivity.this.currentType))}));
                    return;
                default:
                    return;
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17281());
        ...
        this.listView.setOnItemClickListener(new C17302());
