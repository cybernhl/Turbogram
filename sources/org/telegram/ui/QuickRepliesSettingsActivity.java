...
public class QuickRepliesSettingsActivity extends BaseFragment {
    ...
    class C20851 extends ActionBarMenuOnItemClick {
        C20851() {
        }
    ...
    class C20862 implements OnItemClickListener {
        C20862() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20851());
        ...
        this.listView.setOnItemClickListener(new C20862());
