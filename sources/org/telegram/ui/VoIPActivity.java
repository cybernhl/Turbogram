...
public class VoIPActivity extends Activity implements NotificationCenter$NotificationCenterDelegate, StateListener {
    ...
    class C21841 implements ImageReceiverDelegate {
        C21841() {
        }
    ...
    class C21882 implements OnClickListener {
    ...
    class C21953 implements OnClickListener {

        /* renamed from: org.telegram.ui.VoIPActivity$3$1 */
        class C21891 implements Runnable {
            C21891() {
            }
        ...
        public void onClick(View v) {
            ...
            if (VoIPActivity.this.retrying) {
                ...
                VoIPActivity.this.endBtn.postDelayed(new C21891(), 100);
            } else if (VoIPService.getSharedInstance() != null) {
    ...
    class C21964 implements OnClickListener {
        C21964() {
        }
    ...
    class C21975 implements OnClickListener {
        C21975() {
        }
    ...
    class C21986 implements OnClickListener {
        C21986() {
        }
    ...
    class C22017 implements Listener {

        /* renamed from: org.telegram.ui.VoIPActivity$7$1 */
        class C21991 extends AnimatorListenerAdapter {
            C21991() {
            }
        ...
        class C22002 extends AnimatorListenerAdapter {
            C22002() {
            }
    ...
    class C22048 implements Listener {

        /* renamed from: org.telegram.ui.VoIPActivity$8$1 */
        class C22021 extends AnimatorListenerAdapter {
            C22021() {
            }
        ...
        class C22032 extends AnimatorListenerAdapter {
            C22032() {
            }
    ...
    class C22059 implements OnClickListener {
        C22059() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.user.photo != null) {
            this.photoView.getImageReceiver().setDelegate(new C21841());
        ...
        this.nameText.setOnClickListener(new C21882());
        this.endBtn.setOnClickListener(new C21953());
        this.spkToggle.setOnClickListener(new C21964());
        this.micToggle.setOnClickListener(new C21975());
        this.chatBtn.setOnClickListener(new C21986());
        ...
        this.acceptSwipe.setListener(new C22017());
        this.declineSwipe.setListener(new C22048());
        this.cancelBtn.setOnClickListener(new C22059());
    ...
    private View createContentView() {
        ...
        this.emojiWrap.setOnLongClickListener(new OnLongClickListener() {
            ...
            class C21821 implements Runnable {
                C21821() {
                }
            ...
            public boolean onLongClick(View v) {
                ...
                if (VoIPActivity.this.emojiTooltipVisible) {
                    VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C21821(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                }
                return true;
            }
        });
        ...
        this.ellAnimator.addListener(new AnimatorListenerAdapter() {
            private Runnable restarter = new C21831();

            /* renamed from: org.telegram.ui.VoIPActivity$14$1 */
            class C21831 implements Runnable {
                C21831() {
                }
    ...
    public void onStateChanged(final int state) {
        ...
        runOnUiThread(new Runnable() {
            ...
            class C21862 implements Runnable {
                C21862() {
                }
            ...
            class C21873 implements Runnable {
                C21873() {
                }
            ...
            public void run() {
                ...
                if (VoIPActivity.this.firstStateChange) {
                    ...
                    if (VoIPActivity.this.isIncomingWaiting = state == 15) {
                        ...
                        if (UserConfig.getActivatedAccountsCount() > 1) {
                            ...
                            VoIPActivity.this.accountNameText.setText(LocaleController.formatString("VoipAnsweringAsAccount", R.string.VoipAnsweringAsAccount, new Object[]{ContactsController.formatName(self.first_name, self.last_name)}));
                        } else {
                            VoIPActivity.this.accountNameText.setVisibility(8);
                        }
                ...
                if (state == 15) {
                    ...
                    VoIPActivity.this.stateText.postDelayed(new C21851(), 200);
                } else if (state == 17) {
                    ...
                    if (!wasFirstStateChange && state == 3) {
                        ...
                        if (count < 3) {
                            ...
                            VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C21862(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                    ...
                    if (lastError == 1) {
                        ...
                        VoIPActivity.this.stateText.postDelayed(new C21873(), 1000);
                    }
                }
    ...
    private void updateBlurredPhotos(final BitmapHolder src) {
        new Thread(new Runnable() {
            ...
            class C21901 implements Runnable {
                C21901() {
                }
            ...
            public void run() {
                try {
                    ...
                    VoIPActivity.this.runOnUiThread(new C21901());
                } catch (Throwable th) {
                }
            }
        }).start();
    ...
    private void showMessagesSheet() {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            class C21921 implements Runnable {
                C21921() {
                }
            ...
            public void onClick(View v) {
                if (field.length() != 0) {
                    bottomSheet2.dismiss();
                    if (VoIPService.getSharedInstance() != null) {
                        VoIPService.getSharedInstance().declineIncomingCall(4, new C21921());
                    }
                }
            }
        });
        ...
        field.addTextChangedListener(new TextWatcher() {
            ...
            class C21942 implements Runnable {
                C21942() {
                }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (this.prevState != hasText) {
                    ...
                    if (hasText) {
                        ...
                        cancelBtn.animate().alpha(0.0f).scaleX(0.1f).scaleY(0.1f).setInterpolator(CubicBezierInterpolator.DEFAULT).setDuration(200).withEndAction(new C21931()).start();
                        return;
                    }
                    ...
                    view.animate().alpha(0.0f).scaleX(LocaleController.isRTL ? -0.1f : 0.1f).scaleY(0.1f).setInterpolator(CubicBezierInterpolator.DEFAULT).setDuration(200).withEndAction(new C21942()).start();
                }
            }
        });
        editor.setVisibility(8);
