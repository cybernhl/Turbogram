...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    class C12051 extends ActionBarMenuOnItemClick {
        C12051() {
        }
    ...
    class C12062 implements OnTouchListener {
        C12062() {
        }
    ...
    class C12083 implements OnClickListener {
        ...
        class C12071 implements DialogInterface.OnClickListener {
            C12071() {
            }
        ...
        public void onClick(View v) {
            if (ChangePhoneHelpActivity.this.getParentActivity() != null) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C12071());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12051());
        this.fragmentView = new RelativeLayout(context);
        this.fragmentView.setOnTouchListener(new C12062());
        ...
        this.textView2.setOnClickListener(new C12083());
