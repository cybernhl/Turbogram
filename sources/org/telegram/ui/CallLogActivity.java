...
public class CallLogActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    private OnClickListener callBtnClickListener = new C10871();
    ...
    class C10882 extends ActionBarMenuOnItemClick {
        C10882() {
        }
    ...
    class C10893 implements OnItemClickListener {
        C10893() {
        }
    ...
    class C10914 implements OnItemLongClickListener {
        C10914() {
        }
    ...
    class C10935 extends OnScrollListener {
        C10935() {
        }
    ...
    class C10946 extends ViewOutlineProvider {
        C10946() {
        }
    ...
    class C10967 implements OnClickListener {

        /* renamed from: org.telegram.ui.CallLogActivity$7$1 */
        class C10951 implements ContactsActivityDelegate {
            C10951() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C10882());
        ...
        this.listView.setOnItemClickListener(new C10893());
        this.listView.setOnItemLongClickListener(new C10914());
        this.listView.setOnScrollListener(new C10935());
        if (this.loading) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C10946());
        }
        ...
        this.floatingButton.setOnClickListener(new C10967());
    ...
    private void getCalls(int max_id, int count) {
        if (!this.loading) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C10988(), 2), this.classGuid);
        }
    }
