...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C19721 extends ActionBarMenuOnItemClick {
        C19721() {
        }
    ...
    class C19732 implements OnTouchListener {
        C19732() {
        }
    ...
    class C19765 implements OnPreDrawListener {
        C19765() {
        }
    ...
    class C19776 implements PhotoPickerActivityDelegate {
        C19776() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C19791 implements PhotoPickerAlbumsCellDelegate {
            C19791() {
            }
        ...
        class C19802 implements PhotoPickerSearchCellDelegate {
            C19802() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19721());
        ...
        this.emptyView.setOnTouchListener(new C19732());
        ...
        this.pickerBottomLayout.cancelButton.setOnClickListener(new C19743());
        this.pickerBottomLayout.doneButton.setOnClickListener(new C19754());
    ...
    private void fixLayout() {
        if (this.listView != null) {
            this.listView.getViewTreeObserver().addOnPreDrawListener(new C19765());
        }
    }
    ...
    private void openPhotoPicker(MediaController$AlbumEntry albumEntry, int type) {
        ...
        if (albumEntry != null) {
            ...
            fragment.setDelegate(new C19776());
        } else {
