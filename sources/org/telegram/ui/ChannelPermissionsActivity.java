...
public class ChannelPermissionsActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C12761 extends ActionBarMenuOnItemClick {
        C12761() {
        }
    ...
    class C12783 implements OnItemClickListener {
        C12783() {
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (view instanceof TextCheckCell2) {
                ...
                if (checkCell.isEnabled()) {
                    ...
                    TLRPC$TL_channelAdminRights access$600;
    ...
    class C12794 implements OnClickListener {
        C12794() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12761());
        ...
        this.listView.setOnItemClickListener(new C12783());
        ...
        this.radioButtonCell3.setOnClickListener(new C12794());
        ...
        this.radioButtonCell4.setOnClickListener(new C12805());
