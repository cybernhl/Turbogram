...
public class WallpapersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C22081 implements WallpaperUpdaterDelegate {
        C22081() {
        }
    ...
    class C22103 implements OnTouchListener {
        C22103() {
        }
    ...
    class C22114 implements OnItemClickListener {
        C22114() {
        }
    ...
    class C22135 implements RequestDelegate {
        C22135() {
        }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            WallpapersActivity.this.wallpappersByIds.put(((TLRPC$WallPaper) obj).id, (TLRPC$WallPaper) obj);
                        }
    ...
    public void setCustomChat(long did) {
        this.dialog_id = did;
    }
    ...
    public View createView(final Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), new C22081());
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBarMenuOnItemClick() {
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    boolean done;
                    TLRPC$WallPaper wallPaper = (TLRPC$WallPaper) WallpapersActivity.this.wallpappersByIds.get(WallpapersActivity.this.selectedBackground);
                    File toFile;
                    if (wallPaper != null && wallPaper.id != 1000001 && (wallPaper instanceof TLRPC$TL_wallPaper)) {
                        ...
                        FileLoader.getInstance(WallpapersActivity.this.currentAccount);
                        File f = new File(FileLoader.getDirectory(4), fileName);
                        if (WallpapersActivity.this.dialog_id == 0) {
                            toFile = new File(ApplicationLoader.getFilesDirFixed(), "wallpaper.jpg");
                        } else {
                            toFile = new File(ApplicationLoader.getFilesDirFixed(), "wallpaper" + WallpapersActivity.this.dialog_id + ".jpg");
                        }
                        try {
                        ...
                        File fromFile = WallpapersActivity.this.updater.getCurrentWallpaperPath();
                        if (WallpapersActivity.this.dialog_id == 0) {
                            toFile = new File(ApplicationLoader.getFilesDirFixed(), "wallpaper.jpg");
                        } else {
                            toFile = new File(ApplicationLoader.getFilesDirFixed(), "wallpaper" + WallpapersActivity.this.dialog_id + ".jpg");
                    ...
                    if (done) {
                        ...
                        if (WallpapersActivity.this.dialog_id == 0) {
                            ...
                            z = Theme.hasWallpaperFromTheme() && WallpapersActivity.this.overrideThemeWallpaper;
                            editor.putBoolean(str, z);
                            editor.commit();
                            Theme.reloadWallpaper();
                        } else {
                            editor = TurboConfig.getTurboConfigPreferences().edit();
                            editor.putInt("selectedBackground" + WallpapersActivity.this.dialog_id, WallpapersActivity.this.selectedBackground);
                            editor.putInt("selectedColor" + WallpapersActivity.this.dialog_id, WallpapersActivity.this.selectedColor);
                            str = "overrideThemeWallpaper" + WallpapersActivity.this.dialog_id;
                            z = Theme.hasWallpaperFromTheme() && WallpapersActivity.this.overrideThemeWallpaper;
                            editor.putBoolean(str, z);
                            editor.commit();
                            ...
                            dbHelper.open();
                            try {
                                dbHelper.addWallpaper(WallpapersActivity.this.dialog_id);
                                Theme.reloadChatWallpaper(WallpapersActivity.this.dialog_id);
                            } finally {
                                dbHelper.close();
                            }
                        }
        ...
        this.backgroundImage.setOnTouchListener(new C22103());
        ...
        this.listView.setOnItemClickListener(new C22114());
    ...
    private void processSelectedBackground() {
        if (!Theme.hasWallpaperFromTheme() || this.overrideThemeWallpaper) {
            TLRPC$WallPaper wallPaper = (TLRPC$WallPaper) this.wallpappersByIds.get(this.selectedBackground);
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getWallPapers(), new C22135()), this.classGuid);
    }
