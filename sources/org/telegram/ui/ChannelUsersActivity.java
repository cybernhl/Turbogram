...
public class ChannelUsersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C12922 extends ActionBarMenuItemSearchListener {
        C12922() {
        }
    ...
    class C12933 extends OnScrollListener {
        C12933() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    view = new ManageChatUserCell(this.mContext, ChannelUsersActivity.this.type == 0 ? 8 : 1, true);
        ...
        final /* synthetic */ boolean lambda$onCreateViewHolder$0$ChannelUsersActivity$ListAdapter(ManageChatUserCell cell, boolean click) {
            boolean z;
            TLRPC$ChannelParticipant participant = ChannelUsersActivity.this.listViewAdapter.getItem(((Integer) cell.getTag()).intValue());
            ...
            channelUsersActivity.createMenuForParticipant(participant, z);
            if (participant.user_id == UserConfig.getInstance(ChannelUsersActivity.this.currentAccount).getClientUserId()) {
                return false;
            }
            return true;
        }
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (ChannelUsersActivity.this.type == 0) {
                        role = null;
                        if ((participant instanceof TLRPC$TL_channelParticipantBanned) && MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(participant.kicked_by)) != null) {
                            role = LocaleController.formatString("UserRestrictionsBy", R.string.UserRestrictionsBy, new Object[]{ContactsController.formatName(MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(participant.kicked_by)).first_name, MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(participant.kicked_by)).last_name)});
                        }
                        ...
                        } else if ((participant instanceof TLRPC$TL_channelParticipantAdmin) && MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(participant.promoted_by)) != null) {
    ...
    private class SearchAdapter extends SelectionAdapter {
        ...
        final /* synthetic */ void lambda$null$0$ChannelUsersActivity$SearchAdapter(String query, ArrayList contactsCopy) {
            ...
            for (int a = 0; a < contactsCopy.size(); a++) {
                User user = MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) contactsCopy.get(a)).user_id));
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    view = new ManageChatUserCell(this.mContext, 2, true);
                    view.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (object instanceof User) {
                        ...
                        user = MessagesController.getInstance(ChannelUsersActivity.this.currentAccount).getUser(Integer.valueOf(((TLRPC$ChannelParticipant) object).user_id));
                    }
    ...
    public View createView(Context context) {
        ...
        if (this.selectType != 0 || this.type == 2 || this.type == 0) {
            ...
            this.searchItem = this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C12922());
        ...
        if (this.searchItem != null) {
            this.listView.setOnScrollListener(new C12933());
        }
        ...
        if (position == this.addNewRow) {
            ...
            if (this.listView.getAdapter() == this.listViewAdapter) {
                ...
                if (object instanceof User) {
                    ...
                    user_id = user.id;
                    participant = (TLRPC$ChannelParticipant) sparseArray.get(user_id);
    ...
    final /* synthetic */ void lambda$null$1$ChannelUsersActivity(TLRPC$ChannelParticipant participant, int rights, TLRPC$TL_channelAdminRights rightsAdmin, TLRPC$TL_channelBannedRights rightsBanned) {
        if (participant != null) {
            participant.admin_rights = rightsAdmin;
            participant.banned_rights = rightsBanned;
            TLRPC$ChannelParticipant p = (TLRPC$ChannelParticipant) this.participantsMap.get(participant.user_id);
            if (p != null) {
    ...
    final /* synthetic */ void lambda$null$2$ChannelUsersActivity(TLRPC$ChannelParticipant participant, int rights, TLRPC$TL_channelAdminRights rightsAdmin, TLRPC$TL_channelBannedRights rightsBanned) {
        if (participant != null) {
            participant.admin_rights = rightsAdmin;
            participant.banned_rights = rightsBanned;
            TLRPC$ChannelParticipant p = (TLRPC$ChannelParticipant) this.participantsMap.get(participant.user_id);
    ...
    private boolean createMenuForParticipant(TLRPC$ChannelParticipant participant, boolean resultOnly) {
    ...
    final /* synthetic */ void lambda$createMenuForParticipant$6$ChannelUsersActivity(ArrayList actions, User user, TLRPC$ChannelParticipant participant, DialogInterface dialogInterface, int i) {
        if (((Integer) actions.get(i)).intValue() == 3) {
            Bundle args = new Bundle();
            args.putInt("chat_id", this.chatId);
            args.putInt("group_userId", user.id);
            ...
            for (int a = 0; a < this.participants.size(); a++) {
                if (((TLRPC$ChannelParticipant) this.participants.get(a)).user_id == participant.user_id) {
    ...
    final /* synthetic */ void lambda$null$5$ChannelUsersActivity(ArrayList actions, int i, TLRPC$ChannelParticipant participant, int rights, TLRPC$TL_channelAdminRights rightsAdmin, TLRPC$TL_channelBannedRights rightsBanned) {
        int a;
    ...
    final /* synthetic */ void lambda$createMenuForParticipant$9$ChannelUsersActivity(TLRPC$ChannelParticipant participant, DialogInterface dialogInterface, int i) {
        if (i != 0) {
            return;
        }
        if (this.type == 0) {
            ...
            MessagesController.getInstance(this.currentAccount).setUserAdminRole(this.chatId, MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(participant.user_id)), new TLRPC$TL_channelAdminRights(), this.currentChat.megagroup, this);
        } else if (this.type == 2) {
    ...
    final /* synthetic */ void lambda$null$8$ChannelUsersActivity(TLObject response, TLRPC$TL_error error) {
        if (response != null) {
    ...
    final /* synthetic */ void lambda$null$7$ChannelUsersActivity(TLRPC$Updates updates) {
    ...
    final /* synthetic */ void lambda$getChannelParticipants$14$ChannelUsersActivity(boolean byEndReached, TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new ChannelUsersActivity$$Lambda$7(this, error, response, byEndReached));
    }

    final /* synthetic */ void lambda$null$13$ChannelUsersActivity(TLRPC$TL_error error, TLObject response, boolean byEndReached) {
        boolean changeFirst;
        if (this.firstLoaded) {
            changeFirst = false;
        } else {
    ...
    final /* synthetic */ int lambda$null$11$ChannelUsersActivity(TLRPC$ChannelParticipant lhs, TLRPC$ChannelParticipant rhs) {
    ...
    final /* synthetic */ int lambda$null$12$ChannelUsersActivity(TLRPC$ChannelParticipant lhs, TLRPC$ChannelParticipant rhs) {
