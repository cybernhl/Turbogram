...
public class PhonebookSelectActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C19532 extends ActionBarMenuItemSearchListener {
        C19532() {
        }
    ...
    class C19586 implements OnItemClickListener {

        /* renamed from: org.telegram.ui.PhonebookSelectActivity$6$1 */
        class C19571 implements PhonebookSelectActivityDelegate {
            C19571() {
            }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (object != null) {
                ...
                activity.setDelegate(new C19571());
    ...
    class C19597 extends OnScrollListener {
        C19597() {
        }
    ...
    class C19608 implements ThemeDescriptionDelegate {
        C19608() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C19532()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        this.listView.setOnItemClickListener(new C19586());
        this.listView.setOnScrollListener(new C19597());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C19608();
