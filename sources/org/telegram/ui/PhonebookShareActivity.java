...
public class PhonebookShareActivity extends BaseFragment {
    ...
    class C19654 implements OnItemClickListener {
        C19654() {
        }
    ...
    class C19675 implements OnItemLongClickListener {
        C19675() {
        }
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        try {
                            ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("label", item.getValue(false)));
                            if (item.type == 0) {
                                Toast.makeText(PhonebookShareActivity.this.getParentActivity(), LocaleController.getString("PhoneCopied", R.string.PhoneCopied), 0).show();
                            } else if (item.type == 1) {
                                Toast.makeText(PhonebookShareActivity.this.getParentActivity(), LocaleController.getString("EmailCopied", R.string.EmailCopied), 0).show();
                            } else if (item.type == 3) {
    ...
    class C19686 extends OnScrollListener {
        C19686() {
        }
    ...
    class C19707 implements View.OnClickListener {

        /* renamed from: org.telegram.ui.PhonebookShareActivity$7$1 */
        class C19691 implements OnClickListener {
            C19691() {
            }
        ...
        public void onClick(View v) {
            if (!PhonebookShareActivity.this.isImport) {
                ...
                builder2.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", R.string.AddToExistingContact)}, new C19691());
                builder2.show();
            }
        }
    }
    ...
    class C19718 implements OnPreDrawListener {
        C19718() {
        }
    ...
    public View createView(Context context) {
        ...
        LayoutManager c19633 = new LinearLayoutManager(context, 1, false) {
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }
        };
        this.layoutManager = c19633;
        recyclerListView.setLayoutManager(c19633);
        ...
        this.listView.setOnItemClickListener(new C19654());
        this.listView.setOnItemLongClickListener(new C19675());
        ...
        needLayout();
        this.listView.setOnScrollListener(new C19686());
        ...
        this.bottomLayout.setOnClickListener(new C19707());
    ...
    private void fixLayout() {
        if (this.fragmentView != null) {
            this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C19718());
        }
    }
