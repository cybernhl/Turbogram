...
public class DialogsEmptyCell extends LinearLayout {
    ...
    class C11221 implements OnTouchListener {
        C11221() {
        }
    ...
    public DialogsEmptyCell(Context context) {
        ...
        this.emptyTextView1.setTypeface(TurboUtils.getTurboTypeFace());
        this.emptyTextView2.setTypeface(TurboUtils.getTurboTypeFace());
    }
