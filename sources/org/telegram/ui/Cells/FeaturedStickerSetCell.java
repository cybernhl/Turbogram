...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C11273 extends AnimatorListenerAdapter {
        C11273() {
        }
    ...
    class C11284 extends AnimatorListenerAdapter {
        C11284() {
        }
    ...
    public FeaturedStickerSetCell(Context context) {
        ...
        this.addButton.setTypeface(TurboUtils.getTurboTypeFace());
    }
    ...
    public void setStickersSet(TLRPC$StickerSetCovered set, boolean divider, boolean unread) {
        ...
        } else if (!(set.covers.isEmpty() || ((TLRPC$Document) set.covers.get(0)).thumb == null)) {
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C11273());
                ...
                this.currentAnimation.addListener(new C11284());
                this.currentAnimation.start();
                return;
            } else {
                return;
