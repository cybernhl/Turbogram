...
public class ContextLinkCell extends View implements DownloadController$FileDownloadProgressListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        TLRPC$TL_webDocument tLRPC$TL_webDocument = null;
        ...
        if (this.inlineResult != null) {
            if ((this.inlineResult.content instanceof TLRPC$TL_webDocument) && this.inlineResult.type != null) {
                if (this.inlineResult.type.startsWith("gif")) {
                    ...
                    tLRPC$TL_webDocument = this.inlineResult.thumb instanceof TLRPC$TL_webDocument ? (TLRPC$TL_webDocument) this.inlineResult.thumb : (TLRPC$TL_webDocument) this.inlineResult.content;
                }
            }
            if (tLRPC$TL_webDocument == null && (this.inlineResult.thumb instanceof TLRPC$TL_webDocument)) {
                tLRPC$TL_webDocument = (TLRPC$TL_webDocument) this.inlineResult.thumb;
            }
            if (tLRPC$TL_webDocument == null && this.currentPhotoObject == null && currentPhotoObjectThumb == null && ((this.inlineResult.send_message instanceof TLRPC$TL_botInlineMessageMediaVenue) || (this.inlineResult.send_message instanceof TLRPC$TL_botInlineMessageMediaGeo))) {
        ...
        if (this.documentAttach != null) {
            for (int b = 0; b < this.documentAttach.attributes.size(); b++) {
                TLRPC$DocumentAttribute attribute = (TLRPC$DocumentAttribute) this.documentAttach.attributes.get(b);
        ...
        if (w == 0 || h == 0) {
            if (this.currentPhotoObject != null) {
                ...
                w = this.currentPhotoObject.f794w;
                h = this.currentPhotoObject.f793h;
