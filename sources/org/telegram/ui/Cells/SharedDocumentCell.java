...
public class SharedDocumentCell extends FrameLayout implements DownloadController$FileDownloadProgressListener {
    ...
    class C11461 implements ImageReceiverDelegate {
        C11461() {
        }
    ...
    public SharedDocumentCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(40, 40.0f, i, f, 8.0f, f2, 0.0f));
        this.thumbImageView.getImageReceiver().setDelegate(new C11461());
        ...
        this.extTextView.setTypeface(TurboUtils.getTurboTypeFace());
        this.nameTextView.setTypeface(TurboUtils.getTurboTypeFace());
        this.dateTextView.setTypeface(TurboUtils.getTurboTypeFace());
    }
    ...
    public void setVoiceDocument(MessageObject messageObject, boolean divider) {
        setDocument(messageObject, divider);
        this.nameTextView.setText("Voice");
    }
