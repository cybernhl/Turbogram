...
public class ProxyListActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C20711 extends ActionBarMenuOnItemClick {
        C20711() {
        }
    ...
    class C20722 implements OnItemClickListener {
        C20722() {
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == ProxyListActivity.this.useProxyRow) {
                ...
                SharedConfig$ProxyInfo info = (SharedConfig$ProxyInfo) SharedConfig.proxyList.get(position - ProxyListActivity.this.proxyStartRow);
    ...
    class C20743 implements OnItemLongClickListener {
        C20743() {
        }
        ...
        public boolean onItemClick(View view, int position) {
            ...
            final SharedConfig$ProxyInfo info = (SharedConfig$ProxyInfo) SharedConfig.proxyList.get(position - ProxyListActivity.this.proxyStartRow);
            ...
            if (SharedConfig.currentProxy == this.currentInfo && this.this$0.useProxySettings) {
                if (this.this$0.currentConnectionState == 3 || this.this$0.currentConnectionState == 5) {
                    ...
                    if (this.currentInfo.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString("Connected", R.string.Connected) + ", " + LocaleController.formatString("Ping", R.string.Ping, new Object[]{Long.valueOf(this.currentInfo.ping)}));
                    } else {
                ...
                if (this.currentInfo.ping != 0) {
                    this.valueTextView.setText(LocaleController.getString("Available", R.string.Available) + ", " + LocaleController.formatString("Ping", R.string.Ping, new Object[]{Long.valueOf(this.currentInfo.ping)}));
                } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20711());
        ...
        this.listView.setOnItemClickListener(new C20722());
        this.listView.setOnItemLongClickListener(new C20743());
    ...
    private void checkProxyList() {
        ...
        for (int a = 0; a < count; a++) {
            final SharedConfig$ProxyInfo proxyInfo = (SharedConfig$ProxyInfo) SharedConfig.proxyList.get(a);
