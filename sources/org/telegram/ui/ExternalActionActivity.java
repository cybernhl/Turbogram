...
public class ExternalActionActivity extends Activity implements ActionBarLayoutDelegate {
    ...
    class C17481 implements OnGlobalLayoutListener {
        C17481() {
        }
    ...
    final /* synthetic */ void lambda$handleIntent$9$ExternalActionActivity(int[] requestId, int intentAccount, AlertDialog progressDialog, TLRPC$TL_account_getAuthorizationForm req, String payload, String nonce, TLObject response, TLRPC$TL_error error) {
        TLRPC$TL_account_authorizationForm authorizationForm = (TLRPC$TL_account_authorizationForm) response;
        if (authorizationForm != null) {
            requestId[0] = ConnectionsManager.getInstance(intentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new ExternalActionActivity$$Lambda$6(this, progressDialog, intentAccount, authorizationForm, req, payload, nonce));
            return;
        }
        AndroidUtilities.runOnUIThread(new ExternalActionActivity$$Lambda$7(this, progressDialog, error));
    }

    final /* synthetic */ void lambda$null$6$ExternalActionActivity(AlertDialog progressDialog, int intentAccount, TLRPC$TL_account_authorizationForm authorizationForm, TLRPC$TL_account_getAuthorizationForm req, String payload, String nonce, TLObject response1, TLRPC$TL_error error1) {
    ...
    final /* synthetic */ void lambda$null$5$ExternalActionActivity(AlertDialog progressDialog, TLObject response1, int intentAccount, TLRPC$TL_account_authorizationForm authorizationForm, TLRPC$TL_account_getAuthorizationForm req, String payload, String nonce) {
        try {
    ...
    final /* synthetic */ void lambda$null$8$ExternalActionActivity(AlertDialog progressDialog, TLRPC$TL_error error) {
        try {
            progressDialog.dismiss();
    ...
    final /* synthetic */ void lambda$null$7$ExternalActionActivity(TLRPC$TL_error error, DialogInterface dialog1) {
        setResult(1, new Intent().putExtra("error", error.text));
        finish();
    }
    ...
    public void fixLayout() {
        if (AndroidUtilities.isTablet() && this.actionBarLayout != null) {
            this.actionBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new C17481());
        }
    }
