...
final /* synthetic */ class ChannelEditActivity$$Lambda$6 implements ChannelRightsEditActivityDelegate {
    ...
    ChannelEditActivity$$Lambda$6(ChannelEditActivity channelEditActivity, TLRPC$ChannelParticipant tLRPC$ChannelParticipant, ArrayList arrayList, int i, TLRPC$TL_chatChannelParticipant tLRPC$TL_chatChannelParticipant, int i2) {
    ...
    public void didSetRights(int i, TLRPC$TL_channelAdminRights tLRPC$TL_channelAdminRights, TLRPC$TL_channelBannedRights tLRPC$TL_channelBannedRights) {
        this.arg$1.lambda$null$5$ChannelEditActivity(this.arg$2, this.arg$3, this.arg$4, this.arg$5, this.arg$6, i, tLRPC$TL_channelAdminRights, tLRPC$TL_channelBannedRights);
    }
}
