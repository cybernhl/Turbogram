...
public class EmbedBottomSheet extends BottomSheet {
    ...
    class C14071 implements OnShowListener {

        /* renamed from: org.telegram.ui.Components.EmbedBottomSheet$1$1 */
        class C14031 implements OnPreDrawListener {
            C14031() {
            }
        ...
        public void onShow(DialogInterface dialog) {
            if (EmbedBottomSheet.this.pipVideoView != null && EmbedBottomSheet.this.videoView.isInline()) {
                EmbedBottomSheet.this.videoView.getViewTreeObserver().addOnPreDrawListener(new C14031());
            }
        }
    }

    /* renamed from: org.telegram.ui.Components.EmbedBottomSheet$2 */
    class C14082 implements OnTouchListener {
        C14082() {
        }
    ...
    class C14093 implements OnTouchListener {
        C14093() {
        }
    ...
    class C14115 implements OnTouchListener {
        C14115() {
        }
    ...
    class C14137 extends WebChromeClient {
        C14137() {
        }
    ...
    class C14148 extends WebViewClient {
        C14148() {
        }
    ...
    class C14159 implements OnClickListener {
        C14159() {
        }
    ...
    private EmbedBottomSheet(Context context, String title, String description, String originalUrl, String url, int w, int h) {
        ...
        this.onShowListener = new C14071();
        this.fullWidth = true;
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new C14082());
        this.container.addView(this.fullscreenVideoContainer, LayoutHelper.createFrame(-1, -1.0f));
        this.fullscreenVideoContainer.setVisibility(4);
        this.fullscreenVideoContainer.setOnTouchListener(new C14093());
        ...
        this.containerLayout.setOnTouchListener(new C14115());
        ...
        this.webView.setWebChromeClient(new C14137());
        this.webView.setWebViewClient(new C14148());
        ...
        this.youtubeLogoImage.setOnClickListener(new C14159());
        this.videoView = new WebPlayerView(context, true, false, new WebPlayerViewDelegate() {
            ...
            class C14052 extends AnimatorListenerAdapter {
                C14052() {
                }
            ...
            public void prepareToSwitchInlineMode(boolean inline, Runnable switchInlineModeRunnable, float aspectRatio, boolean animated) {
                if (inline) {
                    ...
                    if (animated) {
                        ...
                        r9[2] = ObjectAnimator.ofFloat(textureImageView, "translationX", new float[]{rect.f830x});
                        r9[3] = ObjectAnimator.ofFloat(textureImageView, "translationY", new float[]{rect.f831y});
                        ...
                        r9[6] = ObjectAnimator.ofFloat(textureView, "translationX", new float[]{rect.f830x});
                        r9[7] = ObjectAnimator.ofFloat(textureView, "translationY", new float[]{rect.f831y});
                ...
                if (animated) {
                    ...
                    textureImageView.setTranslationX(rect.f830x);
                    textureImageView.setTranslationY(rect.f831y);
                    textureView.setScaleX(scale);
                    textureView.setScaleY(scale);
                    textureView.setTranslationX(rect.f830x);
                    textureView.setTranslationY(rect.f831y);
                } else {
            ...
            public TextureView onSwitchInlineMode(View controlsView, boolean inline, float aspectRatio, int rotation, boolean animated) {
                ...
                if (animated) {
                    ...
                    animatorSet.setInterpolator(new DecelerateInterpolator());
                    animatorSet.setDuration(250);
                    animatorSet.addListener(new C14052());
                    animatorSet.start();
                } else {
        ...
        boolean isFile = this.openUrl != null && this.openUrl.startsWith("file://");
        ...
        if (isFile) {
            this.imageButtonsContainer.setVisibility(8);
        }
        ...
        this.pipButton.setOnClickListener(new OnClickListener() {
            ...
            class C14061 extends AnimatorListenerAdapter {
                C14061() {
                }
            ...
            public void onClick(View v) {
                if (EmbedBottomSheet.this.checkInlinePermissions() && EmbedBottomSheet.this.progressBar.getVisibility() != 0) {
                    ...
                    if (false) {
                        ...
                        animatorSet.setInterpolator(new DecelerateInterpolator());
                        animatorSet.setDuration(250);
                        animatorSet.addListener(new C14061());
                        animatorSet.start();
                    } else {
                        EmbedBottomSheet.this.containerView.setTranslationY(0.0f);
                    }
