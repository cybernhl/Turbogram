...
public class JoinGroupAlert extends BottomSheet {
    ...
    class C14781 implements OnClickListener {
        C14781() {
        }
        ...
        public void onClick(View v) {
            ...
            ConnectionsManager.getInstance(JoinGroupAlert.this.currentAccount).sendRequest(req, new RequestDelegate() {
                public void run(final TLObject response, final TLRPC$TL_error error) {
                    if (error == null) {
                        MessagesController.getInstance(JoinGroupAlert.this.currentAccount).processUpdates((TLRPC$Updates) response, false);
                    }
    ...
    public JoinGroupAlert(Context context, TLRPC$ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C14781());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C14812());
    }
}
