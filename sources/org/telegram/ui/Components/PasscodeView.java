...
public class PasscodeView extends FrameLayout {
    ...
    private Runnable checkRunnable = new C15209();
    ...
    class C15121 implements OnEditorActionListener {
        C15121() {
        }
    ...
    class C15132 implements TextWatcher {
        C15132() {
        }
    ...
    class C15143 implements Callback {
        C15143() {
        }
    ...
    class C15154 implements OnClickListener {
        C15154() {
        }
    ...
    class C15165 implements OnLongClickListener {
        C15165() {
        }
    ...
    class C15176 implements OnClickListener {
        C15176() {
        }
        ...
        public void onClick(View v) {
            switch (((Integer) v.getTag()).intValue()) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    PasscodeView.this.passwordEditText2.appendCharacter(ExifInterface.GPS_MEASUREMENT_2D);
                    break;
                case 3:
                    PasscodeView.this.passwordEditText2.appendCharacter(ExifInterface.GPS_MEASUREMENT_3D);
                    break;
                case 4:
    ...
    class C15187 extends AnimatorListenerAdapter {
        C15187() {
        }
    ...
    class C15209 implements Runnable {
        C15209() {
        }
    ...
    private class AnimatingTextView extends FrameLayout {
        ...
        class C15232 extends AnimatorListenerAdapter {
            C15232() {
            }
        ...
        class C15243 extends AnimatorListenerAdapter {
            C15243() {
            }
        ...
        class C15254 extends AnimatorListenerAdapter {
            C15254() {
            }
        ...
        public void appendCharacter(String c) {
            if (this.stringBuilder.length() != 4) {
                ...
                this.dotRunnable = new Runnable() {
                    ...
                    class C15211 extends AnimatorListenerAdapter {
                        C15211() {
                        }
                    ...
                    public void run() {
                        if (AnimatingTextView.this.dotRunnable == this) {
                            ...
                            AnimatingTextView.this.currentAnimation.addListener(new C15211());
                ...
                this.currentAnimation.addListener(new C15232());
        ...
        public void eraseLastCharacter() {
            if (this.stringBuilder.length() != 0) {
                ...
                this.currentAnimation.setDuration(150);
                this.currentAnimation.playTogether(animators);
                this.currentAnimation.addListener(new C15243());
                this.currentAnimation.start();
            }
        }
        ...
        private void eraseAllCharacters(boolean animated) {
            if (this.stringBuilder.length() != 0) {
                ...
                if (animated) {
                    ...
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.playTogether(animators);
                    this.currentAnimation.addListener(new C15254());
                    this.currentAnimation.start();
                    return;
                }
                for (a = 0; a < 4; a++) {
    ...
    public PasscodeView(Context context) {
        ...
        this.passwordEditText.setOnEditorActionListener(new C15121());
        this.passwordEditText.addTextChangedListener(new C15132());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C15143());
        ...
        this.checkImage.setOnClickListener(new C15154());
        ...
        for (a = 0; a < 11; a++) {
            ...
            if (a == 10) {
                frameLayout.setOnLongClickListener(new C15165());
            }
            frameLayout.setOnClickListener(new C15176());
    ...
    private void processDone(boolean fingerprint) {
        ...
        AnimatorSet.addListener(new C15187());
        AnimatorSet.start();
    ...
    private void checkRetryTextView() {
        ...
        if (SharedConfig.passcodeRetryInMs > 0) {
            ...
            if (value != this.lastValue) {
                this.retryTextView.setText(LocaleController.formatString("TooManyTries", R.string.TooManyTries, new Object[]{LocaleController.formatPluralString("Seconds", value)}));
