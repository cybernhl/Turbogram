...
public class AlertsCreator {
    ...
    public static android.app.Dialog processError(int r7, org.telegram.tgnet.TLRPC$TL_error r8, org.telegram.ui.ActionBar.BaseFragment r9, org.telegram.tgnet.TLObject r10, java.lang.Object... r11) {
        /*
        r6 = 2131493373; // 0x7f0c01fd float:1.8610224E38 double:1.05309765E-314;
        r5 = 2131493647; // 0x7f0c030f float:1.861078E38 double:1.0530977853E-314;
        r2 = 1;
        r4 = 2131493757; // 0x7f0c037d float:1.8611003E38 double:1.0530978397E-314;
        r1 = 0;
        r0 = r8.code;
    ...
    L_0x002a:
        ...
        r1 = 2131493933; // 0x7f0c042d float:1.861136E38 double:1.0530979266E-314;
    ...
    L_0x005a:
        ...
        r1 = "UpdateAppAlert";
        r3 = 2131495317; // 0x7f0c0995 float:1.8614167E38 double:1.0530986104E-314;
    ...
    L_0x0123:
        r0 = "EditMessageError";
        r1 = 2131493596; // 0x7f0c02dc float:1.8610677E38 double:1.05309776E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleAlert(r9, r0);
        goto L_0x0037;
    L_0x0132:
    ...
    L_0x0199:
        ...
        r1 = 2131493971; // 0x7f0c0453 float:1.8611437E38 double:1.0530979454E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleAlert(r9, r0);
        goto L_0x0037;
    L_0x01a8:
        r0 = "JoinToGroupErrorNotExist";
        r1 = 2131493972; // 0x7f0c0454 float:1.861144E38 double:1.053097946E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleAlert(r9, r0);
        goto L_0x0037;
    L_0x01b7:
    ...
    L_0x0229:
        r0 = "InvalidCode";
        r1 = 2131493930; // 0x7f0c042a float:1.8611354E38 double:1.053097925E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
    ...
    L_0x0328:
        ...
        r1 = 2131493203; // 0x7f0c0153 float:1.860988E38 double:1.053097566E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        r0 = showSimpleAlert(r9, r0);
        goto L_0x0016;
    L_0x0338:
    ...
    L_0x0455:
        ...
        r4 = 2131493223; // 0x7f0c0167 float:1.860992E38 double:1.053097576E-314;
        r2 = new java.lang.Object[r2];
        r0 = r11[r1];
    ...
    L_0x04ab:
        r0 = "UsernameInvalid";
        r1 = 2131495387; // 0x7f0c09db float:1.861431E38 double:1.053098645E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleAlert(r9, r0);
        goto L_0x0037;
    L_0x04ba:
        r0 = "UsernameInUse";
        r1 = 2131495386; // 0x7f0c09da float:1.8614307E38 double:1.0530986445E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleAlert(r9, r0);
        goto L_0x0037;
    L_0x04c9:
    ...
    L_0x055f:
        ...
        r1 = 2131494619; // 0x7f0c06db float:1.8612752E38 double:1.0530982655E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleToast(r9, r0);
        goto L_0x0037;
    L_0x056e:
        r0 = "PaymentFailed";
        r1 = 2131494606; // 0x7f0c06ce float:1.8612725E38 double:1.053098259E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleToast(r9, r0);
        goto L_0x0037;
    L_0x057d:
    ...
    L_0x05a0:
        ...
        r1 = 2131494608; // 0x7f0c06d0 float:1.861273E38 double:1.05309826E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r0, r1);
        showSimpleToast(r9, r0);
        goto L_0x0037;
        */
    ...
    public static void showCustomNotificationsDialog(BaseFragment parentFragment, long did, int currentAccount, IntCallback callback) {
        if (parentFragment != null && parentFragment.getParentActivity() != null) {
            ...
            descriptions[2] = LocaleController.formatString("MuteFor", R.string.MuteFor, new Object[]{LocaleController.formatPluralString("Hours", 1)});
            descriptions[3] = LocaleController.formatString("MuteFor", R.string.MuteFor, new Object[]{LocaleController.formatPluralString("Days", 2)});
    ...
    static final /* synthetic */ void lambda$showCustomNotificationsDialog$1$AlertsCreator(int currentAccount, long did, BaseFragment parentFragment, IntCallback callback, View v) {
        ...
        if (i == 0 || i == 1) {
            ...
            editor.commit();
            dialog = (TLRPC$TL_dialog) MessagesController.getInstance(currentAccount).dialogs_dict.get(did);
            if (dialog != null) {
    ...
    static final /* synthetic */ void lambda$createMuteAlert$10$AlertsCreator(long dialog_id, DialogInterface dialogInterface, int i) {
        ...
        editor.commit();
        TLRPC$TL_dialog dialog = (TLRPC$TL_dialog) MessagesController.getInstance(UserConfig.selectedAccount).dialogs_dict.get(dialog_id);
        if (dialog != null) {
            dialog.notify_settings = new TLRPC$TL_peerNotifySettings();
            dialog.notify_settings.mute_until = untilTime;
        }
    ...
    static final /* synthetic */ void lambda$null$11$AlertsCreator(TLObject response, TLRPC$TL_error error) {
    }
    ...
    public static Builder createTTLAlert(Context context, TLRPC$EncryptedChat encryptedChat) {
        Builder builder = new Builder(context);
    ...
    static final /* synthetic */ void lambda$createTTLAlert$30$AlertsCreator(TLRPC$EncryptedChat encryptedChat, NumberPicker numberPicker, DialogInterface dialog, int which) {
