...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C16113 extends OnScrollListener {
        C16113() {
        }
    ...
    class C16124 implements OnItemClickListener {
        C16124() {
        }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    if (SharingLocationsAlert.this.textView != null) {
                        SharingLocationsAlert.this.textView.setText(LocaleController.formatString("SharingLiveLocationTitle", R.string.SharingLiveLocationTitle, new Object[]{LocaleController.formatPluralString("Chats", LocationController.getLocationsCount())}));
                        return;
                    }
                    return;
                default:
    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate) {
        ...
        this.listView.setOnScrollListener(new C16113());
        this.listView.setOnItemClickListener(new C16124());
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C16135());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C16146());
