...
public class Input {
    ...
    private Point smoothPoint(Point midPoint1, Point midPoint2, Point prev1, float t) {
        ...
        return new Point(((midPoint1.f824x * a1) + (prev1.f824x * a2)) + (midPoint2.f824x * a3), ((midPoint1.f825y * a1) + (prev1.f825y * a2)) + (midPoint2.f825y * a3), 1.0d);
    }
    ...
    private void paintPath(final Path path) {
        ...
        this.renderView.getPainting().paintStroke(path, this.clearBuffer, new Runnable() {
            ...
            class C14871 implements Runnable {
                C14871() {
                }
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new C14871());
            }
        });
    }
}
