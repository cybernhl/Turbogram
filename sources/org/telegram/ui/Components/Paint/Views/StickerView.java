...
public class StickerView extends EntityView {
    ...
    public StickerView(Context context, Point position, float angle, float scale, Size baseSize, TLRPC$Document sticker) {
        ...
        for (int a = 0; a < sticker.attributes.size(); a++) {
            TLRPC$DocumentAttribute attribute = (TLRPC$DocumentAttribute) sticker.attributes.get(a);
            if (attribute instanceof TLRPC$TL_documentAttributeSticker) {
                if (attribute.mask_coords != null) {
                    this.anchor = attribute.mask_coords.f800n;
                }
    ...
    protected void updatePosition() {
        ...
        setX(this.position.f828x - (this.baseSize.width / 2.0f));
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f828x - (side / 2.0f)) * scale, (this.position.f829y - (side / 2.0f)) * scale, side * scale, side * scale);
    }
