...
public class TextPaintView extends EntityView {
    ...
    class C15111 implements TextWatcher {
    ...
    public TextPaintView(Context context, Point position, int fontSize, String text, Swatch swatch, boolean stroke) {
        ...
        setStroke(stroke);
        updatePosition();
        this.editText.addTextChangedListener(new C15111());
    }
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f828x - (width / 2.0f)) * scale, (this.position.f829y - (height / 2.0f)) * scale, width * scale, height * scale);
    }
