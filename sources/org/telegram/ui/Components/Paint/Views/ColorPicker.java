...
public class ColorPicker extends FrameLayout {
    ...
    class C15081 implements OnClickListener {
        C15081() {
        }
    ...
    class C15092 implements OnClickListener {
        C15092() {
        }
    ...
    public ColorPicker(Context context) {
        ...
        this.settingsButton.setOnClickListener(new C15081());
        ...
        this.undoButton.setOnClickListener(new C15092());
