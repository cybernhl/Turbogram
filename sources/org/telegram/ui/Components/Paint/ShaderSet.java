...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        shader.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader.put(UNIFORMS, new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        ...
        shader.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader.put(UNIFORMS, new String[]{"mvpMatrix", "mask", TtmlNode.ATTR_TTS_COLOR});
    ...
    public static Map<String, Shader> setup() {
        ...
        for (Entry<String, Map<String, Object>> entry : AVAILBALBE_SHADERS.entrySet()) {
