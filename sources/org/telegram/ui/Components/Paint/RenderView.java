...
public class RenderView extends TextureView {
    ...
    class C14971 implements SurfaceTextureListener {
        ...
        class C14962 implements Runnable {
            C14962() {
            }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (RenderView.this.internal != null) {
                ...
                RenderView.this.updateTransform();
                RenderView.this.internal.requestRender();
                RenderView.this.internal.postRunnable(new C14951());
            }
        }

        public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
            if (!(RenderView.this.internal == null || RenderView.this.shuttingDown)) {
                RenderView.this.painting.onPause(new C14962());
            }
            return true;
        }
    ...
    class C14982 implements PaintingDelegate {
        C14982() {
        }
    ...
    class C14993 implements Runnable {
        C14993() {
        }
    ...
    private class CanvasInternal extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C15021();
        private EGL10 egl10;
            ...
            public void run() {
                if (CanvasInternal.this.initialized && !RenderView.this.shuttingDown) {
                    ...
                    if (!CanvasInternal.this.ready) {
                        RenderView.this.queue.postRunnable(new C15011(), 200);
                    }
                }
            }
        }
        ...
        class C15043 implements Runnable {
            C15043() {
            }
        ...
        class C15054 implements Runnable {
            C15054() {
            }
        ...
        public void scheduleRedraw() {
            ...
            this.scheduledRunnable = new C15043();
    ...
    public RenderView(Context context, Painting paint, Bitmap b, int rotation) {
        ...
        setSurfaceTextureListener(new C14971());
        this.painting.setDelegate(new C14982());
    }
