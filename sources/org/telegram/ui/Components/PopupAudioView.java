...
public class PopupAudioView extends BaseCell implements DownloadController$FileDownloadProgressListener, SeekBarDelegate {
    private int TAG;
        ...
        if (this.currentMessageObject != null) {
            ...
            if (MediaController.getInstance().isPlayingMessage(this.currentMessageObject)) {
                ...
                for (int a = 0; a < this.currentMessageObject.getDocument().attributes.size(); a++) {
                    TLRPC$DocumentAttribute attribute = (TLRPC$DocumentAttribute) this.currentMessageObject.getDocument().attributes.get(a);
