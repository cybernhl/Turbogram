...
public class InstantCameraView extends FrameLayout implements NotificationCenter$NotificationCenterDelegate {
    ...
    private Runnable timerRunnable = new C14611();
    ...
    class C14611 implements Runnable {
        ...
        public void run() {
            if (InstantCameraView.this.recording) {
                NotificationCenter.getInstance(InstantCameraView.this.currentAccount).postNotificationName(NotificationCenter.recordProgressChanged, Long.valueOf(InstantCameraView.this.duration = System.currentTimeMillis() - InstantCameraView.this.recordStartTime), Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
    ...
    class C14632 implements OnTouchListener {

        /* renamed from: org.telegram.ui.Components.InstantCameraView$2$1 */
        class C14621 extends AnimatorListenerAdapter {
            C14621() {
            }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == 0 && InstantCameraView.this.baseFragment != null) {
                if (InstantCameraView.this.videoPlayer != null) {
                    ...
                    InstantCameraView.this.muteAnimation.addListener(new C14621());
    ...
    class C14665 extends ViewOutlineProvider {
        C14665() {
        }
    ...
    class C14697 implements OnClickListener {
        ...
        class C14681 extends AnimatorListenerAdapter {
            C14681() {
            }
        ...
        public void onClick(View v) {
            if (InstantCameraView.this.cameraReady && InstantCameraView.this.cameraSession != null && InstantCameraView.this.cameraSession.isInitied() && InstantCameraView.this.cameraThread != null) {
                ...
                animator.addListener(new C14681());
                animator.start();
            }
        }
    }
    ...
    class C14708 implements SurfaceTextureListener {
        C14708() {
        }
    ...
    class C14719 extends AnimatorListenerAdapter {
        C14719() {
        }
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        class C14721 implements OnFrameAvailableListener {
            C14721() {
            }
        ...
        class C14732 implements OnFrameAvailableListener {
            C14732() {
            }
                ...
                if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, configs, 1, configsCount)) {
                    ...
                    if (this.eglContext == null) {
                        ...
                        if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                            ...
                            this.cameraSurface.setOnFrameAvailableListener(new C14721());
            ...
            switch (inputMessage.what) {
                ...
                case 2:
                    if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                        ...
                        GLES20.glTexParameteri(36197, 10243, 33071);
                        this.cameraSurface = new SurfaceTexture(InstantCameraView.this.cameraTexture[0]);
                        this.cameraSurface.setOnFrameAvailableListener(new C14732());
                        InstantCameraView.this.createCamera(this.cameraSurface);
                        return;
                    } else if (BuildVars.LOGS_ENABLED) {
    ...
    private class VideoRecorder implements Runnable {
        ...
        class C14773 implements Runnable {
            C14773() {
            }
        ...
        private VideoRecorder() {
            ...
            this.recorderRunnable = new C14741();
        }
        ...
        private void handleStopRecording(final int send) {
            ...
            if (send != 0) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    class C14751 implements VideoPlayerDelegate {
                        C14751() {
                        }
                    ...
                    public void run() {
                        ...
                        if (send == 1) {
                            ...
                            InstantCameraView.this.videoPlayer.setDelegate(new C14751());
        ...
        private void prepareEncoder() {
            try {
                ...
                AndroidUtilities.runOnUIThread(new C14773());
                if (this.eglDisplay != EGL14.EGL_NO_DISPLAY) {
    ...
    public InstantCameraView(Context context, ChatActivity parentFragment) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.cameraContainer.setOutlineProvider(new C14665());
        ...
        this.switchCameraButton.setOnClickListener(new C14697());
    ...
    public void showCamera() {
        if (this.textureView == null) {
            ...
            if (initCamera()) {
                ...
                this.textureView.setSurfaceTextureListener(new C14708());
    ...
    public void startAnimation(boolean open) {
        ...
        if (!open) {
            this.animatorSet.addListener(new C14719());
        }
    ...
    private void createCamera(final SurfaceTexture surfaceTexture) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            class C14592 implements Runnable {
                C14592() {
                }
            ...
            public void run() {
                if (InstantCameraView.this.cameraThread != null) {
                    ...
                    InstantCameraView.this.cameraThread.setCurrentSession(InstantCameraView.this.cameraSession);
                    CameraController.getInstance().openRound(InstantCameraView.this.cameraSession, surfaceTexture, new C14581(), new C14592());
                }
            }
        });
    }
    ...
    private void startProgressTimer() {
        ...
        this.progressTimer.schedule(new TimerTask() {
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new C14601());
            }
        }, 0, 17);
    }
