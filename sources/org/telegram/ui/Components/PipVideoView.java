...
public class PipVideoView {
    ...
    class C15752 extends AnimatorListenerAdapter {
        C15752() {
        }
    ...
    private class MiniControlsView extends FrameLayout {
        ...
        private Runnable hideRunnable = new C15761();
        ...
        private Runnable progressRunnable = new C15772();
        ...
        class C15816 extends AnimatorListenerAdapter {
            C15816() {
            }
        ...
        class C15827 extends AnimatorListenerAdapter {
            C15827() {
            }
            ...
            if (this.isVisible != value) {
                ...
                if (this.isVisible) {
                    if (animated) {
                        ...
                        this.currentAnimation.addListener(new C15816());
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.addListener(new C15827());
                    this.currentAnimation.start();
                } else {
                    setAlpha(0.0f);
                }
    ...
    private void animateToBoundsMaybe() {
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C15752());
            }
