...
public class PhotoFilterView extends FrameLayout {
    ...
    class C15311 implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (PhotoFilterView.this.eglThread != null) {
                PhotoFilterView.this.eglThread.setSurfaceTextureSize(width, height);
                PhotoFilterView.this.eglThread.requestRender(false, true);
                PhotoFilterView.this.eglThread.postRunnable(new C15301());
            }
        }
    ...
    class C15322 implements PhotoFilterLinearBlurControlDelegate {
        C15322() {
        }
    ...
    class C15333 implements PhotoFilterCurvesControlDelegate {
        C15333() {
        }
    ...
    class C15344 implements OnClickListener {
        C15344() {
        }
    ...
    class C15355 implements OnClickListener {
        C15355() {
        }
    ...
    class C15366 implements OnClickListener {
        C15366() {
        }
    ...
    class C15377 implements OnClickListener {
        C15377() {
        }
    ...
    class C15388 implements OnClickListener {
        C15388() {
        }
    ...
    class C15399 implements OnClickListener {
        C15399() {
        }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C15401();
        private EGL10 egl10;
        ...
        class C15423 implements Runnable {
            C15423() {
            }
                    ...
                    if (this.eglContext == null) {
                        ...
                        if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                            ...
                            if (linkStatus[0] == 0) {
                                ...
                                this.heightHandle = GLES20.glGetUniformLocation(this.toolsShaderProgram, MonthView.VIEW_PARAMS_HEIGHT);
        ...
        private boolean drawBlurPass() {
            ...
            if (PhotoFilterView.this.blurType == 1) {
                ...
                GLES20.glUniform2f(this.radialBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f828x, PhotoFilterView.this.blurExcludePoint.f829y);
                ...
                GLES20.glUniform2f(this.linearBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f828x, PhotoFilterView.this.blurExcludePoint.f829y);
    ...
    public class ToolsAdapter extends SelectionAdapter {
        ...
        class C15441 implements PhotoEditorSeekBarDelegate {
            C15441() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                view = cell;
                cell.setSeekBarDelegate(new C15441());
            } else {
                view = new PhotoEditRadioCell(this.mContext);
                view.setOnClickListener(new C15452());
            }
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (i == PhotoFilterView.this.enhanceTool) {
                        ...
                        cell.setIconAndTextAndValue(LocaleController.getString(ExifInterface.TAG_CONTRAST, R.string.Contrast), PhotoFilterView.this.contrastValue, -100, PhotoFilterView.curveGranularity);
                        return;
                    } else if (i == PhotoFilterView.this.exposureTool) {
                        ...
                        cell.setIconAndTextAndValue(LocaleController.getString(ExifInterface.TAG_SATURATION, R.string.Saturation), PhotoFilterView.this.saturationValue, -100, PhotoFilterView.curveGranularity);
                        return;
                    } else if (i == PhotoFilterView.this.vignetteTool) {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation, MediaController$SavedFilterState state) {
        ...
        this.textureView.setSurfaceTextureListener(new C15311());
        ...
        this.blurControl.setDelegate(new C15322());
        this.curvesControl = new PhotoFilterCurvesControl(context, this.curvesToolValue);
        this.curvesControl.setDelegate(new C15333());
        ...
        this.tuneItem.setOnClickListener(new C15344());
        ...
        this.blurItem.setOnClickListener(new C15355());
        ...
        this.curveItem.setOnClickListener(new C15366());
        ...
        while (a < 4) {
            ...
            frameLayout1.setOnClickListener(new C15377());
            a++;
        }
        ...
        this.blurOffButton.setOnClickListener(new C15388());
        ...
        this.blurRadialButton.setOnClickListener(new C15399());
