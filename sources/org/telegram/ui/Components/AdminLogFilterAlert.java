...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    public interface AdminLogFilterAlertDelegate {
        void didSelectRights(TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, SparseArray<User> sparseArray);
    }

    /* renamed from: org.telegram.ui.Components.AdminLogFilterAlert$3 */
    class C13393 extends OnScrollListener {
        C13393() {
        }
    ...
    class C13404 implements OnItemClickListener {
        C13404() {
        }
            ...
            if (view instanceof CheckBoxCell) {
                ...
                if (AdminLogFilterAlert.this.selectedAdmins == null) {
                    ...
                    for (a = 0; a < AdminLogFilterAlert.this.currentAdmins.size(); a++) {
                        user = MessagesController.getInstance(AdminLogFilterAlert.this.currentAccount).getUser(Integer.valueOf(((TLRPC$ChannelParticipant) AdminLogFilterAlert.this.currentAdmins.get(a)).user_id));
    ...
    class C13415 implements OnClickListener {
        C13415() {
        }
    ...
    public AdminLogFilterAlert(Context context, TLRPC$TL_channelAdminLogEventsFilter filter, SparseArray<User> admins, boolean megagroup) {
        int rowCount;
        super(context, false);
        if (filter != null) {
        ...
        this.listView.setOnScrollListener(new C13393());
        this.listView.setOnItemClickListener(new C13404());
        ...
        this.saveButton.setOnClickListener(new C13415());
