...
public class StickerMasksView extends FrameLayout implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C16222 extends SpanSizeLookup {
        C16222() {
        }
    ...
    class C16233 implements OnTouchListener {
        C16233() {
        }
    ...
    class C16244 implements OnItemClickListener {
        C16244() {
        }
    ...
    class C16255 implements ScrollSlidingTabStripDelegate {
        C16255() {
        }
    ...
    class C16266 extends OnScrollListener {
        C16266() {
        }
    ...
    private class StickersGridAdapter extends SelectionAdapter {
        ...
        public int getTabForPosition(int position) {
            ...
            TLRPC$TL_messages_stickerSet pack = (TLRPC$TL_messages_stickerSet) this.rowStartPack.get(position / this.stickersPerRow);
            if (pack == null) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    if (position == this.totalItems) {
                        TLRPC$TL_messages_stickerSet pack = (TLRPC$TL_messages_stickerSet) this.rowStartPack.get((position - 1) / this.stickersPerRow);
                        if (pack == null) {
    ...
    public StickerMasksView(Context context) {
        ...
        this.stickersLayoutManager.setSpanSizeLookup(new C16222());
        ...
        this.stickersGridView.setOnTouchListener(new C16233());
        this.stickersOnItemClickListener = new C16244();
        ...
        updateStickerTabs();
        this.scrollSlidingTabStrip.setDelegate(new C16255());
        this.stickersGridView.setOnScrollListener(new C16266());
    }
    ...
    private void updateStickerTabs() {
        if (this.scrollSlidingTabStrip != null) {
            ...
            ArrayList<TLRPC$TL_messages_stickerSet> packs = DataQuery.getInstance(this.currentAccount).getStickerSets(this.currentType);
    ...
    protected void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(new C16277());
    }
