        ...
        public void draw(Canvas canvas) {
            switch (this.type) {
                case 0:
                    ...
                    canvas.drawPoint(this.f822x, this.f823y, FireworksEffect.this.particlePaint);
                    return;
                default:
                    return;
            }
    ...
    private void updateParticles(long dt) {
        ...
        while (a < count) {
            ...
            if (particle.currentTime >= particle.lifeTime) {
                ...
                particle.f822x += ((particle.vx * particle.velocity) * ((float) dt)) / 500.0f;
                particle.f823y += ((particle.vy * particle.velocity) * ((float) dt)) / 500.0f;
        ...
        if (parent != null && canvas != null) {
            ...
            if (Utilities.random.nextBoolean() && this.particles.size() + 8 < 150) {
                ...
                for (a = 0; a < 8; a++) {
                    ...
                    newParticle.f822x = cx;
                    newParticle.f823y = cy;
