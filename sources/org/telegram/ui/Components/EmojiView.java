...
public class EmojiView extends FrameLayout implements NotificationCenter$NotificationCenterDelegate {
    private static final OnScrollChangedListener NOP = new C14182();
    ...
    private StickerPreviewViewerDelegate stickerPreviewViewerDelegate = new C14161();
    ...
    class C14161 implements StickerPreviewViewerDelegate {
        C14161() {
        }
    ...
    static class C14182 implements OnScrollChangedListener {
        C14182() {
        }
    ...
    class C14213 extends ViewOutlineProvider {
        C14213() {
        }
    ...
    class C14235 extends SpanSizeLookup {
        C14235() {
        }
        ...
        public int getSpanSize(int position) {
            if (EmojiView.this.stickersGridView.getAdapter() == EmojiView.this.stickersGridAdapter) {
                ...
                return 1;
            } else if (position == EmojiView.this.stickersSearchGridAdapter.totalItems || (EmojiView.this.stickersSearchGridAdapter.cache.get(position) != null && !(EmojiView.this.stickersSearchGridAdapter.cache.get(position) instanceof TLRPC$Document))) {
                return EmojiView.this.stickersGridAdapter.stickersPerRow;
            } else {
                return 1;
            }
    ...
    class C14246 implements OnTouchListener {
        C14246() {
        }
    ...
    class C14257 implements OnItemClickListener {
        C14257() {
        }

        public void onItemClick(View view, int position) {
            if (EmojiView.this.stickersGridView.getAdapter() == EmojiView.this.stickersSearchGridAdapter) {
                TLRPC$StickerSetCovered pack = (TLRPC$StickerSetCovered) EmojiView.this.stickersSearchGridAdapter.positionsToSets.get(position);
                if (pack != null) {
    ...
    class C14268 implements OnClickListener {
        C14268() {
        }
    ...
    private class StickersGridAdapter extends SelectionAdapter {
        ...
        class C14333 implements OnClickListener {
            C14333() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 2:
                    ...
                    ((StickerSetNameCell) view).setOnIconClickListener(new C14322());
                    break;
                case 3:
                    view = new StickerSetGroupInfoCell(this.context);
                    ((StickerSetGroupInfoCell) view).setAddOnClickListener(new C14333());
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    TLRPC$TL_messages_stickerSet object = this.cache.get(position);
        ...
        public void notifyDataSetChanged() {
            ...
            while (a < packs.size()) {
                ...
                if (a == -3) {
                    ...
                    i = this.totalItems;
                    this.totalItems = i + 1;
                    sparseArray.put(i, Event.SEARCH);
                    startRow++;
                } else {
                    ArrayList<TLRPC$Document> documents;
                    if (a == -2) {
    ...
    private class StickersSearchGridAdapter extends SelectionAdapter {
        ...
        private Runnable searchRunnable = new C14381();
        ...
        class C14381 implements Runnable {
            ...
            public void run() {
                if (!TextUtils.isEmpty(StickersSearchGridAdapter.this.searchQuery)) {
                    ...
                    HashMap<String, ArrayList<TLRPC$Document>> allStickers = DataQuery.getInstance(EmojiView.this.currentAccount).getAllStickers();
                    if (StickersSearchGridAdapter.this.searchQuery.length() <= 14) {
                        ...
                        if (!(newStickers == null || newStickers.isEmpty())) {
                            ...
                            for (a = 0; a < size; a++) {
                                TLRPC$Document document = (TLRPC$Document) newStickers.get(a);
                    ...
                    ArrayList<TLRPC$TL_messages_stickerSet> local = DataQuery.getInstance(EmojiView.this.currentAccount).getStickerSets(0);
                    size = local.size();
                    for (a = 0; a < size; a++) {
                        set = (TLRPC$TL_messages_stickerSet) local.get(a);
                    ...
                    req.f808q = StickersSearchGridAdapter.this.searchQuery;
                        ...
                        public void run(final TLObject response, TLRPC$TL_error error) {
                            if (response instanceof TLRPC$TL_messages_foundStickerSets) {
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    public void run() {
                                        if (req.f808q.equals(StickersSearchGridAdapter.this.searchQuery)) {
                                            C14381.this.clear();
                                    ...
                                    public void run() {
                                        if (req2.emoticon.equals(StickersSearchGridAdapter.this.searchQuery)) {
                                            ...
                                            if (response instanceof TLRPC$TL_messages_stickers) {
                                                TLRPC$TL_messages_stickers res = response;
                                                int oldCount = emojiStickersArray.size();
                                                int size = res.stickers.size();
                                                for (int a = 0; a < size; a++) {
                                                    TLRPC$Document document = (TLRPC$Document) res.stickers.get(a);
        ...
        class C14403 implements OnClickListener {
            C14403() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 3:
                    ...
                    ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new C14403());
                    break;
                case 4:
                    view = new View(this.context);
                    view.setLayoutParams(new LayoutParams(-1, EmojiView.this.searchFieldHeight));
        ...
        public void notifyDataSetChanged() {
            ...
            for (int a = -1; a < (serverSize + localSize) + emojiSize; a++) {
                ...
                if (a == -1) {
                    ...
                    int idx = a;
                    if (idx < localSize) {
                        TLRPC$TL_messages_stickerSet set = (TLRPC$TL_messages_stickerSet) this.localPacks.get(idx);
                        ...
                        if (idx < emojiSize) {
                            ...
                            TLRPC$StickerSetCovered set2 = (TLRPC$StickerSetCovered) this.serverPacks.get(idx - emojiSize);
                            documents = set2.covers;
                            TLRPC$StickerSetCovered pack = set2;
                        }
                    }
                    if (!documents.isEmpty()) {
                        int b;
                        ...
                        if (a >= localSize && (obj instanceof TLRPC$StickerSetCovered)) {
                        ...
                        for (b = 0; b < size; b++) {
                            ...
                            if (a >= localSize && (obj instanceof TLRPC$StickerSetCovered)) {
                                this.positionsToSets.put(this.totalItems + (b + 1), (TLRPC$StickerSetCovered) obj);
                            }
                        }
                        for (b = 0; b < count + 1; b++) {
                            if (obj != null) {
    ...
    private class TrendingGridAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 2:
                    view = new FeaturedStickerSetInfoCell(this.context, 17);
                    ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new C14432());
                    break;
            }
            return new Holder(view);
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ((StickerEmojiCell) holder.itemView).setSticker((TLRPC$Document) this.cache.get(position), false);
                    return;
                case 1:
                ...
                case 2:
                    ...
                    TLRPC$StickerSetCovered stickerSetCovered = (TLRPC$StickerSetCovered) this.sets.get(((Integer) this.cache.get(position)).intValue());
        ...
        public void notifyDataSetChanged() {
            ...
            if (!EmojiView.this.trendingLoaded) {
                ...
                this.totalItems = 0;
                int num = 0;
                ArrayList<TLRPC$StickerSetCovered> packs = DataQuery.getInstance(EmojiView.this.currentAccount).getFeaturedStickerSets();
    ...
    public EmojiView(boolean needStickers, boolean needGif, Context context, TLRPC$ChatFull chatFull) {
        ...
        if (VERSION.SDK_INT >= 21) {
            this.outlineProvider = new C14213();
        }
        ...
        if (needStickers) {
            ...
            this.stickersLayoutManager.setSpanSizeLookup(new C14235());
            ...
            this.stickersGridView.setOnTouchListener(new C14246());
            this.stickersOnItemClickListener = new C14257();
                    ...
                    if (event.getAction() == 0) {
                        if (!EmojiView.this.listener.isSearchOpened()) {
                            ...
                            if (EmojiView.this.listener == null || !EmojiView.this.listener.isExpanded()) {
                                ...
                                EmojiView.this.searchAnimation.addListener(new C14271());
            ...
            this.trendingGridView.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(View view, int position) {
                    TLRPC$StickerSetCovered pack = (TLRPC$StickerSetCovered) EmojiView.this.trendingGridAdapter.positionsToSets.get(position);
                    if (pack != null) {
                        EmojiView.this.listener.onShowStickerSet(pack.set, null);
                    }
                }
            ...
            if (needGif) {
                ...
                gridLayoutManager = new ExtendedGridLayoutManager(context, 100) {
                    ...
                    protected Size getSizeForItem(int i) {
                        ...
                        TLRPC$Document document = (TLRPC$Document) EmojiView.this.recentGifs.get(i);
                        Size size = this.size;
                        if (document.thumb == null || document.thumb.f794w == 0) {
                            f = 100.0f;
                        } else {
                            f = (float) document.thumb.f794w;
                        }
                        size.width = f;
                        Size size2 = this.size;
                        if (!(document.thumb == null || document.thumb.f793h == 0)) {
                            f2 = (float) document.thumb.f793h;
                        }
                        size2.height = f2;
                        for (int b = 0; b < document.attributes.size(); b++) {
                            TLRPC$DocumentAttribute attribute = (TLRPC$DocumentAttribute) document.attributes.get(b);
                            if ((attribute instanceof TLRPC$TL_documentAttributeImageSize) || (attribute instanceof TLRPC$TL_documentAttributeVideo)) {
                                this.size.width = (float) attribute.f787w;
                                this.size.height = (float) attribute.f786h;
                                break;
                            }
                        }
                        return this.size;
    ...
    public void closeSearch(boolean animated, long scrollToSet) {
        ...
        if (scrollToSet != -1) {
            TLRPC$TL_messages_stickerSet set = DataQuery.getInstance(this.currentAccount).getStickerSetById(scrollToSet);
            if (set != null) {
    ...
    private void checkStickersTabY(View list, int dy) {
        ...
        } else if (list.getVisibility() == 0 && !TurboConfig.dontHideStickertab) {
    ...
    private void updateStickerTabs() {
        if (this.stickersTab != null) {
            ...
            ArrayList<TLRPC$TL_messages_stickerSet> packs = DataQuery.getInstance(this.currentAccount).getStickerSets(0);
            ...
            if (chat != null && chat.banned_rights != null) {
                ...
                AnimatorSet.addListener(new AnimatorListenerAdapter() {
                    ...
                    class C14201 implements Runnable {
                        ...
                        class C14191 extends AnimatorListenerAdapter {
                            C14191() {
                            }
                        ...
                        public void run() {
                            if (EmojiView.this.mediaBanTooltip != null) {
                                ...
                                AnimatorSet.addListener(new C14191());
                    ...
                    public void onAnimationEnd(Animator animation) {
                        AndroidUtilities.runOnUIThread(new C14201(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                    }
                });
                AnimatorSet.setDuration(300);
                AnimatorSet.start();
