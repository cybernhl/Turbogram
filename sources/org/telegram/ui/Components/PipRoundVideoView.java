...
public class PipRoundVideoView implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C15693 extends ViewOutlineProvider {
        C15693() {
        }
    ...
    class C15715 extends AnimatorListenerAdapter {
        C15715() {
        }
    ...
    class C15737 extends AnimatorListenerAdapter {
        C15737() {
        }
    ...
    public void show(Activity activity, Runnable closeRunnable) {
        if (activity != null) {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.aspectRatioFrameLayout.setOutlineProvider(new C15693());
    ...
    public void showTemporary(boolean show) {
        ...
        this.hideShowAnimation.addListener(new C15715());
    ...
    private void animateToBoundsMaybe() {
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C15737());
            }
