...
public class TermsOfServiceView extends FrameLayout {
    ...
    class C16491 implements OnClickListener {
        ...
        class C16481 implements DialogInterface.OnClickListener {
            ...
            class C16471 implements DialogInterface.OnClickListener {
                C16471() {
                }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Deactivate", R.string.Deactivate), new C16471());
        ...
        public void onClick(View view) {
            ...
            builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", R.string.DeclineDeactivate), new C16481());
    ...
    class C16512 implements OnClickListener {
        ...
        class C16501 implements DialogInterface.OnClickListener {
            C16501() {
            }
        ...
        public void onClick(View view) {
            if (TermsOfServiceView.this.currentTos.min_age_confirm != 0) {
                ...
                builder.setPositiveButton(LocaleController.getString("Agree", R.string.Agree), new C16501());
                builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                builder.setMessage(LocaleController.formatString("TosAgeText", R.string.TosAgeText, new Object[]{LocaleController.formatPluralString("Years", TermsOfServiceView.this.currentTos.min_age_confirm)}));
                builder.show();
                return;
            }
            TermsOfServiceView.this.accept();
    ...
    public TermsOfServiceView(Context context) {
        ...
        declineTextView.setOnClickListener(new C16491());
        ...
        acceptTextView.setOnClickListener(new C16512());
    }
    ...
    private void accept() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C16523());
    }
