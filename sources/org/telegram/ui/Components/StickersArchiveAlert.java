...
public class StickersArchiveAlert extends Builder {
    ...
    class C16442 implements OnClickListener {
        C16442() {
        }
    ...
    public StickersArchiveAlert(Context context, BaseFragment baseFragment, ArrayList<TLRPC$StickerSetCovered> sets) {
        ...
        setNegativeButton(LocaleController.getString("Close", R.string.Close), new C16431());
        if (this.parentFragment != null) {
            setPositiveButton(LocaleController.getString("Settings", R.string.Settings), new C16442());
        }
    }
}
