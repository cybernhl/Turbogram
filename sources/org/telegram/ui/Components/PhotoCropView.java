...
public class PhotoCropView extends FrameLayout {
    ...
    class C15261 implements CropViewListener {
        C15261() {
        }
    ...
    class C15272 implements RotationWheelListener {
        C15272() {
        }
    ...
    class C15283 implements Runnable {
        C15283() {
        }
    ...
    public void setBitmap(Bitmap bitmap, int rotation, boolean freeform) {
        ...
        if (this.cropView == null) {
            ...
            this.cropView.setListener(new C15261());
            ...
            this.wheelView.setListener(new C15272());
    ...
    public float getLimitWidth() {
        return ((((float) (getWidth() - AndroidUtilities.dp(14.0f))) - this.rectX) - ((float) ((int) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, Math.ceil((double) ((((float) (getWidth() - AndroidUtilities.dp(28.0f))) - (((float) this.bitmapWidth) * this.bitmapGlobalScale)) / 2.0f)))))) - this.rectSizeX;
    }

    public float getLimitHeight() {
        float additionalY = (float) (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
        return (((((float) (getHeight() - AndroidUtilities.dp(14.0f))) - additionalY) - this.rectY) - ((float) ((int) Math.max(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, Math.ceil((double) (((((float) (getHeight() - AndroidUtilities.dp(28.0f))) - (((float) this.bitmapHeight) * this.bitmapGlobalScale)) - additionalY) / 2.0f)))))) - this.rectSizeY;
    }
    ...
    public void startAnimationRunnable() {
        if (this.animationRunnable == null) {
            this.animationRunnable = new C15283();
