...
@SuppressLint({"NewApi"})
public class VideoPlayer implements EventListener, VideoListener, NotificationCenter$NotificationCenterDelegate {
    ...
    class C16751 implements Player.EventListener {
        C16751() {
        }
    ...
    private void ensurePleyaerCreated() {
        ...
        if (this.mixedAudio && this.audioPlayer == null) {
            ...
            this.audioPlayer.addListener(new C16751());
