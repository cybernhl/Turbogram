...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter$NotificationCenterDelegate, SizeNotifierFrameLayoutPhotoDelegate {
    ...
    class C15603 implements ActionMode.Callback {
        C15603() {
        }
    ...
    class C15614 implements ActionMode.Callback {
        C15614() {
        }
    ...
    class C15625 implements OnKeyListener {
        C15625() {
        }
    ...
    class C15636 implements OnClickListener {
        C15636() {
        }
    ...
    class C15647 implements TextWatcher {
    ...
    class C15658 implements OnClickListener {
        C15658() {
        }
    ...
    class C15669 implements Listener {
        C15669() {
        }
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, View window) {
        ...
        this.emojiButton.setOnClickListener(new C15581());
        ...
        if (VERSION.SDK_INT >= 23 && this.windowView != null) {
            this.messageEditText.setCustomSelectionActionModeCallback(new C15603());
            this.messageEditText.setCustomInsertionActionModeCallback(new C15614());
        }
        ...
        this.messageEditText.setOnKeyListener(new C15625());
        this.messageEditText.setOnClickListener(new C15636());
        this.messageEditText.addTextChangedListener(new C15647());
        ...
        doneButton.setOnClickListener(new C15658());
    }
    ...
    private void createEmojiView() {
        if (this.emojiView == null) {
            ...
            this.emojiView.setListener(new C15669());
