...
public class MrzCameraActivity extends BaseFragment implements PreviewCallback {
    ...
    class C18881 extends ActionBarMenuOnItemClick {
        C18881() {
        }
    ...
    class C18903 implements OnTouchListener {
        C18903() {
        }
    ...
    class C18914 implements CameraViewDelegate {
        C18914() {
        }
    ...
    class C18925 implements Runnable {
        C18925() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C18881());
        ...
        viewGroup.setOnTouchListener(new C18903());
        this.cameraView = new CameraView(context, false);
        this.cameraView.setDelegate(new C18914());
    ...
    private void startRecognizing() {
        ...
        AndroidUtilities.runOnUIThread(new C18925());
    }
                        ...
                        if ((res.expiryDay != 0 || res.doesNotExpire) && res.gender != 0) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    AndroidUtilities.runOnUIThread(new C18931(), 1200);
                                }
                            });
                        }
                    }
