...
public class InviteContactsActivity extends BaseFragment implements OnClickListener, NotificationCenter$NotificationCenterDelegate {
    ...
    class C18161 extends ActionBarMenuOnItemClick {
        C18161() {
        }
    ...
    class C18205 implements Callback {
        C18205() {
        }
    ...
    class C18216 implements OnKeyListener {
    ...
    class C18227 implements TextWatcher {
        C18227() {
        }
    ...
    class C18238 implements OnItemClickListener {
        C18238() {
        }
    ...
    class C18249 extends OnScrollListener {
        C18249() {
        }
        ...
        public void searchDialogs(final String query) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C18261 implements Runnable {
                    ...
                    public void run() {
                        Utilities.searchQueue.postRunnable(new C18251());
                    }
                }
                ...
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C18261());
                }
            }, 200, 300);
        }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        class C18291 extends AnimatorListenerAdapter {
            C18291() {
            }
        ...
        public void addSpan(GroupCreateSpan span) {
            ...
            this.currentAnimation.addListener(new C18291());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C18161());
        ...
        this.editText.setCustomSelectionActionModeCallback(new C18205());
        this.editText.setOnKeyListener(new C18216());
        this.editText.addTextChangedListener(new C18227());
        ...
        this.listView.setOnItemClickListener(new C18238());
        this.listView.setOnScrollListener(new C18249());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        r10[41] = new ThemeDescription(this.counterView, ThemeDescription.FLAG_BACKGROUND, null, null, null, null, Theme.key_contacts_inviteBackground);
        ...
        r10[44] = new ThemeDescription(this.counterTextView, ThemeDescription.FLAG_BACKGROUNDFILTER, null, null, null, null, Theme.key_contacts_inviteText);
        return r10;
    }
}
