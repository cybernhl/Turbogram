...
public class StickerPreviewViewer {
    ...
    private Runnable showSheetRunnable = new C21411();
    private int startX;
    private int startY;
    ...
    public interface StickerPreviewViewerDelegate {
        ...
        void sendSticker(TLRPC$Document tLRPC$Document);
    }

    /* renamed from: org.telegram.ui.StickerPreviewViewer$1 */
    class C21411 implements Runnable {

        /* renamed from: org.telegram.ui.StickerPreviewViewer$1$2 */
        class C21402 implements OnDismissListener {
            C21402() {
            }
        ...
        public void run() {
            if (StickerPreviewViewer.this.parentActivity != null && StickerPreviewViewer.this.currentSet != null) {
                ...
                if (!items.isEmpty()) {
                    ...
                    StickerPreviewViewer.this.visibleDialog.setOnDismissListener(new C21402());
    ...
    class C21444 implements OnTouchListener {
        C21444() {
        }
    ...
    class C21455 implements Runnable {
        C21455() {
        }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C21444());
    ...
    public void open(TLRPC$Document sticker, boolean isRecent) {
        if (this.parentActivity != null && sticker != null) {
            ...
            for (a = 0; a < sticker.attributes.size(); a++) {
                attribute = (TLRPC$DocumentAttribute) sticker.attributes.get(a);
            ...
            TLRPC$FileLocation tLRPC$FileLocation = (sticker == null || sticker.thumb == null) ? null : sticker.thumb.location;
            imageReceiver.setImage((TLObject) sticker, null, tLRPC$FileLocation, null, "webp", 1);
        ...
        if (this.containerView != null && this.backgroundDrawable != null) {
            ...
            if (this.isVisible) {
                ...
                if (this.showProgress == 0.0f) {
                    ...
                    AndroidUtilities.runOnUIThread(new C21455());
                    try {
                        if (this.windowView.getParent() != null) {
                            ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                        }
