...
public class FeaturedStickersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C17533 implements OnItemClickListener {
        C17533() {
        }
        ...
        public void onItemClick(final View view, int position) {
            if (position >= FeaturedStickersActivity.this.stickersStartRow && position < FeaturedStickersActivity.this.stickersEndRow && FeaturedStickersActivity.this.getParentActivity() != null) {
                ...
                final TLRPC$StickerSetCovered stickerSet = (TLRPC$StickerSetCovered) DataQuery.getInstance(FeaturedStickersActivity.this.currentAccount).getFeaturedStickerSets().get(position);
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (getItemViewType(position) == 0) {
                boolean z;
                boolean installing;
                ArrayList<TLRPC$StickerSetCovered> arrayList = DataQuery.getInstance(FeaturedStickersActivity.this.currentAccount).getFeaturedStickerSets();
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((FeaturedStickerSetCell) view).setAddOnClickListener(new C17541());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnItemClickListener(new C17533());
    ...
    private void updateRows() {
        this.rowCount = 0;
        ArrayList<TLRPC$StickerSetCovered> stickerSets = DataQuery.getInstance(this.currentAccount).getFeaturedStickerSets();
