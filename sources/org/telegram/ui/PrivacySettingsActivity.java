...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C20481 extends ActionBarMenuOnItemClick {
        C20481() {
        }
    ...
    static final /* synthetic */ void lambda$onFragmentDestroy$0$PrivacySettingsActivity(TLObject response, TLRPC$TL_error error) {
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20481());
    ...
    final /* synthetic */ void lambda$null$3$PrivacySettingsActivity(DialogInterface dialogInterface, int i) {
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_messages_clearAllDrafts(), new PrivacySettingsActivity$$Lambda$19(this));
    }
    ...
    final /* synthetic */ void lambda$null$2$PrivacySettingsActivity(TLObject response, TLRPC$TL_error error) {
    ...
    final /* synthetic */ void lambda$null$5$PrivacySettingsActivity(AlertDialog progressDialog, TLRPC$TL_account_setAccountTTL req, TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new PrivacySettingsActivity$$Lambda$18(this, progressDialog, response, req));
    }

    final /* synthetic */ void lambda$null$4$PrivacySettingsActivity(AlertDialog progressDialog, TLObject response, TLRPC$TL_account_setAccountTTL req) {
        try {
    ...
    final /* synthetic */ void lambda$null$10$PrivacySettingsActivity(TextCheckCell cell, TLObject response, TLRPC$TL_error error) {
    ...
    static final /* synthetic */ void lambda$null$15$PrivacySettingsActivity(TLObject response, TLRPC$TL_error error) {
    }
    ...
    private void loadPasswordSettings() {
        if (!UserConfig.getInstance(this.currentAccount).hasSecureData) {
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getPassword(), new PrivacySettingsActivity$$Lambda$2(this), 10);
        }
    }

    final /* synthetic */ void lambda$loadPasswordSettings$20$PrivacySettingsActivity(TLObject response, TLRPC$TL_error error) {
    ...
    private String formatRulesString(int rulesType) {
        ArrayList<TLRPC$PrivacyRule> privacyRules = ContactsController.getInstance(this.currentAccount).getPrivacyRules(rulesType);
