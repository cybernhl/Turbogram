...
public class PrivacyControlActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C20471 extends ActionBarMenuOnItemClick {
        C20471() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20471());
    ...
    final /* synthetic */ void lambda$applyCurrentPrivacySettings$4$PrivacyControlActivity(AlertDialog progressDialogFinal, TLObject response, TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new PrivacyControlActivity$$Lambda$2(this, progressDialogFinal, error, response));
    }

    final /* synthetic */ void lambda$null$3$PrivacyControlActivity(AlertDialog progressDialogFinal, TLRPC$TL_error error, TLObject response) {
