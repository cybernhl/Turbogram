...
public class CommonGroupsActivity extends BaseFragment {
    ...
    class C13311 extends ActionBarMenuOnItemClick {
        C13311() {
        }
    ...
    class C13322 implements OnItemClickListener {
        C13322() {
        }
    ...
    class C13333 extends OnScrollListener {
        C13333() {
        }
    ...
    class C13365 implements ThemeDescriptionDelegate {
        C13365() {
        }
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnItemClickListener(new C13322());
        this.listView.setOnScrollListener(new C13333());
        if (this.loading) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C13365();
