...
public class ProxySettingsActivity extends BaseFragment {
    ...
    class C20781 extends ActionBarMenuOnItemClick {
        C20781() {
        }
    ...
    class C20792 implements OnClickListener {
        C20792() {
        }
    ...
    class C20803 implements TextWatcher {
        C20803() {
        }
    ...
    class C20814 implements TextWatcher {
        C20814() {
        }
    ...
    class C20825 implements OnEditorActionListener {
        C20825() {
        }
    ...
    class C20836 implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                ...
                if (params.length() != 0) {
                    AndroidUtilities.addToClipboard(url + params.toString());
                    TurboUtils.showToast(ProxySettingsActivity.this.getParentActivity(), LocaleController.getString("TextCopied", R.string.TextCopied), 0);
                }
            } catch (Exception e) {
            }
        }
    ...
    /* renamed from: org.telegram.ui.ProxySettingsActivity$7 */
    class C20847 implements OnClickListener {
        C20847() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20781());
        ...
        while (a < 2) {
            ...
            this.typeCell[a].setOnClickListener(new C20792());
            a++;
        }
        ...
        for (a = 0; a < 5; a++) {
            ...
            if (a == 0) {
                ...
                this.inputFields[a].addTextChangedListener(new C20803());
            } else if (a == 1) {
                this.inputFields[a].setInputType(2);
                this.inputFields[a].addTextChangedListener(new C20814());
            } else if (a == 3) {
            ...
            switch (a) {
                case 0:
                    ...
                    break;
                case 1:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPort", R.string.UseProxyPort));
                    this.inputFields[a].setText("" + this.currentProxyInfo.port);
                    break;
                case 2:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyUsername", R.string.UseProxyUsername));
                    this.inputFields[a].setText(this.currentProxyInfo.username);
                    break;
                case 3:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPassword", R.string.UseProxyPassword));
                    this.inputFields[a].setText(this.currentProxyInfo.password);
                    break;
                case 4:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxySecret", R.string.UseProxySecret));
            ...
            this.inputFields[a].setOnEditorActionListener(new C20825());
        }
        ...
        this.copyCell.setBackgroundDrawable(Theme.getSelectorDrawable(true));
        this.copyCell.setText(LocaleController.getString("Copy", R.string.Copy), true);
        this.copyCell.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText4));
        this.linearLayout2.addView(this.copyCell, LayoutHelper.createLinear(-1, -2));
        this.copyCell.setOnClickListener(new C20836());
        ...
        this.shareCell.setOnClickListener(new C20847());
    ...
    private void checkShareButton() {
        if (this.shareCell != null && this.doneItem != null && this.inputFields[0] != null && this.inputFields[1] != null) {
            if (this.inputFields[0].length() == 0 || Utilities.parseInt(this.inputFields[1].getText().toString()).intValue() == 0) {
                ...
                this.copyCell.getTextView().setAlpha(0.5f);
                this.copyCell.setEnabled(false);
                return;
            }
            ...
            this.copyCell.getTextView().setAlpha(1.0f);
            this.copyCell.setEnabled(true);
        }
    }
    ...
    private void updateUiForType() {
        ...
        if (this.currentType == 0) {
            ...
            this.bottomCell.setText(LocaleController.getString("UseProxyTelegramInfo", R.string.UseProxyTelegramInfo) + "\n\n" + LocaleController.getString("UseProxyTelegramInfo2", R.string.UseProxyTelegramInfo2));
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        arrayList.add(new ThemeDescription(this.copyCell, ThemeDescription.FLAG_BACKGROUND, null, null, null, null, Theme.key_windowBackgroundWhite));
        arrayList.add(new ThemeDescription(this.copyCell, 0, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlueText4));
        arrayList.add(new ThemeDescription(this.copyCell, 0, new Class[]{TextSettingsCell.class}, new String[]{"valueTextView"}, null, null, null, Theme.key_windowBackgroundWhiteValueText));
