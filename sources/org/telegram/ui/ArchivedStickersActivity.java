...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C10231 extends ActionBarMenuOnItemClick {
        C10231() {
        }
    ...
    class C10252 implements OnItemClickListener {
        C10252() {
        }
    ...
    class C10263 extends OnScrollListener {
        C10263() {
        }
    ...
    class C10284 implements RequestDelegate {
        C10284() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C10291 implements OnCheckedChangeListener {
            C10291() {
            }
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (num < ArchivedStickersActivity.this.sets.size()) {
                    DataQuery.getInstance(ArchivedStickersActivity.this.currentAccount).removeStickersSet(ArchivedStickersActivity.this.getParentActivity(), ((TLRPC$StickerSetCovered) ArchivedStickersActivity.this.sets.get(num)).set, !isChecked ? 1 : 2, ArchivedStickersActivity.this, false);
                }
            }
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((ArchivedStickerSetCell) view).setOnCheckClick(new C10291());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C10231());
        ...
        this.listView.setOnItemClickListener(new C10252());
        this.listView.setOnScrollListener(new C10263());
    ...
    private void getStickers() {
        if (!this.loadingStickers && !this.endReached) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C10284()), this.classGuid);
        }
    }
