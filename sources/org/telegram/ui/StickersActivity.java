...
public class StickersActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C21482 implements OnItemClickListener {
        ...
        public void onItemClick(View view, int position) {
            if (position >= StickersActivity.this.stickersStartRow && position < StickersActivity.this.stickersEndRow && StickersActivity.this.getParentActivity() != null) {
                ...
                TLRPC$TL_messages_stickerSet stickerSet = (TLRPC$TL_messages_stickerSet) DataQuery.getInstance(StickersActivity.this.currentAccount).getStickerSets(StickersActivity.this.currentType).get(position - StickersActivity.this.stickersStartRow);
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("SuggestStickersAll", R.string.SuggestStickersAll), LocaleController.getString("SuggestStickersInstalled", R.string.SuggestStickersInstalled), LocaleController.getString("SuggestStickersNone", R.string.SuggestStickersNone)}, new C21471());
    ...
    class C21493 implements RequestDelegate {
        C21493() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C21522 implements View.OnClickListener {
            C21522() {
            }
        ...
        public long getItemId(int i) {
            if (i >= StickersActivity.this.stickersStartRow && i < StickersActivity.this.stickersEndRow) {
                return ((TLRPC$TL_messages_stickerSet) DataQuery.getInstance(StickersActivity.this.currentAccount).getStickerSets(StickersActivity.this.currentType).get(i - StickersActivity.this.stickersStartRow)).set.id;
            }
        ...
        private void processSelectionOption(int which, TLRPC$TL_messages_stickerSet stickerSet) {
            if (which == 0) {
                ...
                instance.removeStickersSet(parentActivity, tLRPC$StickerSet, i, StickersActivity.this, true);
            } else if (which == 1) {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case 0:
                    ArrayList<TLRPC$TL_messages_stickerSet> arrayList = DataQuery.getInstance(StickersActivity.this.currentAccount).getStickerSets(StickersActivity.this.currentType);
                ...
                case 2:
                    if (position == StickersActivity.this.featuredRow) {
                        ((TextSettingsCell) holder.itemView).setTextAndValue(LocaleController.getString("FeaturedStickers", R.string.FeaturedStickers), DataQuery.getInstance(StickersActivity.this.currentAccount).getUnreadStickerSets().size() != 0 ? String.format("%d", new Object[]{Integer.valueOf(DataQuery.getInstance(StickersActivity.this.currentAccount).getUnreadStickerSets().size())}) : "", false);
                        return;
                    } else if (position == StickersActivity.this.archivedRow) {
                        if (StickersActivity.this.currentType == 0) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((StickerSetCell) view).setOnOptionsClick(new C21522());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnItemClickListener(new C21482());
    ...
    private void sendReorder() {
        if (this.needReorder) {
            ...
            req.masks = z;
            ArrayList<TLRPC$TL_messages_stickerSet> arrayList = DataQuery.getInstance(this.currentAccount).getStickerSets(this.currentType);
            for (int a = 0; a < arrayList.size(); a++) {
                req.order.add(Long.valueOf(((TLRPC$TL_messages_stickerSet) arrayList.get(a)).set.id));
            }
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C21493());
    ...
    private void updateRows() {
        ...
        ArrayList<TLRPC$TL_messages_stickerSet> stickerSets = DataQuery.getInstance(this.currentAccount).getStickerSets(this.currentType);
