...
public class DialogsAdapter extends SelectionAdapter {
    ...
    public TLObject getItem(int i) {
        if (this.showContacts) {
            ...
            return MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) ContactsController.getInstance(this.currentAccount).contacts.get(i)).user_id));
        }
    ...
    public void onBindViewHolder(ViewHolder holder, int i) {
        ...
        switch (holder.getItemViewType()) {
            ...
            case 5:
                ...
                return;
            case 6:
                holder.itemView.setData(MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(((TLRPC$TL_contact) ContactsController.getInstance(this.currentAccount).contacts.get(i - 3)).user_id)), null, null, 0);
                return;
            default:
                return;
        }
