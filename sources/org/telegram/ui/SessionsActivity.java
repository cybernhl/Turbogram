...
public class SessionsActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C21021 extends ActionBarMenuOnItemClick {
        C21021() {
        }
    ...
    class C21142 implements OnItemClickListener {

        /* renamed from: org.telegram.ui.SessionsActivity$2$1 */
        class C21071 implements OnClickListener {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (SessionsActivity.this.currentType == 0) {
                    ConnectionsManager.getInstance(SessionsActivity.this.currentAccount).sendRequest(new TLRPC$TL_auth_resetAuthorizations(), new C21041());
                    return;
                }
                ConnectionsManager.getInstance(SessionsActivity.this.currentAccount).sendRequest(new TLRPC$TL_account_resetWebAuthorizations(), new C21062());
            }
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == SessionsActivity.this.terminateAllSessionsRow) {
                if (SessionsActivity.this.getParentActivity() != null) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C21071());
                ...
                if (SessionsActivity.this.currentType == 0) {
                    ...
                    String name;
                    builder.setMessage(LocaleController.formatString("TerminateWebSessionQuestion", R.string.TerminateWebSessionQuestion, new Object[]{((TLRPC$TL_webAuthorization) SessionsActivity.this.sessions.get(position - SessionsActivity.this.otherSessionsStartRow)).domain}));
                    ...
                    cell.setText(LocaleController.formatString("TerminateWebSessionStop", R.string.TerminateWebSessionStop, new Object[]{name}), "", false, false);
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int option) {
                        if (SessionsActivity.this.getParentActivity() != null) {
                            ...
                            progressDialog.show();
                            if (SessionsActivity.this.currentType == 0) {
                                final TLRPC$TL_authorization authorization = (TLRPC$TL_authorization) SessionsActivity.this.sessions.get(i - SessionsActivity.this.otherSessionsStartRow);
                            ...
                            final TLRPC$TL_webAuthorization authorization2 = (TLRPC$TL_webAuthorization) SessionsActivity.this.sessions.get(i - SessionsActivity.this.otherSessionsStartRow);
    ...
    class C21163 implements RequestDelegate {
        C21163() {
        }
    ...
    class C21184 implements RequestDelegate {
        C21184() {
        }
        ...
        public void run(final TLObject response, final TLRPC$TL_error error) {
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    ...
                    if (error == null) {
                        SessionsActivity.this.sessions.clear();
                        TLRPC$TL_account_webAuthorizations res = response;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C21021());
        ...
        this.listView.setOnItemClickListener(new C21142());
    ...
    private void loadSessions(boolean silent) {
        if (!this.loading) {
            ...
            if (this.currentType == 0) {
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getAuthorizations(), new C21163()), this.classGuid);
                return;
            }
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC$TL_account_getWebAuthorizations(), new C21184()), this.classGuid);
        }
    }
