...
public class IdenticonActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C17991 extends ActionBarMenuOnItemClick {
        C17991() {
        }
    ...
    class C18002 implements OnTouchListener {
        C18002() {
        }
    ...
    class C18024 extends AnimatorListenerAdapter {
        C18024() {
        }
    ...
    class C18035 implements OnPreDrawListener {
        C18035() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17991());
        this.fragmentView = new FrameLayout(context);
        FrameLayout parentFrameLayout = this.fragmentView;
        this.fragmentView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        this.fragmentView.setOnTouchListener(new C18002());
        ...
        this.codeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.emojiTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
    ...
    private void updateEmojiButton(boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new C18024());
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C18035());
    }
