...
public class AudioSelectActivity extends BaseFragment implements NotificationCenter$NotificationCenterDelegate {
    ...
    class C10671 extends ActionBarMenuOnItemClick {
        C10671() {
        }
    ...
    class C10682 implements OnItemClickListener {
        C10682() {
        }
        ...
        public void onClick(View view) {
            if (AudioSelectActivity.this.delegate != null) {
                ...
                for (int a = 0; a < AudioSelectActivity.this.selectedAudios.size(); a++) {
                    audios.add(((MediaController$AudioEntry) AudioSelectActivity.this.selectedAudios.valueAt(a)).messageObject);
                }
    ...
    class C10725 implements Runnable {
        C10725() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C10731 implements AudioCellDelegate {
            C10731() {
            }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            MediaController$AudioEntry mediaController$AudioEntry = (MediaController$AudioEntry) AudioSelectActivity.this.audioEntries.get(position);
            ...
            audioCell.setAudio(mediaController$AudioEntry, z, z2);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C10671());
        ...
        this.listView.setOnItemClickListener(new C10682());
        ...
        this.bottomLayout.cancelButton.setOnClickListener(new C10693());
        this.bottomLayout.doneButton.setOnClickListener(new C10704());
    ...
    private void loadAudio() {
        ...
        Utilities.globalQueue.postRunnable(new C10725());
    }
