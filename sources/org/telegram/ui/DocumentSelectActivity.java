...
public class DocumentSelectActivity extends BaseFragment {
    ...
    private BroadcastReceiver receiver = new C17441();
    ...
    class C17441 extends BroadcastReceiver {
        C17441() {
        }
    ...
    class C17452 extends ActionBarMenuOnItemClick {
        C17452() {
        }
    ...
    class C17463 extends OnScrollListener {
        C17463() {
        }
    ...
    class C17474 implements OnPreDrawListener {
        C17474() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17452());
        ...
        this.listView.setOnScrollListener(new C17463());
    ...
    final /* synthetic */ boolean lambda$createView$1$DocumentSelectActivity(View view, int position) {
        ...
        if (!(file == null || file.isDirectory())) {
            if (!file.canRead()) {
                ...
                showErrorBox(LocaleController.formatString("FileUploadLimit", R.string.FileUploadLimit, new Object[]{AndroidUtilities.formatFileSize(this.sizeLimit)}));
                return false;
            } else if (this.maxSelectedFiles >= 0 && this.selectedFiles.size() >= this.maxSelectedFiles) {
                showErrorBox(LocaleController.formatString("PassportUploadMaxReached", R.string.PassportUploadMaxReached, new Object[]{LocaleController.formatPluralString("Files", this.maxSelectedFiles)}));
                return false;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (this.listView != null) {
            this.listView.getViewTreeObserver().addOnPreDrawListener(new C17474());
        }
    }
