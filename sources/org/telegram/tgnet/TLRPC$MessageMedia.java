    ...
    public static TLRPC$MessageMedia TLdeserialize(AbstractSerializedData stream, int constructor, boolean exception) {
        ...
        switch (constructor) {
            ...
            case -1557277184:
                ...
                break;
            case -1256047857:
                result = new TLRPC$TL_messageMediaPhoto_layer74();
                break;
            case -961117440:
            ...
            case 1540298357:
                ...
                break;
            case 1585262393:
                result = new TLRPC$TL_messageMediaContact_layer81();
                break;
            case 1766936791:
            ...
            case 2084316681:
                ...
                break;
            case 2084836563:
                result = new TLRPC$TL_messageMediaDocument_layer74();
                break;
        }
        ...
        if (result != null) {
            ...
            if (result.video_unused != null) {
                ...
                attributeVideo.w = result.video_unused.f812w;
                attributeVideo.h = result.video_unused.f811h;
