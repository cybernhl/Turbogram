    ...
    public void run() {
        if (ConnectionsManager.access$500(this.this$0) != this.val$value) {
            ...
            if (ConnectionsManager.access$200(this.this$0) == 3) {
                NotificationCenter.getInstance(ConnectionsManager.access$000(this.this$0)).postNotificationName(NotificationCenter.didUpdatedConnectionState, new Object[0]);
            }
        }
    }
}
