...
public final class Palette {
    ...
    static final Filter DEFAULT_FILTER = new C01431();
    ...
    static class C01431 implements Filter {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            return scaleRatio <= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? bitmap : Bitmap.createScaledBitmap(bitmap, (int) Math.ceil(((double) bitmap.getWidth()) * scaleRatio), (int) Math.ceil(((double) bitmap.getHeight()) * scaleRatio), false);
        }
    }
