        ...
        try {
            ...
            if (VERSION.SDK_INT < 28 || params.mWrapped == null) {
                ...
                if (VERSION.SDK_INT >= 23) {
                    ...
                    StaticLayout staticLayout = new StaticLayout(text, params.getTextPaint(), Integer.MAX_VALUE, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                }
                precomputedTextCompat = new PrecomputedTextCompat(text, params, result);
                TraceCompat.endSection();
                return precomputedTextCompat;
            }
            precomputedTextCompat = new PrecomputedTextCompat(PrecomputedText.create(text, params.mWrapped), params);
            return precomputedTextCompat;
        } finally {
            TraceCompat.endSection();
        }
