...
class TypefaceCompatBaseImpl {
    ...
    class C00791 implements StyleExtractor<FontInfo> {
        C00791() {
        }
    ...
    class C00802 implements StyleExtractor<FontFileResourceEntry> {
        C00802() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C00791());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C00802());
    }
