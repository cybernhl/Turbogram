...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path p, float x0, float y0, float x1, float y1, float a, float b, float theta, boolean isMoreThanHalf, boolean isPositiveArc) {
            ...
            if (dsq == FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                Log.w(PathParser.LOGTAG, " Points are coincident");
                return;
            }
            double disc = (1.0d / dsq) - 0.25d;
            if (disc < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
            ...
            if (isPositiveArc != (sweep >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE)) {
                if (sweep > FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
