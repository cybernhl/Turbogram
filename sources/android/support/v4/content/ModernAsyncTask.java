...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00721();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C00732();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00721 implements ThreadFactory {
    ...
    class C00732 extends WorkerRunnable<Params, Result> {
        C00732() {
        }
