...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C01082();
    public static final AbsSavedState EMPTY_STATE = new C01071();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C01071 extends AbsSavedState {
        C01071() {
            super();
        }
    }
    ...
    static class C01082 implements ClassLoaderCreator<AbsSavedState> {
        C01082() {
        }
