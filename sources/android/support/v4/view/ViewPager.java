...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01141();
    ...
    private static final Interpolator sInterpolator = new C01152();
    ...
    private final Runnable mEndScrollRunnable = new C01163();
    ...
    static class C01141 implements Comparator<ItemInfo> {
        C01141() {
        }
    ...
    static class C01152 implements Interpolator {
        C01152() {
        }
    ...
    class C01174 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C01181();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C01181 implements ClassLoaderCreator<SavedState> {
            C01181() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01174());
    }
