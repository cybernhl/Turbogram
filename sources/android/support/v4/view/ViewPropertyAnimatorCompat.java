...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m72x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m73y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m74z(float value) {
        View view = (View) this.mView.get();
        if (view != null && VERSION.SDK_INT >= 21) {
