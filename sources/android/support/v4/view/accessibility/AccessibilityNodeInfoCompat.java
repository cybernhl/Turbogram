...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SET_PROGRESS = new AccessibilityActionCompat(obj);
            if (VERSION.SDK_INT >= 28) {
                obj = AccessibilityAction.ACTION_SHOW_TOOLTIP;
            } else {
                obj = null;
            }
            ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(obj);
            if (VERSION.SDK_INT >= 28) {
                obj2 = AccessibilityAction.ACTION_HIDE_TOOLTIP;
            }
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(obj2);
        }
    ...
    private void setBooleanProperty(int property, boolean value) {
        ...
        if (extras != null) {
            ...
            extras.putInt(BOOLEAN_PROPERTY_KEY, booleanProperties | property);
        }
    }
