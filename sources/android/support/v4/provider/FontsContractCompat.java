...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C00995();
    ...
    static class C00995 implements Comparator<byte[]> {
        C00995() {
        }
    ...
    L_0x0050:
        r7 = sBackgroundThread;	 Catch:{ InterruptedException -> 0x005b }
        r7 = r7.postAndWait(r2, r14);	 Catch:{ InterruptedException -> 0x005b }
        r7 = (android.support.v4.provider.FontsContractCompat.TypefaceResult) r7;	 Catch:{ InterruptedException -> 0x005b }
        r0 = r7.mTypeface;	 Catch:{ InterruptedException -> 0x005b }
        goto L_0x002b;
    L_0x005b:
        r1 = move-exception;
        r0 = 0;
    ...
    L_0x0061:
        r8 = sLock;
        monitor-enter(r8);
        r7 = sPendingReplies;	 Catch:{ all -> 0x007c }
        r7 = r7.containsKey(r3);	 Catch:{ all -> 0x007c }
        if (r7 == 0) goto L_0x0085;
    L_0x006c:
        if (r5 == 0) goto L_0x0079;
    L_0x006e:
        r7 = sPendingReplies;	 Catch:{ all -> 0x007c }
        r7 = r7.get(r3);	 Catch:{ all -> 0x007c }
        r7 = (java.util.ArrayList) r7;	 Catch:{ all -> 0x007c }
    ...
    L_0x0087:
        r4 = new java.util.ArrayList;	 Catch:{ all -> 0x007c }
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest request, @NonNull final FontRequestCallback callback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C00946 implements Runnable {
                C00946() {
                }
                ...
                try {
                    ...
                    if (result.getStatusCode() != 0) {
                        switch (result.getStatusCode()) {
                            case 1:
                                callerThreadHandler.post(new C00902());
                                return;
                            case 2:
                                callerThreadHandler.post(new C00913());
                                return;
                            default:
                                callerThreadHandler.post(new C00924());
                                return;
                        }
                    }
                    FontInfo[] fonts = result.getFonts();
                    if (fonts == null || fonts.length == 0) {
                        callerThreadHandler.post(new C00935());
                        return;
                    }
                    for (FontInfo font : fonts) {
                        if (font.getResultCode() != 0) {
                            ...
                            if (resultCode < 0) {
                                callerThreadHandler.post(new C00946());
                                return;
                            } else {
                    ...
                    if (typeface == null) {
                        callerThreadHandler.post(new C00968());
                    } else {
                        callerThreadHandler.post(new Runnable() {
                            public void run() {
                    ...
                    callerThreadHandler.post(new C00891());
                }
            }
        });
    }
