...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01401();
    ...
    private final Runnable mSetIdleRunnable = new C01412();
    ...
    static class C01401 implements Interpolator {
        C01401() {
        }
    ...
    public boolean shouldInterceptTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r27) {
        /*
        r26 = this;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void processTouchEvent(@android.support.annotation.NonNull android.view.MotionEvent r22) {
        /*
        r21 = this;
