...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    class C01321 implements AnimationListener {
        C01321() {
        }
    ...
    class C01332 extends Animation {
        C01332() {
        }
    ...
    class C01343 extends Animation {
        C01343() {
        }
    ...
    class C01365 implements AnimationListener {
        C01365() {
        }
    ...
    class C01376 extends Animation {
        C01376() {
        }
    ...
    class C01387 extends Animation {
        C01387() {
        }
    ...
    class C01398 extends Animation {
        C01398() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01321();
        this.mAnimateToCorrectPosition = new C01376();
        this.mAnimateToStartPosition = new C01387();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01332();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01343();
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        if (this.mCustomSlingshotDistance > 0) {
            slingshotDist = (float) this.mCustomSlingshotDistance;
        } else {
            slingshotDist = (float) (this.mUsingCustomStart ? this.mSpinnerOffsetEnd - this.mOriginalOffsetTop : this.mSpinnerOffsetEnd);
        }
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01398();
