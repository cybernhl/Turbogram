            ...
            if (!this.mInitializedMenuBuilderReferences) {
                ...
                try {
                    ...
                    for (i = 0; i < supportedActivities.size(); i++) {
                        ...
                        menu.add(0, 0, i + MENU_ITEM_ORDER_PROCESS_TEXT_INTENT_ACTIONS_START, info.loadLabel(packageManager)).setIntent(createProcessTextIntentForResolveInfo(info, this.mTextView)).setShowAsAction(1);
                    }
