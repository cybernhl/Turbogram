...
public class ArchTaskExecutor extends TaskExecutor {
    @NonNull
    private static final Executor sIOThreadExecutor = new C00192();
    private static volatile ArchTaskExecutor sInstance;
    @NonNull
    private static final Executor sMainThreadExecutor = new C00181();
    @NonNull
    ...
    static class C00181 implements Executor {
        C00181() {
        }
    ...
    static class C00192 implements Executor {
        C00192() {
        }
